...
import { useEffect as useEffect45, Suspense, useRef as useRef26, useState as useState36 } from "react";
...
var useSettingsStore = create2((set) => ({
  settings: {},
...
import React3, { useEffect as useEffect3, useRef as useRef2, useState as useState2 } from "react";
...
// src/components/Toast.tsx
var Toast = () => {
  const [toastMessage, setToastMessage] = useState2("");
  const toastType = useRef2("info");
  const toastTimeout = useRef2(5e3);
  const messageClass = useRef2("");
  const toastDismissTimeout = useRef2(null);
  const toastClassMap = {
  ...
  return toastMessage && /* @__PURE__ */ React3.createElement(
    "div",
    {
      className: clsx(
    ...
    /* @__PURE__ */ React3.createElement(
      ...
      /* @__PURE__ */ React3.createElement(
        ...
        toastMessage.split("\n").map((line, idx) => /* @__PURE__ */ React3.createElement(React3.Fragment, { key: idx }, line || /* @__PURE__ */ React3.createElement(React3.Fragment, null, "\xA0"), /* @__PURE__ */ React3.createElement("br", null)))
      )
    )
  );
};
...
import { useState as useState35, useRef as useRef25, useEffect as useEffect44 } from "react";
import { useSearchParams as useSearchParams2 } from "next/navigation";

// src/store/bookDataStore.ts
import { create as create3 } from "zustand";
var useBookDataStore = create3((set, get) => ({
  booksData: {},
  getBookData: (keyOrId) => {
...
// src/store/readerStore.ts
var useReaderStore = create4((set, get) => ({
  viewStates: {},
  bookKeys: [],
  hoveredBookKey: null,
...
var useSidebarStore = create5((set) => ({
  sideBarBookKey: null,
  sideBarWidth: "",
...
var useBooksManager = () => {
  ...
  const [shouldUpdateSearchParams, setShouldUpdateSearchParams] = useState3(false);
  useEffect4(() => {
...
var useNotebookStore = create6((set, get) => ({
  notebookWidth: "",
...
var useShortcuts = (actions, dependencies = []) => {
  const [shortcuts, setShortcuts] = useState4(loadShortcuts);
  useEffect5(() => {
...
var Alert = ({ title, message, onCancel, onConfirm }) => {
  ...
  return /* @__PURE__ */ React4.createElement("div", { className: clsx2("z-[100] flex justify-center px-4") }, /* @__PURE__ */ React4.createElement(
    "div",
    {
      role: "alert",
      className: clsx2(
    ...
    /* @__PURE__ */ React4.createElement("div", { className: "flex items-center space-x-2" }, /* @__PURE__ */ React4.createElement(
      "svg",
      {
    ...
    ), /* @__PURE__ */ React4.createElement("div", { className: "" }, /* @__PURE__ */ React4.createElement("h3", { className: "font-sm text-base" }, title), /* @__PURE__ */ React4.createElement("div", { className: "text-xs" }, message))),
    /* @__PURE__ */ React4.createElement("div", { className: "flex flex-wrap items-center justify-center gap-2" }, /* @__PURE__ */ React4.createElement("button", { className: "btn btn-sm", onClick: onCancel }, _("Cancel")), /* @__PURE__ */ React4.createElement("button", { className: "btn btn-sm btn-warning", onClick: onConfirm }, _("Confirm")))
  ));
};
...
var Spinner = ({ loading }) => {
  ...
  return /* @__PURE__ */ React5.createElement(
    ...
    /* @__PURE__ */ React5.createElement("span", { className: "loading loading-dots loading-lg" }),
    /* @__PURE__ */ React5.createElement("span", { className: "hidden" }, _("Loading..."))
  );
};
...
import React6, { useEffect as useEffect6, useState as useState5 } from "react";
...
var useDrag = (onDragMove, onDragEnd) => {
  ...
  const startY = useRef3(0);
  const lastX = useRef3(0);
  const lastY = useRef3(0);
...
var Dialog = ({
  ...
  const [isFullHeightInMobile, setIsFullHeightInMobile] = React6.useState(!snapHeight);
  const [isRtl] = useState5(() => getDirFromUILanguage() === "rtl");
  ...
  return /* @__PURE__ */ React6.createElement(
    ...
    /* @__PURE__ */ React6.createElement(
      "div",
      {
        className: clsx4("overlay fixed inset-0 z-10 bg-black/50 sm:bg-black/20", bgClassName),
        onClick: onClose
      }
    ),
    /* @__PURE__ */ React6.createElement(
      ...
      window.innerWidth < 640 && /* @__PURE__ */ React6.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ React6.createElement("div", { className: "bg-base-content/50 h-1 w-10 rounded-full" })
      ),
      /* @__PURE__ */ React6.createElement("div", { className: "dialog-header bg-base-100 sticky top-1 z-10 flex items-center justify-between px-4" }, header ? header : /* @__PURE__ */ React6.createElement("div", { className: "flex h-11 w-full items-center justify-between" }, /* @__PURE__ */ React6.createElement(
        "button",
        {
          tabIndex: -1,
          onClick: onClose,
        ...
        isRtl ? /* @__PURE__ */ React6.createElement(MdArrowForwardIos, { size: iconSize22 }) : /* @__PURE__ */ React6.createElement(MdArrowBackIosNew, { size: iconSize22 })
      ), /* @__PURE__ */ React6.createElement("div", { className: "z-15 pointer-events-none absolute inset-0 flex h-11 items-center justify-center" }, /* @__PURE__ */ React6.createElement("span", { className: "line-clamp-1 text-center font-bold" }, title ?? "")), /* @__PURE__ */ React6.createElement(
        "button",
        {
          tabIndex: -1,
          onClick: onClose,
...
var BookDetailModal = ({ book, isOpen, onClose }) => {
  ...
  const [showDeleteAlert, setShowDeleteAlert] = useState6(false);
  const [bookMeta, setBookMeta] = useState6(null);
  ...
  if (!bookMeta)
    return loading && /* @__PURE__ */ React7.createElement("div", { className: "fixed inset-0 z-50 flex items-center justify-center" }, /* @__PURE__ */ React7.createElement(Spinner_default, { loading: true }));
  return /* @__PURE__ */ React7.createElement("div", { className: "fixed inset-0 z-50 flex items-center justify-center" }, /* @__PURE__ */ React7.createElement(
    Dialog_default,
    {
    ...
    /* @__PURE__ */ React7.createElement("div", { className: "flex w-full select-text items-center justify-center" }, /* @__PURE__ */ React7.createElement("div", { className: "relative w-full rounded-lg" }, /* @__PURE__ */ React7.createElement("div", { className: "mb-10 flex h-40 items-start" }, /* @__PURE__ */ React7.createElement("div", { className: "book-cover relative mr-10 aspect-[28/41] h-40 items-end shadow-lg" }, /* @__PURE__ */ React7.createElement(
      Image,
      {
    ...
    )), /* @__PURE__ */ React7.createElement("div", { className: "title-author flex h-40 flex-col justify-between" }, /* @__PURE__ */ React7.createElement("div", null, /* @__PURE__ */ React7.createElement("p", { className: "text-base-content mb-2 line-clamp-2 break-all text-2xl font-bold" }, formatTitle(book.title) || _("Untitled")), /* @__PURE__ */ React7.createElement("p", { className: "text-neutral-content line-clamp-1" }, formatAuthors(book.author, bookMeta.language) || _("Unknown"))), window.innerWidth >= 400 && /* @__PURE__ */ React7.createElement("div", { className: "flex flex-wrap items-center gap-x-4 gap-y-2 py-2" }, /* @__PURE__ */ React7.createElement(
      "button",
      {
      ...
      _("Delete")
    ), /* @__PURE__ */ React7.createElement("button", { className: "btn btn-disabled bg-primary/25 hover:bg-primary/85 rounded-xl px-4 text-white" }, _("More Info"))))), window.innerWidth < 400 && /* @__PURE__ */ React7.createElement("div", { className: "flex flex-wrap items-center gap-x-4 gap-y-2 py-2" }, /* @__PURE__ */ React7.createElement(
      "button",
      {
      ...
      _("Delete")
    ), /* @__PURE__ */ React7.createElement("button", { className: "btn btn-disabled bg-primary/25 hover:bg-primary/85 rounded px-4 text-white" }, _("More Info"))), /* @__PURE__ */ React7.createElement("div", { className: "text-base-content my-4" }, /* @__PURE__ */ React7.createElement("div", { className: "mb-4 grid grid-cols-2 gap-4 sm:grid-cols-3" }, /* @__PURE__ */ React7.createElement("div", { className: "overflow-hidden" }, /* @__PURE__ */ React7.createElement("span", { className: "font-bold" }, _("Publisher:")), /* @__PURE__ */ React7.createElement("p", { className: "text-neutral-content line-clamp-1 text-sm" }, formatPublisher(bookMeta.publisher || "") || _("Unknown"))), /* @__PURE__ */ React7.createElement("div", { className: "overflow-hidden" }, /* @__PURE__ */ React7.createElement("span", { className: "font-bold" }, _("Published:")), /* @__PURE__ */ React7.createElement("p", { className: "text-neutral-content max-w-28 text-ellipsis text-sm" }, formatDate(bookMeta.published) || _("Unknown"))), /* @__PURE__ */ React7.createElement("div", { className: "overflow-hidden" }, /* @__PURE__ */ React7.createElement("span", { className: "font-bold" }, _("Updated:")), /* @__PURE__ */ React7.createElement("p", { className: "text-neutral-content text-sm" }, formatDate(book.lastUpdated) || "")), /* @__PURE__ */ React7.createElement("div", { className: "overflow-hidden" }, /* @__PURE__ */ React7.createElement("span", { className: "font-bold" }, _("Language:")), /* @__PURE__ */ React7.createElement("p", { className: "text-neutral-content text-sm" }, formatLanguage(bookMeta.language) || _("Unknown"))), /* @__PURE__ */ React7.createElement("div", { className: "overflow-hidden" }, /* @__PURE__ */ React7.createElement("span", { className: "font-bold" }, _("Identifier:")), /* @__PURE__ */ React7.createElement("p", { className: "text-neutral-content line-clamp-1 text-sm" }, bookMeta.identifier || "N/A")), /* @__PURE__ */ React7.createElement("div", { className: "overflow-hidden" }, /* @__PURE__ */ React7.createElement("span", { className: "font-bold" }, _("Subjects:")), /* @__PURE__ */ React7.createElement("p", { className: "text-neutral-content line-clamp-1 text-sm" }, formatSubject(bookMeta.subject) || _("Unknown")))))))
  ), showDeleteAlert && /* @__PURE__ */ React7.createElement(
    "div",
    {
      className: clsx5(
...
import React19, { useEffect as useEffect13, useState as useState12 } from "react";
...
import { MdArrowBackIosNew as MdArrowBackIosNew2 } from "react-icons/md";

// src/store/trafficLightStore.ts
import { create as create7 } from "zustand";
var useTrafficLightStore = create7((set, get) => {
  return {
    appService: void 0,
...
var SidebarHeader = ({ isPinned, isSearchBarVisible, onGoToLibrary, onClose, onTogglePin, onToggleSearchBar }) => {
  ...
  return /* @__PURE__ */ React8.createElement(
    ...
    /* @__PURE__ */ React8.createElement("div", { className: "flex items-center gap-x-8" }, /* @__PURE__ */ React8.createElement(
      "button",
      {
        onClick: onClose,
        className: "btn btn-ghost btn-circle flex h-6 min-h-6 w-6 hover:bg-transparent sm:hidden"
      },
      /* @__PURE__ */ React8.createElement(MdArrowBackIosNew2, { size: iconSize22 })
      ...
      /* @__PURE__ */ React8.createElement(IoReload, { className: "fill-base-content" })
    )),
    /* @__PURE__ */ React8.createElement("div", { className: "flex min-w-24 max-w-32 items-center justify-between sm:size-[70%]" }, /* @__PURE__ */ React8.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ React8.createElement(FiSearch, { size: iconSize18, className: "text-base-content" })
    ), /* @__PURE__ */ React8.createElement("div", { className: "right-0 hidden h-8 w-8 items-center justify-center sm:flex" }, /* @__PURE__ */ React8.createElement(
      "button",
      {
        onClick: onTogglePin,
        className: clsx6(
      ...
      isPinned ? /* @__PURE__ */ React8.createElement(MdPushPin, { size: iconSize14 }) : /* @__PURE__ */ React8.createElement(MdOutlinePushPin, { size: iconSize14 })
    )))
  );
};
...
import React13, { useEffect as useEffect10, useRef as useRef7, useState as useState9 } from "react";

// src/app/reader/components/sidebar/TOCView.tsx
import clsx7 from "clsx";
import React9, { useEffect as useEffect8, useRef as useRef5, useState as useState7 } from "react";
var createExpanderIcon = (isExpanded) => {
  return /* @__PURE__ */ React9.createElement(
    ...
    /* @__PURE__ */ React9.createElement("polygon", { points: "0 0, 8 5, 0 10" })
  );
};
var TOCItemView = ({ bookKey, item, depth, expandedItems }) => {
  const [isExpanded, setIsExpanded] = useState7(expandedItems.includes(item.href || ""));
  ...
  return /* @__PURE__ */ React9.createElement("li", { className: "w-full", style: { paddingTop: "1px" } }, /* @__PURE__ */ React9.createElement(
    "span",
    {
      role: "treeitem",
      tabIndex: -1,
    ...
    item.subitems && /* @__PURE__ */ React9.createElement("span", { onClick: handleToggleExpand, className: "inline-block cursor-pointer" }, createExpanderIcon(isExpanded)),
  ...
  ), item.subitems && isExpanded && /* @__PURE__ */ React9.createElement("ol", { role: "group" }, item.subitems.map((subitem, index) => /* @__PURE__ */ React9.createElement(
    TOCItemView,
    {
      bookKey,
...
var TOCView = ({ bookKey, toc }) => {
  ...
  const progress = getProgress(bookKey);
  const [expandedItems, setExpandedItems] = useState7([]);
  ...
  return /* @__PURE__ */ React9.createElement("div", { className: "rounded pt-2" }, /* @__PURE__ */ React9.createElement("ul", { role: "tree", ref: viewRef, className: "px-2" }, toc && toc.map((item, index) => /* @__PURE__ */ React9.createElement(
    TOCItemView,
    {
      bookKey,
      key: `${index}-${item.href}`,
...
import * as CFI3 from "foliate-js/epubcfi.js";
...
import * as CFI2 from "foliate-js/epubcfi.js";
var useScrollToItem = (cfi, progress) => {
  const viewRef = useRef6(null);
  const [isCurrent, setIsCurrent] = useState8(false);
  useEffect9(() => {
...
var BooknoteItem = ({ bookKey, item }) => {
  ...
  return /* @__PURE__ */ React10.createElement(
    ...
    /* @__PURE__ */ React10.createElement(
      ...
      item.note && /* @__PURE__ */ React10.createElement("span", { className: "content font-size-sm font-normal", dir: "auto" }, item.note),
      /* @__PURE__ */ React10.createElement("div", { className: "flex items-start" }, item.note && /* @__PURE__ */ React10.createElement("div", { className: "my-1 me-2 min-h-full self-stretch border-l-2 border-gray-300" }), /* @__PURE__ */ React10.createElement("div", { className: clsx8("content font-size-sm line-clamp-3", item.note && "my-2") }, /* @__PURE__ */ React10.createElement(
        "span",
        {
          className: clsx8(
            "inline",
    ...
    /* @__PURE__ */ React10.createElement(
      ...
      /* @__PURE__ */ React10.createElement("div", { className: "flex justify-end space-x-3 p-2", dir: "ltr" }, item.note && /* @__PURE__ */ React10.createElement(
        "button",
        {
          className: clsx8(
...
var BooknoteView = ({ type, bookKey, toc }) => {
  ...
  return /* @__PURE__ */ React11.createElement("div", { className: "rounded pt-2" }, /* @__PURE__ */ React11.createElement("ul", { role: "tree", className: "px-2" }, sortedGroups.map((group) => /* @__PURE__ */ React11.createElement("li", { key: group.href, className: "p-2" }, /* @__PURE__ */ React11.createElement("h3", { className: "content font-size-base line-clamp-1 font-normal" }, group.label), /* @__PURE__ */ React11.createElement("ul", null, group.booknotes.map((item, index) => /* @__PURE__ */ React11.createElement(BooknoteItem_default, { key: `${index}-${item.cfi}`, bookKey, item })))))));
};
...
var TabNavigation = ({ activeTab, onTabChange }) => {
  ...
  return /* @__PURE__ */ React12.createElement(
    "div",
    {
      className: clsx9("bottom-tab border-base-300/50 bg-base-200 relative flex w-full border-t"),
      dir: "ltr"
    },
    ...
    tabs.map((tab) => /* @__PURE__ */ React12.createElement(
      "div",
      {
        key: tab,
      ...
      /* @__PURE__ */ React12.createElement("div", { className: clsx9("flex h-6 items-center"), onClick: () => onTabChange(tab) }, tab === "toc" ? /* @__PURE__ */ React12.createElement(TOCIcon, { className: "mx-auto" }) : tab === "annotations" ? /* @__PURE__ */ React12.createElement(NoteIcon, { className: "mx-auto" }) : /* @__PURE__ */ React12.createElement(BookmarkIcon, { className: "mx-auto" }))
    ))
  );
};
...
var SidebarContent = ({ bookDoc, sideBarBookKey }) => {
  ...
  const [activeTab, setActiveTab] = useState9(config?.viewSettings?.sideBarTab || "toc");
  const [fade, setFade] = useState9(false);
  const [targetTab, setTargetTab] = useState9(activeTab);
  useEffect10(() => {
  ...
  return /* @__PURE__ */ React13.createElement(React13.Fragment, null, /* @__PURE__ */ React13.createElement(
    ...
    /* @__PURE__ */ React13.createElement(
      ...
      targetTab === "toc" && bookDoc.toc && /* @__PURE__ */ React13.createElement(TOCView_default, { toc: bookDoc.toc, bookKey: sideBarBookKey }),
      targetTab === "annotations" && /* @__PURE__ */ React13.createElement(BooknoteView_default, { type: "annotation", toc: bookDoc.toc ?? [], bookKey: sideBarBookKey }),
      targetTab === "bookmarks" && /* @__PURE__ */ React13.createElement(BooknoteView_default, { type: "bookmark", toc: bookDoc.toc ?? [], bookKey: sideBarBookKey })
    )
  ), /* @__PURE__ */ React13.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React13.createElement(TabNavigation_default, { activeTab, onTabChange: handleTabChange })
  ));
};
...
var BookCard = ({ book }) => {
  ...
  return /* @__PURE__ */ React14.createElement("div", { className: "flex h-20 w-full items-center" }, /* @__PURE__ */ React14.createElement(
    Image2,
    {
      src: coverImageUrl,
      alt: _("Book Cover"),
  ...
  ), /* @__PURE__ */ React14.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React14.createElement("h4", { className: "line-clamp-2 w-[90%] text-sm font-semibold" }, formatTitle(title)), /* @__PURE__ */ React14.createElement("p", { className: "truncate text-xs opacity-75" }, formatAuthors(author))), /* @__PURE__ */ React14.createElement(
    "button",
    {
      className: "btn btn-ghost hover:bg-base-300 h-6 min-h-6 w-6 rounded-full p-0 transition-colors",
      "aria-label": _("More Info")
    },
    /* @__PURE__ */ React14.createElement(MdInfoOutline, { size: iconSize18, className: "fill-base-content", onClick: showBookDetails })
  ));
};
...
import React17, { useEffect as useEffect12, useRef as useRef8, useState as useState11 } from "react";
import { FaSearch, FaChevronDown } from "react-icons/fa";

// src/components/Dropdown.tsx
import clsx12 from "clsx";
import React15, { useState as useState10, isValidElement } from "react";
var Dropdown = ({
  className,
  menuClassName,
  buttonClassName,
  ...
  const childrenWithToggle = isValidElement(children) ? React15.cloneElement(children, { setIsDropdownOpen, menuClassName }) : children;
  return /* @__PURE__ */ React15.createElement("div", { className: "dropdown-container" }, isOpen && /* @__PURE__ */ React15.createElement("div", { className: "fixed inset-0 bg-transparent", onClick: () => setIsDropdownOpen(false) }), /* @__PURE__ */ React15.createElement("div", { className: clsx12("dropdown", className) }, /* @__PURE__ */ React15.createElement(
    "div",
    {
      tabIndex: -1,
      onClick: toggleDropdown,
      className: clsx12("dropdown-toggle", buttonClassName, isOpen && "bg-base-300/50")
    },
    toggleButton
...
var Option = ({ label, isActive, onClick }) => /* @__PURE__ */ React16.createElement(
  "button",
  {
    className: "hover:bg-base-300 flex w-full items-center justify-between rounded-md p-2",
    onClick
  },
  /* @__PURE__ */ React16.createElement("div", { className: "flex items-center" }, /* @__PURE__ */ React16.createElement("span", { style: { minWidth: `${useDefaultIconSize()}px` } }, isActive && /* @__PURE__ */ React16.createElement(MdCheck, { className: "text-base-content" })), /* @__PURE__ */ React16.createElement("span", { className: "ml-2" }, label))
);
var SearchOptions = ({
  searchConfig,
  menuClassName,
  ...
  return /* @__PURE__ */ React16.createElement(
    ...
    /* @__PURE__ */ React16.createElement("hr", { className: "border-base-200 my-1" }),
    /* @__PURE__ */ React16.createElement(
      Option,
      {
        label: _("Match Case"),
...
var SearchBar = ({
  ...
  const { getView, getProgress } = useReaderStore();
  const [searchTerm, setSearchTerm] = useState11(term);
  const inputRef = useRef8(null);
  const view = getView(bookKey);
  const config = getConfig(bookKey);
  const progress = getProgress(bookKey);
  const searchConfig = config.searchConfig;
  const queuedSearchTerm = useRef8("");
  const isSearchPending = useRef8(false);
  const searchTimeout = useRef8(null);
  ...
  return /* @__PURE__ */ React17.createElement("div", { className: "relative p-2" }, /* @__PURE__ */ React17.createElement("div", { className: "bg-base-100 flex h-8 items-center rounded-lg" }, /* @__PURE__ */ React17.createElement("div", { className: "pl-3" }, /* @__PURE__ */ React17.createElement(FaSearch, { size: iconSize16, className: "text-gray-500" })), /* @__PURE__ */ React17.createElement(
    "input",
    {
      ref: inputRef,
      type: "text",
  ...
  ), /* @__PURE__ */ React17.createElement("div", { className: "bg-base-300 flex h-8 w-8 items-center rounded-r-lg" }, /* @__PURE__ */ React17.createElement(
    Dropdown_default,
    {
      className: clsx14(
      ...
      toggleButton: /* @__PURE__ */ React17.createElement(FaChevronDown, { size: iconSize12, className: "text-gray-500" })
    },
...
var SearchResultItem = ({
  ...
  return /* @__PURE__ */ React18.createElement(
    ...
    /* @__PURE__ */ React18.createElement("div", { className: "line-clamp-3" }, /* @__PURE__ */ React18.createElement("span", { className: "" }, excerpt.pre), /* @__PURE__ */ React18.createElement("span", { className: "font-semibold" }, excerpt.match), /* @__PURE__ */ React18.createElement("span", { className: "" }, excerpt.post))
  );
};
var SearchResults = ({ bookKey, results, onSelectResult }) => {
  return /* @__PURE__ */ React18.createElement("div", { className: "search-results overflow-y-auto p-2 font-sans text-sm font-light" }, /* @__PURE__ */ React18.createElement("ul", { className: "px-2" }, results.map((result, index) => {
    if ("subitems" in result) {
      return /* @__PURE__ */ React18.createElement("ul", { key: `${index}-${result.label}` }, /* @__PURE__ */ React18.createElement("h3", { className: "line-clamp-1 font-normal" }, result.label), /* @__PURE__ */ React18.createElement("ul", null, result.subitems.map((item, index2) => /* @__PURE__ */ React18.createElement(
        SearchResultItem,
        {
          key: `${index2}-${item.cfi}`,
          bookKey,
...
var SideBar = ({ onGoToLibrary }) => {
  ...
  const [isSearchBarVisible, setIsSearchBarVisible] = useState12(false);
  const [searchResults, setSearchResults] = useState12(null);
  ...
  return isSideBarVisible ? /* @__PURE__ */ React19.createElement(React19.Fragment, null, /* @__PURE__ */ React19.createElement(
    "div",
    {
      className: clsx16(
    ...
    /* @__PURE__ */ React19.createElement("style", { jsx: true }, `
        ...
        `),
    /* @__PURE__ */ React19.createElement("div", { className: "flex-shrink-0" }, isMobile && /* @__PURE__ */ React19.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ React19.createElement("div", { className: "bg-base-content/50 h-1 w-10 rounded-full" })
    ...
    ), /* @__PURE__ */ React19.createElement("div", { className: "border-base-300/50 border-b px-3" }, /* @__PURE__ */ React19.createElement(BookCard_default, { book }))),
    isSearchBarVisible && searchResults ? /* @__PURE__ */ React19.createElement(
    ...
    ) : /* @__PURE__ */ React19.createElement(Content_default, { bookDoc, sideBarBookKey }),
    /* @__PURE__ */ React19.createElement(
      "div",
      {
  ...
  ), !isSideBarPinned && /* @__PURE__ */ React19.createElement(
    "div",
    {
...
import React22, { useEffect as useEffect15 } from "react";
...
import { MdArrowBackIosNew as MdArrowBackIosNew3, MdOutlinePushPin as MdOutlinePushPin2, MdPushPin as MdPushPin2 } from "react-icons/md";
var NotebookHeader = ({ isPinned, handleClose: handleClose2, handleTogglePin }) => {
  const _ = useTranslation();
  const iconSize14 = useResponsiveSize(14);
  return /* @__PURE__ */ React20.createElement("div", { className: "notebook-header relative flex h-11 items-center px-3", dir: "ltr" }, /* @__PURE__ */ React20.createElement("div", { className: "absolute inset-0 flex items-center justify-center space-x-2" }, /* @__PURE__ */ React20.createElement(LuNotebookPen, null), /* @__PURE__ */ React20.createElement("div", { className: "notebook-title hidden text-sm font-medium sm:flex" }, _("Notebook"))), /* @__PURE__ */ React20.createElement("div", { className: "z-10 flex items-center gap-x-4" }, /* @__PURE__ */ React20.createElement(
    "button",
    {
    ...
    isPinned ? /* @__PURE__ */ React20.createElement(MdPushPin2, { size: iconSize14 }) : /* @__PURE__ */ React20.createElement(MdOutlinePushPin2, { size: iconSize14 })
    ...
    /* @__PURE__ */ React20.createElement(MdArrowBackIosNew3, null)
  ), /* @__PURE__ */ React20.createElement("button", { className: "btn btn-ghost left-0 h-8 min-h-8 w-8 p-0" }, /* @__PURE__ */ React20.createElement(FiSearch2, null))));
};
var Header_default2 = NotebookHeader;

// src/app/reader/components/notebook/NoteEditor.tsx
import clsx18 from "clsx";
import React21, { useEffect as useEffect14, useRef as useRef9 } from "react";
var NoteEditor = ({ onSave, onEdit }) => {
  ...
  return /* @__PURE__ */ React21.createElement("div", { className: "content note-editor-container bg-base-100 mt-2 rounded-md p-2" }, /* @__PURE__ */ React21.createElement("div", { className: "flex w-full justify-between space-x-2" }, /* @__PURE__ */ React21.createElement("div", { className: "relative w-full" }, /* @__PURE__ */ React21.createElement(
    "textarea",
    {
      className: clsx18(
  ...
  ))), /* @__PURE__ */ React21.createElement("div", { className: "flex items-start pt-2" }, /* @__PURE__ */ React21.createElement("div", { className: "mr-2 min-h-full self-stretch border-l-2 border-gray-300" }), /* @__PURE__ */ React21.createElement("div", { className: "content font-size-sm line-clamp-3 py-2" }, /* @__PURE__ */ React21.createElement("span", { className: "content font-size-xs inline text-gray-500" }, getAnnotationText()))), /* @__PURE__ */ React21.createElement("div", { className: "flex justify-end p-2", dir: "ltr" }, /* @__PURE__ */ React21.createElement(
    "button",
    {
      className: clsx18(
    ...
    /* @__PURE__ */ React21.createElement("div", { className: "font-size-sm pr-1 align-bottom text-blue-500" }, _("Save"))
  )));
};
...
var Notebook = ({}) => {
  ...
  return isNotebookVisible ? /* @__PURE__ */ React22.createElement(React22.Fragment, null, !isNotebookPinned && /* @__PURE__ */ React22.createElement("div", { className: "overlay fixed inset-0 z-10 bg-black/20", onClick: handleClickOverlay }), /* @__PURE__ */ React22.createElement(
    "div",
    {
      className: clsx19(
    ...
    /* @__PURE__ */ React22.createElement("style", { jsx: true }, `
          @media (max-width: 640px) {
            .notebook-container {
              width: 100%;
              min-width: 100%;
    ...
    /* @__PURE__ */ React22.createElement("div", { className: "max-h-[calc(100vh-44px)] overflow-y-auto px-3" }, /* @__PURE__ */ React22.createElement("div", { dir: "ltr" }, excerptNotes.length > 0 && /* @__PURE__ */ React22.createElement("p", { className: "content font-size-base pt-1" }, _("Excerpts"))), /* @__PURE__ */ React22.createElement("ul", { className: "" }, excerptNotes.map((item, index) => /* @__PURE__ */ React22.createElement("li", { key: `${index}-${item.id}`, className: "my-2" }, /* @__PURE__ */ React22.createElement(
      "div",
      {
        tabIndex: 0,
      ...
      /* @__PURE__ */ React22.createElement(
        ...
        /* @__PURE__ */ React22.createElement("p", { className: "line-clamp-1" }, item.text || `Excerpt ${index + 1}`)
      ),
      /* @__PURE__ */ React22.createElement("div", { className: "collapse-content font-size-xs select-text px-3 pb-0" }, /* @__PURE__ */ React22.createElement("p", { className: "hyphens-auto text-justify" }, item.text), /* @__PURE__ */ React22.createElement("div", { className: "flex justify-end", dir: "ltr" }, /* @__PURE__ */ React22.createElement(
        "div",
        {
    ...
    )))), /* @__PURE__ */ React22.createElement("div", { dir: "ltr" }, (notebookNewAnnotation || annotationNotes.length > 0) && /* @__PURE__ */ React22.createElement("p", { className: "content font-size-base pt-1" }, _("Notes"))), (notebookNewAnnotation || notebookEditAnnotation) && /* @__PURE__ */ React22.createElement(NoteEditor_default, { onSave: handleSaveNote, onEdit: (item) => handleEditNote(item, false) }), /* @__PURE__ */ React22.createElement("ul", null, annotationNotes.map((item, index) => /* @__PURE__ */ React22.createElement(BooknoteItem_default, { key: `${index}-${item.cfi}`, bookKey: sideBarBookKey, item }))))
  )) : null;
};
...
import React58, { useEffect as useEffect41 } from "react";

// src/app/reader/components/FoliateViewer.tsx
import React24, { useEffect as useEffect22, useRef as useRef12, useState as useState15 } from "react";
...
import { useEffect as useEffect18, useRef as useRef10, useState as useState13 } from "react";
import { useRouter as useRouter2 } from "next/navigation";

// src/context/SyncContext.tsx
import React23, { createContext as createContext2, useContext as useContext2 } from "react";
...
var SyncContext = createContext2({ syncClient });
var useSyncContext = () => useContext2(SyncContext);
...
function useSync(bookKey) {
  ...
  const [syncingBooks, setSyncingBooks] = useState13(false);
  const [syncingConfigs, setSyncingConfigs] = useState13(false);
  const [syncingNotes, setSyncingNotes] = useState13(false);
  const [syncError, setSyncError] = useState13(null);
  const [lastSyncedAtBooks, setLastSyncedAtBooks] = useState13(0);
  const [lastSyncedAtConfigs, setLastSyncedAtConfigs] = useState13(0);
  const [lastSyncedAtNotes, setLastSyncedAtNotes] = useState13(0);
  const lastSyncedAtInited = useRef10(false);
  const [syncing, setSyncing] = useState13(false);
  const [syncResult, setSyncResult] = useState13({
    books: null,
    configs: null,
    notes: null
  });
  const [syncedBooks, setSyncedBooks] = useState13(null);
  const [syncedConfigs, setSyncedConfigs] = useState13(null);
  const [syncedNotes, setSyncedNotes] = useState13(null);
...
var useProgressSync = (bookKey) => {
  ...
  const config = getConfig(bookKey);
  const progress = getProgress(bookKey);
  const configSynced = useRef11(false);
  const firstPulled = useRef11(false);
  ...
  const lastProgressSyncTime = useRef11(0);
  const syncTimeoutRef = useRef11(null);
  useEffect19(() => {
...
import { useCallback as useCallback2, useEffect as useEffect20 } from "react";
...
var useProgressAutoSave = (bookKey) => {
  ...
  const { getProgress } = useReaderStore();
  const progress = getProgress(bookKey);
  const saveBookConfig = useCallback2(
    throttle(async () => {
      const config = getConfig(bookKey);
...
var useUICSS = (bookKey, viewSettings) => {
  const [styleElement, setStyleElement] = useState14(null);
  useEffect21(() => {
...
var FoliateViewer = ({ bookKey, bookDoc, config }) => {
  ...
  const isViewCreated = useRef12(false);
...
import React34, { useEffect as useEffect26, useRef as useRef14, useState as useState18 } from "react";
import { PiDotsThreeVerticalBold } from "react-icons/pi";

// src/components/WindowButtons.tsx
import clsx21 from "clsx";
import React26, { useEffect as useEffect23, useRef as useRef13 } from "react";
var WindowButton = ({ onClick, ariaLabel, id, children }) => /* @__PURE__ */ React26.createElement(
  "button",
  {
    id,
    onClick,
...
var WindowButtons = ({
  ...
  return /* @__PURE__ */ React26.createElement(
    ...
    showMinimize && appService?.hasWindowBar && /* @__PURE__ */ React26.createElement(WindowButton, { onClick: handleMinimizeClick, ariaLabel: "Minimize", id: "titlebar-minimize" }, /* @__PURE__ */ React26.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 24 24" }, /* @__PURE__ */ React26.createElement("path", { fill: "currentColor", d: "M20 14H4v-2h16" }))),
    showMaximize && appService?.hasWindowBar && /* @__PURE__ */ React26.createElement(WindowButton, { onClick: handleMaximizeClick, ariaLabel: "Maximize/Restore", id: "titlebar-maximize" }, /* @__PURE__ */ React26.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 24 24" }, /* @__PURE__ */ React26.createElement("path", { fill: "currentColor", d: "M4 4h16v16H4zm2 4v10h12V8z" }))),
    showClose && (appService?.hasWindowBar || onClose) && /* @__PURE__ */ React26.createElement(WindowButton, { onClick: handleCloseClick, ariaLabel: "Close", id: "titlebar-close" }, /* @__PURE__ */ React26.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 24 24" }, /* @__PURE__ */ React26.createElement(
      "path",
      {
        fill: "currentColor",
        d: "M19 6.41L17.59 5L12 10.59L6.41 5L5 6.41L10.59 12L5 17.59L6.41 19L12 13.41L17.59 19L19 17.59L13.41 12z"
...
var SidebarToggler = ({ bookKey }) => {
  ...
  return /* @__PURE__ */ React28.createElement(
    Button_default,
    {
      icon: sideBarBookKey === bookKey && isSideBarVisible ? /* @__PURE__ */ React28.createElement(TbLayoutSidebarFilled, { className: "text-base-content" }) : /* @__PURE__ */ React28.createElement(TbLayoutSidebar, { className: "text-base-content" }),
...
import React29, { useEffect as useEffect24, useState as useState16 } from "react";
...
var BookmarkToggler = ({ bookKey }) => {
  ...
  const [isBookmarked, setIsBookmarked] = useState16(false);
  ...
  return /* @__PURE__ */ React29.createElement(
    Button_default,
    {
      icon: isBookmarked ? /* @__PURE__ */ React29.createElement(MdOutlineBookmark, { className: "text-base-content" }) : /* @__PURE__ */ React29.createElement(MdOutlineBookmarkAdd, { className: "text-base-content" }),
...
import { LuNotebookPen as LuNotebookPen2 } from "react-icons/lu";
var NotebookToggler = ({ bookKey }) => {
  ...
  return /* @__PURE__ */ React30.createElement(
    Button_default,
    {
      icon: sideBarBookKey == bookKey && isNotebookVisible ? /* @__PURE__ */ React30.createElement(LuNotebookPen2, { size: iconSize16, className: "text-base-content" }) : /* @__PURE__ */ React30.createElement(LuNotebookPen2, { size: iconSize16, className: "text-base-content" }),
      onClick: handleToggleSidebar,
      tooltip: _("Notebook"),
      tooltipDirection: "bottom"
    }
...
var SettingsToggler = () => {
  ...
  return /* @__PURE__ */ React31.createElement(
    Button_default,
    {
      icon: /* @__PURE__ */ React31.createElement(RiFontSize, { className: "text-base-content" }),
...
import React33, { useEffect as useEffect25 } from "react";
import { useState as useState17 } from "react";
import { BiMoon, BiSun } from "react-icons/bi";
import { TbSunMoon } from "react-icons/tb";
import { MdZoomOut, MdZoomIn, MdCheck as MdCheck2 } from "react-icons/md";
...
var MenuItem = ({
  ...
  const menuButton = /* @__PURE__ */ React32.createElement(
    "button",
    {
      className: clsx23(
    ...
    /* @__PURE__ */ React32.createElement("div", { className: "flex min-w-0 items-center" }, !noIcon && /* @__PURE__ */ React32.createElement("span", { style: { minWidth: `${iconSize}px` } }, icon), /* @__PURE__ */ React32.createElement(
      "span",
      {
        className: clsx23("mx-2 flex-1 truncate text-base sm:text-sm", labelClass),
        style: { minWidth: 0 }
      },
      label
    )),
    shortcut && /* @__PURE__ */ React32.createElement(
      "kbd",
      {
        className: clsx23(
  ...
  if (children) {
    return /* @__PURE__ */ React32.createElement("ul", { className: "menu rounded-box m-0 p-0" }, /* @__PURE__ */ React32.createElement("li", null, /* @__PURE__ */ React32.createElement("details", null, /* @__PURE__ */ React32.createElement("summary", { className: "hover:bg-base-300 p-0 pr-3" }, menuButton), children)));
  }
  return menuButton;
};
...
var ViewMenu = ({
  ...
  const [isScrolledMode, setScrolledMode] = useState17(viewSettings.scrolled);
  const [zoomLevel, setZoomLevel] = useState17(viewSettings.zoomLevel);
  ...
  return /* @__PURE__ */ React33.createElement(
    ...
    /* @__PURE__ */ React33.createElement("div", { className: clsx24("flex items-center justify-between rounded-md") }, /* @__PURE__ */ React33.createElement(
      "button",
      {
        onClick: zoomOut,
        className: clsx24(
      ...
      /* @__PURE__ */ React33.createElement(MdZoomOut, null)
      ...
      /* @__PURE__ */ React33.createElement(MdZoomIn, null)
    )),
    /* @__PURE__ */ React33.createElement("hr", { className: "border-base-300 my-1" }),
    /* @__PURE__ */ React33.createElement(MenuItem_default, { label: _("Font & Layout"), shortcut: "Shift+F", onClick: openFontLayoutMenu }),
    /* @__PURE__ */ React33.createElement(
      MenuItem_default,
      {
        label: _("Scrolled Mode"),
        shortcut: "Shift+J",
        icon: isScrolledMode ? /* @__PURE__ */ React33.createElement(MdCheck2, null) : void 0,
        onClick: toggleScrolledMode
      }
    ),
    /* @__PURE__ */ React33.createElement("hr", { className: "border-base-300 my-1" }),
    appService?.hasWindow && /* @__PURE__ */ React33.createElement(MenuItem_default, { label: _("Fullscreen"), onClick: handleFullScreen }),
    /* @__PURE__ */ React33.createElement(
      MenuItem_default,
      {
        label: themeMode === "dark" ? _("Dark Mode") : themeMode === "light" ? _("Light Mode") : _("Auto Mode"),
        icon: themeMode === "dark" ? /* @__PURE__ */ React33.createElement(BiMoon, null) : themeMode === "light" ? /* @__PURE__ */ React33.createElement(BiSun, null) : /* @__PURE__ */ React33.createElement(TbSunMoon, null),
...
var HeaderBar = ({
  ...
  const [isDropdownOpen, setIsDropdownOpen] = useState18(false);
  ...
  return /* @__PURE__ */ React34.createElement(
    ...
    /* @__PURE__ */ React34.createElement("div", { className: "sidebar-bookmark-toggler bg-base-100 z-20 flex h-full items-center gap-x-4" }, /* @__PURE__ */ React34.createElement("div", { className: "hidden sm:flex" }, /* @__PURE__ */ React34.createElement(SidebarToggler_default, { bookKey })), /* @__PURE__ */ React34.createElement(BookmarkToggler_default, { bookKey })),
    /* @__PURE__ */ React34.createElement("div", { className: "header-title z-15 pointer-events-none absolute inset-0 hidden items-center justify-center sm:flex" }, /* @__PURE__ */ React34.createElement("h2", { className: "line-clamp-1 max-w-[50%] text-center text-xs font-semibold" }, bookTitle)),
    /* @__PURE__ */ React34.createElement("div", { className: "bg-base-100 z-20 ml-auto flex h-full items-center space-x-4" }, /* @__PURE__ */ React34.createElement(SettingsToggler_default, null), /* @__PURE__ */ React34.createElement(NotebookToggler_default, { bookKey }), /* @__PURE__ */ React34.createElement(
      Dropdown_default,
      {
        className: "exclude-title-bar-mousedown dropdown-bottom dropdown-end",
        buttonClassName: "btn btn-ghost h-8 min-h-8 w-8 p-0",
        toggleButton: /* @__PURE__ */ React34.createElement(PiDotsThreeVerticalBold, { size: iconSize16 }),
        onToggle: handleToggleDropdown
      },
      /* @__PURE__ */ React34.createElement(ViewMenu_default, { bookKey, onSetSettingsDialogOpen })
...
import { IoIosList as TOCIcon2 } from "react-icons/io";
import { PiNotePencil as NoteIcon2 } from "react-icons/pi";
...
import React35, { useEffect as useEffect27, useRef as useRef15, useState as useState19 } from "react";
var Slider = ({
  min = 0,
  max = 100,
  step = 1,
  ...
  const [value, setValue] = useState19(safeInitialValue);
  const [isRtl, setIsRtl] = useState19(false);
  const sliderRef = useRef15(null);
  ...
  return /* @__PURE__ */ React35.createElement(
    ...
    /* @__PURE__ */ React35.createElement("div", { className: "relative", style: { height: `${heightPx}px` } }, /* @__PURE__ */ React35.createElement("div", { className: "bg-base-300/40 absolute h-full w-full rounded-full" }), /* @__PURE__ */ React35.createElement(
      "div",
      {
    ...
    ), /* @__PURE__ */ React35.createElement("div", { className: "absolute inset-0 flex items-center justify-between px-4 text-sm" }, /* @__PURE__ */ React35.createElement("span", { className: `ml-2 ${minClassName}` }, minLabel), /* @__PURE__ */ React35.createElement("span", { className: `mr-2 ${maxClassName}` }, maxLabel)), /* @__PURE__ */ React35.createElement(
      "div",
      {
...
var FooterBar = ({
  ...
  const [actionTab, setActionTab] = React36.useState("");
  ...
  return /* @__PURE__ */ React36.createElement(React36.Fragment, null, /* @__PURE__ */ React36.createElement(
    ...
    /* @__PURE__ */ React36.createElement(
      ...
      /* @__PURE__ */ React36.createElement(
        Button_default,
        {
          icon: viewSettings?.rtl ? /* @__PURE__ */ React36.createElement(RiArrowRightWideLine, null) : /* @__PURE__ */ React36.createElement(RiArrowLeftWideLine, null),
      ...
      /* @__PURE__ */ React36.createElement(
        Button_default,
        {
          icon: viewSettings?.rtl ? /* @__PURE__ */ React36.createElement(RiArrowGoForwardLine, null) : /* @__PURE__ */ React36.createElement(RiArrowGoBackLine, null),
      ...
      /* @__PURE__ */ React36.createElement(
        Button_default,
        {
          icon: viewSettings?.rtl ? /* @__PURE__ */ React36.createElement(RiArrowGoBackLine, null) : /* @__PURE__ */ React36.createElement(RiArrowGoForwardLine, null),
      ...
      /* @__PURE__ */ React36.createElement(
        Button_default,
        {
          icon: viewSettings?.rtl ? /* @__PURE__ */ React36.createElement(RiArrowLeftWideLine, null) : /* @__PURE__ */ React36.createElement(RiArrowRightWideLine, null),
    ...
    /* @__PURE__ */ React36.createElement(
      ...
      /* @__PURE__ */ React36.createElement("div", { className: "flex w-full items-center justify-between gap-x-6" }, /* @__PURE__ */ React36.createElement(
        Slider_default,
        {
          ...
          bubbleElement: /* @__PURE__ */ React36.createElement(TbBoxMargin, { size: marginIconSize }),
          minLabel: _("Small"),
          maxLabel: _("Large"),
          step: 10,
        ...
        Slider_default,
        {
          ...
          bubbleElement: /* @__PURE__ */ React36.createElement(RxLineHeight, { size: marginIconSize }),
          minLabel: _("Small"),
          maxLabel: _("Large"),
          min: 8,
          max: 24,
    ...
    /* @__PURE__ */ React36.createElement(
      ...
      /* @__PURE__ */ React36.createElement(
        Button_default,
        {
          icon: /* @__PURE__ */ React36.createElement(TOCIcon2, { size: tocIconSize, className: "" }),
          onClick: () => handleSetActionTab("toc")
        }
      ),
      /* @__PURE__ */ React36.createElement(Button_default, { icon: /* @__PURE__ */ React36.createElement(NoteIcon2, { className: "" }), onClick: () => handleSetActionTab("note") }),
      /* @__PURE__ */ React36.createElement(
        Button_default,
        {
          icon: /* @__PURE__ */ React36.createElement(SliderIcon, { className: clsx26(actionTab === "progress" && "text-blue-500") }),
      ...
      /* @__PURE__ */ React36.createElement(
        Button_default,
        {
          icon: /* @__PURE__ */ React36.createElement(
            ...
            {
              size: fontIconSize,
              className: clsx26(actionTab === "font" && "text-blue-500")
            }
          ),
          onClick: () => handleSetActionTab("font")
        }
      ),
      /* @__PURE__ */ React36.createElement(Button_default, { icon: /* @__PURE__ */ React36.createElement(TTSIcon, { className: "" }), onClick: () => handleSetActionTab("tts") })
    ),
    /* @__PURE__ */ React36.createElement("div", { className: "hidden w-full items-center gap-x-4 px-4 sm:flex" }, /* @__PURE__ */ React36.createElement(
      Button_default,
      {
        icon: viewSettings?.rtl ? /* @__PURE__ */ React36.createElement(RiArrowRightWideLine, null) : /* @__PURE__ */ React36.createElement(RiArrowLeftWideLine, null),
        onClick: viewSettings?.rtl ? handleGoNext : handleGoPrev,
    ...
    ), /* @__PURE__ */ React36.createElement("span", { className: "mx-2 text-center text-sm" }, progressValid ? `${Math.round(progressFraction * 100)}%` : ""), /* @__PURE__ */ React36.createElement(
      "input",
      {
        type: "range",
    ...
    ), /* @__PURE__ */ React36.createElement(Button_default, { icon: /* @__PURE__ */ React36.createElement(FaHeadphones, null), onClick: handleSpeakText, tooltip: _("Speak") }), /* @__PURE__ */ React36.createElement(
      Button_default,
      {
        icon: viewSettings?.rtl ? /* @__PURE__ */ React36.createElement(RiArrowLeftWideLine, null) : /* @__PURE__ */ React36.createElement(RiArrowRightWideLine, null),
        onClick: viewSettings?.rtl ? handleGoPrev : handleGoNext,
...
var PageInfoView = ({
  ...
  return /* @__PURE__ */ React37.createElement(
    ...
    /* @__PURE__ */ React37.createElement("h2", { className: "text-neutral-content text-right font-sans text-xs font-extralight" }, pageInfo)
  );
};
...
var Ribbon = ({}) => {
  return /* @__PURE__ */ React38.createElement(
    ...
    /* @__PURE__ */ React38.createElement(
      ...
      /* @__PURE__ */ React38.createElement("polygon", { fill: "#F44336", points: "100 100, 50 78, 0 100, 0 0, 100 0" })
    )
  );
};
...
import { RiFontSize as RiFontSize2 } from "react-icons/ri";
import { RiDashboardLine } from "react-icons/ri";
import { VscSymbolColor } from "react-icons/vsc";
import { PiDotsThreeVerticalBold as PiDotsThreeVerticalBold2 } from "react-icons/pi";
import { IoAccessibilityOutline } from "react-icons/io5";
import { MdArrowBackIosNew as MdArrowBackIosNew4, MdArrowForwardIos as MdArrowForwardIos2 } from "react-icons/md";

// src/app/reader/components/settings/FontPanel.tsx
import clsx31 from "clsx";
import React41, { useEffect as useEffect29, useState as useState21 } from "react";

// src/app/reader/components/settings/NumberInput.tsx
import clsx29 from "clsx";
import React39, { useEffect as useEffect28, useState as useState20 } from "react";
...
var NumberInput = ({
  ...
  const [localValue, setLocalValue] = useState20(value);
  ...
  return /* @__PURE__ */ React39.createElement("div", { className: clsx29("config-item", className) }, /* @__PURE__ */ React39.createElement("span", { className: "text-base-content" }, label), /* @__PURE__ */ React39.createElement("div", { className: "text-base-content flex items-center gap-2" }, /* @__PURE__ */ React39.createElement(
    "input",
    {
      type: "text",
      inputMode: "decimal",
    ...
    /* @__PURE__ */ React39.createElement(FiMinus, { className: "h-4 w-4" })
  ), /* @__PURE__ */ React39.createElement(
    "button",
    {
      onClick: increment,
    ...
    /* @__PURE__ */ React39.createElement(FiPlus, { className: "h-4 w-4" })
  )));
};
...
import { MdCheck as MdCheck3 } from "react-icons/md";
var FontDropdown = ({
  family,
  selected,
  options: options2,
  ...
  return /* @__PURE__ */ React40.createElement("div", { className: "dropdown dropdown-top" }, /* @__PURE__ */ React40.createElement(
    "button",
    {
      tabIndex: 0,
    ...
    /* @__PURE__ */ React40.createElement("span", { style: { fontFamily: onGetFontFamily(selectedOption.option, family ?? "") } }, selectedOption.label),
    /* @__PURE__ */ React40.createElement(FiChevronUp, { size: iconSize16 })
    ...
    options2.map(({ option, label }) => /* @__PURE__ */ React40.createElement("li", { key: option, onClick: () => onSelect(option) }, /* @__PURE__ */ React40.createElement("div", { className: "flex items-center px-0" }, /* @__PURE__ */ React40.createElement("span", { style: { minWidth: `${defaultIconSize}px` } }, selected === option && /* @__PURE__ */ React40.createElement(MdCheck3, { className: "text-base-content" })), /* @__PURE__ */ React40.createElement("span", { style: { fontFamily: onGetFontFamily(option, family ?? "") } }, label || option)))),
    moreOptions && moreOptions.length > 0 && /* @__PURE__ */ React40.createElement("li", { className: "dropdown dropdown-left dropdown-top" }, /* @__PURE__ */ React40.createElement("div", { className: "flex items-center px-0" }, /* @__PURE__ */ React40.createElement("span", { style: { minWidth: `${defaultIconSize}px` } }, /* @__PURE__ */ React40.createElement(FiChevronLeft, { size: iconSize16 })), /* @__PURE__ */ React40.createElement("span", null, _("System Fonts"))), /* @__PURE__ */ React40.createElement(
      "ul",
      {
        tabIndex: 0,
        className: clsx30(
      ...
      moreOptions.map((option, index) => /* @__PURE__ */ React40.createElement("li", { key: `${index}-${option.option}`, onClick: () => onSelect(option.option) }, /* @__PURE__ */ React40.createElement("div", { className: "flex items-center px-2" }, /* @__PURE__ */ React40.createElement("span", { style: { minWidth: `${defaultIconSize}px` } }, selected === option.option && /* @__PURE__ */ React40.createElement(MdCheck3, { className: "text-base-content" })), /* @__PURE__ */ React40.createElement("span", { style: { fontFamily: onGetFontFamily(option.option, family ?? "") } }, option.label || option.option))))
    ))
  ));
};
...
var FontFace = ({
  ...
  const _ = useTranslation();
  return /* @__PURE__ */ React41.createElement("div", { className: clsx31("config-item", className) }, /* @__PURE__ */ React41.createElement("span", { className: "" }, label), /* @__PURE__ */ React41.createElement(
...
var FontPanel = ({ bookKey }) => {
  ...
  const [sysFonts, setSysFonts] = useState21(defaultSysFonts);
  const [defaultFontSize, setDefaultFontSize] = useState21(viewSettings.defaultFontSize);
  const [minFontSize, setMinFontSize] = useState21(viewSettings.minimumFontSize);
  const [overrideFont, setOverrideFont] = useState21(viewSettings.overrideFont);
  const [defaultFont, setDefaultFont] = useState21(viewSettings.defaultFont);
  const [defaultCJKFont, setDefaultCJKFont] = useState21(viewSettings.defaultCJKFont);
  const [serifFont, setSerifFont] = useState21(viewSettings.serifFont);
  const [sansSerifFont, setSansSerifFont] = useState21(viewSettings.sansSerifFont);
  const [monospaceFont, setMonospaceFont] = useState21(viewSettings.monospaceFont);
  const [fontWeight, setFontWeight] = useState21(viewSettings.fontWeight);
  const [CJKFonts] = useState21(() => {
  ...
  return /* @__PURE__ */ React41.createElement("div", { className: "my-4 w-full space-y-6" }, /* @__PURE__ */ React41.createElement("div", { className: "w-full" }, /* @__PURE__ */ React41.createElement("h2", { className: "mb-2 font-medium" }, _("Font Size")), /* @__PURE__ */ React41.createElement("div", { className: "card border-base-200 border shadow" }, /* @__PURE__ */ React41.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ React41.createElement(
    NumberInput_default,
    {
  ...
  )))), /* @__PURE__ */ React41.createElement("div", { className: "w-full" }, /* @__PURE__ */ React41.createElement("h2", { className: "mb-2 font-medium" }, _("Font Weight")), /* @__PURE__ */ React41.createElement("div", { className: "card border-base-200 border shadow" }, /* @__PURE__ */ React41.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ React41.createElement(
    NumberInput_default,
    {
      label: _("Font Weight"),
      value: fontWeight,
  ...
  )))), /* @__PURE__ */ React41.createElement("div", { className: "w-full" }, /* @__PURE__ */ React41.createElement("h2", { className: "mb-2 font-medium" }, _("Font Family")), /* @__PURE__ */ React41.createElement("div", { className: "card border-base-200 border shadow" }, /* @__PURE__ */ React41.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ React41.createElement("div", { className: "config-item" }, /* @__PURE__ */ React41.createElement("span", { className: "" }, _("Default Font")), /* @__PURE__ */ React41.createElement(
    FontDropDown_default,
    {
  ...
  )), (isCJKEnv() || view?.language.isCJK) && /* @__PURE__ */ React41.createElement(
    FontFace,
    {
  ...
  ), /* @__PURE__ */ React41.createElement("div", { className: "config-item" }, /* @__PURE__ */ React41.createElement("span", { className: "" }, _("Override Book Font")), /* @__PURE__ */ React41.createElement(
    "input",
    {
      type: "checkbox",
      className: "toggle",
  ...
  ))))), /* @__PURE__ */ React41.createElement("div", { className: "w-full" }, /* @__PURE__ */ React41.createElement("h2", { className: "mb-2 font-medium" }, _("Font Face")), /* @__PURE__ */ React41.createElement("div", { className: "card border-base-200 border shadow" }, /* @__PURE__ */ React41.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ React41.createElement(
    FontFace,
    {
      className: "config-item-top",
      family: "serif",
...
import React42, { useEffect as useEffect30, useState as useState22 } from "react";
...
var LayoutPanel = ({ bookKey }) => {
  ...
  const bookData = getBookData(bookKey);
  const viewSettings = getViewSettings(bookKey);
  const [paragraphMargin, setParagraphMargin] = useState22(viewSettings.paragraphMargin);
  const [lineHeight, setLineHeight] = useState22(viewSettings.lineHeight);
  const [wordSpacing, setWordSpacing] = useState22(viewSettings.wordSpacing);
  const [letterSpacing, setLetterSpacing] = useState22(viewSettings.letterSpacing);
  const [textIndent, setTextIndent] = useState22(viewSettings.textIndent);
  const [fullJustification, setFullJustification] = useState22(viewSettings.fullJustification);
  const [hyphenation, setHyphenation] = useState22(viewSettings.hyphenation);
  const [marginPx, setMarginPx] = useState22(viewSettings.marginPx);
  const [gapPercent, setGapPercent] = useState22(viewSettings.gapPercent);
  const [maxColumnCount, setMaxColumnCount] = useState22(viewSettings.maxColumnCount);
  const [maxInlineSize, setMaxInlineSize] = useState22(viewSettings.maxInlineSize);
  const [maxBlockSize, setMaxBlockSize] = useState22(viewSettings.maxBlockSize);
  const [writingMode, setWritingMode] = useState22(viewSettings.writingMode);
  const [overrideLayout, setOverrideLayout] = useState22(viewSettings.overrideLayout);
  const [isScrolledMode, setScrolledMode] = useState22(viewSettings.scrolled);
  const [doubleBorder, setDoubleBorder] = useState22(viewSettings.doubleBorder);
  const [borderColor, setBorderColor] = useState22(viewSettings.borderColor);
  const [showHeader, setShowHeader] = useState22(viewSettings.showHeader);
  const [showFooter, setShowFooter] = useState22(viewSettings.showFooter);
  useEffect30(() => {
  ...
  return /* @__PURE__ */ React42.createElement("div", { className: "my-4 w-full space-y-6" }, /* @__PURE__ */ React42.createElement("div", { className: "w-full" }, /* @__PURE__ */ React42.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React42.createElement("h2", { className: "font-medium" }, _("Scrolled Mode")), /* @__PURE__ */ React42.createElement(
    "input",
    {
      type: "checkbox",
      className: "toggle",
  ...
  ))), mightBeRTLBook && /* @__PURE__ */ React42.createElement("div", { className: "w-full" }, /* @__PURE__ */ React42.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React42.createElement("h2", { className: "font-medium" }, _("Writing Mode")), /* @__PURE__ */ React42.createElement("div", { className: "flex gap-4" }, /* @__PURE__ */ React42.createElement("div", { className: "lg:tooltip lg:tooltip-bottom", "data-tip": _("Default") }, /* @__PURE__ */ React42.createElement(
    "button",
    {
      className: `btn btn-ghost btn-circle btn-sm ${writingMode === "auto" ? "btn-active bg-base-300" : ""}`,
      onClick: () => setWritingMode("auto")
    },
    /* @__PURE__ */ React42.createElement(MdOutlineAutoMode, null)
  )), /* @__PURE__ */ React42.createElement("div", { className: "lg:tooltip lg:tooltip-bottom", "data-tip": _("Horizontal Direction") }, /* @__PURE__ */ React42.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ React42.createElement(MdOutlineTextRotationNone, null)
  )), /* @__PURE__ */ React42.createElement("div", { className: "lg:tooltip lg:tooltip-bottom", "data-tip": _("Vertical Direction") }, /* @__PURE__ */ React42.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ React42.createElement(MdTextRotateVertical, null)
  )), /* @__PURE__ */ React42.createElement("div", { className: "lg:tooltip lg:tooltip-bottom", "data-tip": _("RTL Direction") }, /* @__PURE__ */ React42.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ React42.createElement(TbTextDirectionRtl, null)
  ))))), viewSettings.vertical && /* @__PURE__ */ React42.createElement("div", { className: "w-full" }, /* @__PURE__ */ React42.createElement("h2", { className: "mb-2 font-medium" }, _("Border Frame")), /* @__PURE__ */ React42.createElement("div", { className: "card bg-base-100 border-base-200 border shadow" }, /* @__PURE__ */ React42.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ React42.createElement("div", { className: "config-item" }, /* @__PURE__ */ React42.createElement("span", { className: "" }, _("Double Border")), /* @__PURE__ */ React42.createElement(
    "input",
    {
      type: "checkbox",
      className: "toggle",
  ...
  )), /* @__PURE__ */ React42.createElement("div", { className: "config-item" }, /* @__PURE__ */ React42.createElement("span", { className: "" }, _("Border Color")), /* @__PURE__ */ React42.createElement("div", { className: "flex gap-4" }, /* @__PURE__ */ React42.createElement(
    "button",
    {
  ...
  )))))), /* @__PURE__ */ React42.createElement("div", { className: "w-full" }, /* @__PURE__ */ React42.createElement("h2", { className: "mb-2 font-medium" }, _("Paragraph")), /* @__PURE__ */ React42.createElement("div", { className: "card bg-base-100 border-base-200 border shadow" }, /* @__PURE__ */ React42.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ React42.createElement(
    NumberInput_default,
    {
  ...
  ), langCode !== "zh" && /* @__PURE__ */ React42.createElement(
    NumberInput_default,
    {
  ...
  ), /* @__PURE__ */ React42.createElement("div", { className: "config-item" }, /* @__PURE__ */ React42.createElement("span", { className: "" }, _("Full Justification")), /* @__PURE__ */ React42.createElement(
    "input",
    {
      type: "checkbox",
      className: "toggle",
  ...
  )), /* @__PURE__ */ React42.createElement("div", { className: "config-item" }, /* @__PURE__ */ React42.createElement("span", { className: "" }, _("Hyphenation")), /* @__PURE__ */ React42.createElement(
    "input",
    {
      type: "checkbox",
      className: "toggle",
  ...
  )), /* @__PURE__ */ React42.createElement("div", { className: "config-item" }, /* @__PURE__ */ React42.createElement("span", { className: "" }, _("Override Book Layout")), /* @__PURE__ */ React42.createElement(
    "input",
    {
      type: "checkbox",
      className: "toggle",
  ...
  ))))), /* @__PURE__ */ React42.createElement("div", { className: "w-full" }, /* @__PURE__ */ React42.createElement("h2", { className: "mb-2 font-medium" }, _("Page")), /* @__PURE__ */ React42.createElement("div", { className: "card bg-base-100 border-base-200 border shadow" }, /* @__PURE__ */ React42.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ React42.createElement("div", { className: "config-item" }, /* @__PURE__ */ React42.createElement("span", { className: "" }, _("Show Header")), /* @__PURE__ */ React42.createElement(
    "input",
    {
      type: "checkbox",
      className: "toggle",
  ...
  )), /* @__PURE__ */ React42.createElement("div", { className: "config-item" }, /* @__PURE__ */ React42.createElement("span", { className: "" }, _("Show Footer")), /* @__PURE__ */ React42.createElement(
    "input",
    {
      type: "checkbox",
      className: "toggle",
...
import React44, { useState as useState25, useEffect as useEffect32 } from "react";
import { MdOutlineLightMode, MdOutlineDarkMode } from "react-icons/md";
import { MdRadioButtonUnchecked, MdRadioButtonChecked } from "react-icons/md";
import { CgColorPicker } from "react-icons/cg";
import { TbSunMoon as TbSunMoon2 } from "react-icons/tb";
...
import React43, { useState as useState23, useEffect as useEffect31, useRef as useRef16 } from "react";
...
var ColorInput = ({ label, value, onChange }) => {
  ...
  return /* @__PURE__ */ React43.createElement("div", { className: "mb-3" }, /* @__PURE__ */ React43.createElement("label", { className: "mb-1 block text-sm font-medium" }, label), /* @__PURE__ */ React43.createElement("div", { className: "flex items-center" }, /* @__PURE__ */ React43.createElement(
    "div",
    {
  ...
  )), isOpen && /* @__PURE__ */ React43.createElement("div", { ref: pickerRef, className: "relative z-50 mt-2" }, /* @__PURE__ */ React43.createElement("div", { className: "absolute" }, /* @__PURE__ */ React43.createElement(
    SketchPicker,
    {
      width: "100%",
      color: value,
...
var ThemeEditor = ({ customTheme, onSave, onDelete, onCancel }) => {
  ...
  const [lightTextColor, setLightTextColor] = useState24(
    customTheme?.colors.light.fg || template.light.fg
  );
  const [lightBackgroundColor, setLightBackgroundColor] = useState24(
    customTheme?.colors.light.bg || template.light.bg
  );
  const [darkTextColor, setDarkTextColor] = useState24(
    customTheme?.colors.dark.fg || template.dark.fg
  );
  const [darkBackgroundColor, setDarkBackgroundColor] = useState24(
    customTheme?.colors.dark.bg || template.dark.bg
  );
  const [themeName, setThemeName] = useState24(customTheme?.label || _("Custom"));
...
var ColorPanel = ({}) => {
  ...
  const [editTheme, setEditTheme] = useState25(null);
  const [customThems, setCustomThemes] = useState25([]);
  const [showCustomThemeEditor, setShowCustomThemeEditor] = useState25(false);
  useEffect32(() => {
    const customThemes = settings.globalReadSettings.customThemes ?? [];
    setCustomThemes(
  ...
  return /* @__PURE__ */ React44.createElement("div", { className: "my-4 w-full space-y-6" }, showCustomThemeEditor ? /* @__PURE__ */ React44.createElement(
    ThemeEditor_default,
    {
  ...
  ) : /* @__PURE__ */ React44.createElement(React44.Fragment, null, /* @__PURE__ */ React44.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React44.createElement("h2", { className: "font-medium" }, _("Theme Mode")), /* @__PURE__ */ React44.createElement("div", { className: "flex gap-4" }, /* @__PURE__ */ React44.createElement("div", { className: "lg:tooltip lg:tooltip-bottom", "data-tip": _("Auto Mode") }, /* @__PURE__ */ React44.createElement(
    "button",
    {
      className: `btn btn-ghost btn-circle btn-sm ${themeMode === "auto" ? "btn-active bg-base-300" : ""}`,
      onClick: () => setThemeMode("auto")
    },
    /* @__PURE__ */ React44.createElement(TbSunMoon2, null)
  )), /* @__PURE__ */ React44.createElement("div", { className: "lg:tooltip lg:tooltip-bottom", "data-tip": _("Light Mode") }, /* @__PURE__ */ React44.createElement(
    "button",
    {
      className: `btn btn-ghost btn-circle btn-sm ${themeMode === "light" ? "btn-active bg-base-300" : ""}`,
      onClick: () => setThemeMode("light")
    },
    /* @__PURE__ */ React44.createElement(MdOutlineLightMode, null)
  )), /* @__PURE__ */ React44.createElement("div", { className: "lg:tooltip lg:tooltip-bottom", "data-tip": _("Dark Mode") }, /* @__PURE__ */ React44.createElement(
    "button",
    {
      className: `btn btn-ghost btn-circle btn-sm ${themeMode === "dark" ? "btn-active bg-base-300" : ""}`,
      onClick: () => setThemeMode("dark")
    },
    /* @__PURE__ */ React44.createElement(MdOutlineDarkMode, null)
  )))), /* @__PURE__ */ React44.createElement("div", null, /* @__PURE__ */ React44.createElement("h2", { className: "mb-2 font-medium" }, _("Theme Color")), /* @__PURE__ */ React44.createElement("div", { className: "grid grid-cols-3 gap-4" }, themes.concat(customThems).map(({ name, label, colors: colors2, isCustomizale }) => /* @__PURE__ */ React44.createElement(
    "label",
    {
      key: name,
    ...
    themeColor === name ? /* @__PURE__ */ React44.createElement(MdRadioButtonChecked, { size: iconSize24 }) : /* @__PURE__ */ React44.createElement(MdRadioButtonUnchecked, { size: iconSize24 }),
    /* @__PURE__ */ React44.createElement("span", null, _(label)),
    isCustomizale && themeColor === name && /* @__PURE__ */ React44.createElement("button", { onClick: () => handleEditTheme(name) }, /* @__PURE__ */ React44.createElement(CgColorPicker, { size: iconSize16, className: "absolute right-2 top-2" }))
  )), /* @__PURE__ */ React44.createElement(
    "label",
    {
    ...
    /* @__PURE__ */ React44.createElement(PiPlus, { size: iconSize24 }),
    /* @__PURE__ */ React44.createElement("span", null, _("Custom"))
  )))));
};
...
import { MdCheck as MdCheck4 } from "react-icons/md";
var DialogMenu = ({ toggleDropdown }) => {
  ...
  return /* @__PURE__ */ React45.createElement(
    ...
    /* @__PURE__ */ React45.createElement(
      ...
      /* @__PURE__ */ React45.createElement("div", { className: "flex items-center" }, /* @__PURE__ */ React45.createElement("span", { style: { minWidth: `${iconSize}px` } }, isFontLayoutSettingsGlobal && /* @__PURE__ */ React45.createElement(MdCheck4, { className: "text-base-content" })), /* @__PURE__ */ React45.createElement(
        "div",
        {
          className: "lg:tooltip",
          "data-tip": isFontLayoutSettingsGlobal ? _("Apply to All Books") : _("Apply to This Book")
        },
        /* @__PURE__ */ React45.createElement("span", { className: "ml-2 whitespace-nowrap" }, _("Global Settings"))
      ))
    )
  );
};
...
import React47, { useEffect as useEffect33, useRef as useRef17, useState as useState26 } from "react";
...
import { MdCheck as MdCheck5 } from "react-icons/md";
var DropDown = ({ selected, options: options2, onSelect }) => {
  const iconSize16 = useResponsiveSize(16);
  const defaultIconSize = useDefaultIconSize();
  return /* @__PURE__ */ React46.createElement("div", { className: "dropdown dropdown-bottom" }, /* @__PURE__ */ React46.createElement(
    "button",
    {
      tabIndex: 0,
      className: "btn btn-sm flex items-center gap-1 px-[20px] font-normal normal-case",
    ...
    /* @__PURE__ */ React46.createElement("span", null, selected.label),
    /* @__PURE__ */ React46.createElement(FiChevronDown, { size: iconSize16 })
    ...
    options2.map(({ option, label }) => /* @__PURE__ */ React46.createElement("li", { key: option, onClick: () => onSelect(option) }, /* @__PURE__ */ React46.createElement("div", { className: "flex items-center px-0" }, /* @__PURE__ */ React46.createElement("span", { style: { minWidth: `${defaultIconSize}px` } }, selected.option === option && /* @__PURE__ */ React46.createElement(MdCheck5, { className: "text-base-content" })), /* @__PURE__ */ React46.createElement("span", null, label || option))))
  ));
};
var DropDown_default = DropDown;
...
var MiscPanel = ({ bookKey }) => {
  ...
  const { getView, getViewSettings, setViewSettings } = useReaderStore();
  const viewSettings = getViewSettings(bookKey);
  const [animated, setAnimated] = useState26(viewSettings.animated);
  const [isDisableClick, setIsDisableClick] = useState26(viewSettings.disableClick);
  const [swapClickArea, setSwapClickArea] = useState26(viewSettings.swapClickArea);
  const [isContinuousScroll, setIsContinuousScroll] = useState26(viewSettings.continuousScroll);
  const [draftStylesheet, setDraftStylesheet] = useState26(viewSettings.userStylesheet);
  const [draftStylesheetSaved, setDraftStylesheetSaved] = useState26(true);
  const [error, setError] = useState26(null);
  const [inputFocusInAndroid, setInputFocusInAndroid] = useState26(false);
  ...
  const handleSelectUILang = (option) => {
    ...
    i18n2.changeLanguage(option ? option : navigator.language);
  };
  useEffect33(() => {
  ...
  return /* @__PURE__ */ React47.createElement(
    ...
    /* @__PURE__ */ React47.createElement("div", { className: "w-full" }, /* @__PURE__ */ React47.createElement("h2", { className: "mb-2 font-medium" }, _("Language")), /* @__PURE__ */ React47.createElement("div", { className: "card border-base-200 bg-base-100 border shadow" }, /* @__PURE__ */ React47.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ React47.createElement("div", { className: "config-item" }, /* @__PURE__ */ React47.createElement("span", { className: "" }, _("Language")), /* @__PURE__ */ React47.createElement(
      DropDown_default,
      {
    ...
    /* @__PURE__ */ React47.createElement("div", { className: "w-full" }, /* @__PURE__ */ React47.createElement("h2", { className: "mb-2 font-medium" }, _("Animation")), /* @__PURE__ */ React47.createElement("div", { className: "card border-base-200 bg-base-100 border shadow" }, /* @__PURE__ */ React47.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ React47.createElement("div", { className: "config-item" }, /* @__PURE__ */ React47.createElement("span", { className: "" }, _("Paging Animation")), /* @__PURE__ */ React47.createElement(
      "input",
      {
        type: "checkbox",
        className: "toggle",
    ...
    /* @__PURE__ */ React47.createElement("div", { className: "w-full" }, /* @__PURE__ */ React47.createElement("h2", { className: "mb-2 font-medium" }, _("Behavior")), /* @__PURE__ */ React47.createElement("div", { className: "card border-base-200 bg-base-100 border shadow" }, /* @__PURE__ */ React47.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ React47.createElement("div", { className: "config-item" }, /* @__PURE__ */ React47.createElement("span", { className: "" }, _("Continuous Scroll")), /* @__PURE__ */ React47.createElement(
      "input",
      {
        type: "checkbox",
        className: "toggle",
    ...
    )), /* @__PURE__ */ React47.createElement("div", { className: "config-item" }, /* @__PURE__ */ React47.createElement("span", { className: "" }, _("Disable Click-to-Flip")), /* @__PURE__ */ React47.createElement(
      "input",
      {
        type: "checkbox",
        className: "toggle",
    ...
    )), /* @__PURE__ */ React47.createElement("div", { className: "config-item" }, /* @__PURE__ */ React47.createElement("span", { className: "" }, _("Swap Click-to-Flip Area")), /* @__PURE__ */ React47.createElement(
      "input",
      {
        type: "checkbox",
        className: "toggle",
    ...
    /* @__PURE__ */ React47.createElement("div", { className: "w-full" }, /* @__PURE__ */ React47.createElement("h2", { className: "mb-2 font-medium" }, _("Custom CSS")), /* @__PURE__ */ React47.createElement(
      "div",
      {
        className: `card border-base-200 bg-base-100 border shadow ${error ? "border-red-500" : ""}`
      },
      /* @__PURE__ */ React47.createElement("div", { className: "relative p-1" }, /* @__PURE__ */ React47.createElement(
        "textarea",
        {
          ref: textareaRef,
          className: clsx34(
    ...
    ), error && /* @__PURE__ */ React47.createElement("p", { className: "mt-1 text-sm text-red-500" }, error))
  );
};
...
var SettingsDialog = ({ bookKey }) => {
  const _ = useTranslation();
  const [isRtl] = useState27(() => getDirFromUILanguage() === "rtl");
  const [activePanel, setActivePanel] = useState27(
  ...
  return /* @__PURE__ */ React48.createElement(React48.Fragment, null, /* @__PURE__ */ React48.createElement(
    Dialog_default,
    {
      ...
      header: /* @__PURE__ */ React48.createElement("div", { className: "flex w-full items-center justify-between" }, /* @__PURE__ */ React48.createElement(
        "button",
        {
          tabIndex: -1,
          onClick: handleClose2,
        ...
        isRtl ? /* @__PURE__ */ React48.createElement(MdArrowForwardIos2, null) : /* @__PURE__ */ React48.createElement(MdArrowBackIosNew4, null)
      ), /* @__PURE__ */ React48.createElement("div", { className: "dialog-tabs flex h-10 max-w-[100%] flex-grow items-center gap-2 pl-4" }, tabConfig.map(({ tab, icon: Icon, label }) => /* @__PURE__ */ React48.createElement(
        "button",
        {
          key: tab,
          className: clsx35(
        ...
        /* @__PURE__ */ React48.createElement(Icon, { className: "mr-0" }),
        window.innerWidth >= 500 ? label : ""
      ))), /* @__PURE__ */ React48.createElement("div", { className: "flex h-full items-center justify-end gap-x-2" }, /* @__PURE__ */ React48.createElement(
        Dropdown_default,
        {
          className: "dropdown-bottom dropdown-end",
          buttonClassName: "btn btn-ghost h-8 min-h-8 w-8 p-0",
          toggleButton: /* @__PURE__ */ React48.createElement(PiDotsThreeVerticalBold2, null)
        },
        /* @__PURE__ */ React48.createElement(DialogMenu_default, null)
    ...
    activePanel === "Font" && /* @__PURE__ */ React48.createElement(FontPanel_default, { bookKey }),
    activePanel === "Layout" && /* @__PURE__ */ React48.createElement(LayoutPanel_default, { bookKey }),
    activePanel === "Color" && /* @__PURE__ */ React48.createElement(ColorPanel_default, { bookKey }),
    activePanel === "Misc" && /* @__PURE__ */ React48.createElement(MiscPanel_default, { bookKey })
  ));
};
var SettingsDialog_default = SettingsDialog;

// src/app/reader/components/annotator/Annotator.tsx
import React55, { useState as useState31, useEffect as useEffect38, useRef as useRef21 } from "react";
import { FiSearch as FiSearch3 } from "react-icons/fi";
...
import { FaHeadphones as FaHeadphones2 } from "react-icons/fa6";
import * as CFI5 from "foliate-js/epubcfi.js";
...
var useNotesSync = (bookKey) => {
  ...
  const lastSyncTime = useRef18(0);
  const syncTimeoutRef = useRef18(null);
  const getNewNotes = () => {
    if (!config?.location) return [];
...
var PopupButton = ({ showTooltip, tooltipText, Icon, onClick }) => {
  const [buttonClicked, setButtonClicked] = useState28(false);
  const handleClick2 = () => {
  ...
  return /* @__PURE__ */ React49.createElement(
    ...
    /* @__PURE__ */ React49.createElement(
      ...
      /* @__PURE__ */ React49.createElement(Icon, null)
    )
  );
};
...
var HighlightOptions = ({
  ...
  const [selectedStyle, setSelectedStyle] = React50.useState(_selectedStyle);
  const [selectedColor, setSelectedColor] = React50.useState(_selectedColor);
  ...
  return /* @__PURE__ */ React50.createElement(
    ...
    /* @__PURE__ */ React50.createElement(
      "div",
      {
        className: clsx36("flex gap-2", isVertical ? "flex-col" : "flex-row"),
        style: isVertical ? { width: size28 } : { height: size28 }
      },
      styles.map((style2) => /* @__PURE__ */ React50.createElement(
        "button",
        {
          key: style2,
    ...
    /* @__PURE__ */ React50.createElement(
      ...
      colors.map((color) => /* @__PURE__ */ React50.createElement(
        "button",
        {
          key: color,
          onClick: () => handleSelectColor(color),
          style: { width: size16, height: size16 },
          className: clsx36(`rounded-full p-0`, selectedColor !== color && `bg-${color}-400`)
        },
        selectedColor === color && /* @__PURE__ */ React50.createElement(FaCheckCircle, { size: size16, className: clsx36(`fill-${color}-400`) })
      ))
    )
  );
};
...
var AnnotationPopup = ({
  ...
  return /* @__PURE__ */ React51.createElement("div", { dir }, /* @__PURE__ */ React51.createElement(
    Popup_default,
    {
    ...
    /* @__PURE__ */ React51.createElement(
      ...
      buttons.map((button, index) => /* @__PURE__ */ React51.createElement(
        PopupButton_default,
        {
          key: index,
  ...
  ), highlightOptionsVisible && /* @__PURE__ */ React51.createElement(
...
import React52, { useEffect as useEffect35, useRef as useRef19, useState as useState29 } from "react";
var WiktionaryPopup = ({
  word,
  lang,
  position,
  ...
  const [lookupWord, setLookupWord] = useState29(word);
  const isLookingUp = useRef19(false);
  ...
  return /* @__PURE__ */ React52.createElement("div", null, /* @__PURE__ */ React52.createElement(
    Popup_default,
    {
      trianglePosition,
      width: popupWidth2,
    ...
    /* @__PURE__ */ React52.createElement("div", { className: "flex h-full flex-col" }, /* @__PURE__ */ React52.createElement("main", { className: "flex-grow overflow-y-auto p-4 font-sans" }), /* @__PURE__ */ React52.createElement("footer", { className: "mt-auto hidden data-[state=loaded]:block data-[state=error]:hidden data-[state=loading]:hidden" }, /* @__PURE__ */ React52.createElement("div", { className: "flex items-center px-4 py-2 text-sm opacity-60" }, "Source: Wiktionary (CC BY-SA)")))
  ));
};
var WiktionaryPopup_default = WiktionaryPopup;

// src/app/reader/components/annotator/WikipediaPopup.tsx
import React53, { useEffect as useEffect36, useRef as useRef20 } from "react";
var WikipediaPopup = ({
  text,
  lang,
  position,
  ...
  const isLoading = useRef20(false);
  useEffect36(() => {
  ...
  return /* @__PURE__ */ React53.createElement("div", null, /* @__PURE__ */ React53.createElement(
    Popup_default,
    {
      width: popupWidth2,
      height: popupHeight2,
    ...
    /* @__PURE__ */ React53.createElement("div", { className: "text-base-content flex h-full flex-col pt-2" }, /* @__PURE__ */ React53.createElement("main", { className: "flex-grow overflow-y-auto px-2 font-sans" }), /* @__PURE__ */ React53.createElement("footer", { className: "mt-auto hidden data-[state=loaded]:block data-[state=error]:hidden data-[state=loading]:hidden" }, /* @__PURE__ */ React53.createElement("div", { className: "flex items-center px-4 py-2 text-sm opacity-60" }, "Source: Wikipedia (CC BY-SA)")))
  ));
};
var WikipediaPopup_default = WikipediaPopup;

// src/app/reader/components/annotator/DeepLPopup.tsx
import React54, { useEffect as useEffect37, useState as useState30 } from "react";
var LANGUAGES = {
  AUTO: "Auto Detect",
  EN: "English",
  DE: "German",
...
var DeepLPopup = ({
  ...
  const _ = useTranslation();
  const { settings, setSettings } = useSettingsStore();
  const [sourceLang, setSourceLang] = useState30("AUTO");
  const [targetLang, setTargetLang] = useState30(settings.globalReadSettings.translateTargetLang);
  const [translation, setTranslation] = useState30(null);
  const [detectedSourceLang, setDetectedSourceLang] = useState30(null);
  ...
  return /* @__PURE__ */ React54.createElement("div", null, /* @__PURE__ */ React54.createElement(
    Popup_default,
    {
      trianglePosition,
      width: popupWidth2,
    ...
    /* @__PURE__ */ React54.createElement("div", { className: "text-neutral-content relative h-[50%] overflow-y-auto border-b border-neutral-400/75 p-4 font-sans" }, /* @__PURE__ */ React54.createElement("div", { className: "mb-2 flex items-center justify-between" }, /* @__PURE__ */ React54.createElement("h1", { className: "text-base font-semibold" }, _("Original Text")), /* @__PURE__ */ React54.createElement(
      "select",
      {
        value: sourceLang,
      ...
      Object.entries(LANGUAGES).map(([code, name]) => {
        return /* @__PURE__ */ React54.createElement("option", { key: code, value: code }, detectedSourceLang && sourceLang === "AUTO" && code === "AUTO" ? `${LANGUAGES[detectedSourceLang] || detectedSourceLang} ` + _("(detected)") : name);
      })
    )), /* @__PURE__ */ React54.createElement("p", { className: "text-base" }, text)),
    /* @__PURE__ */ React54.createElement("div", { className: "text-neutral-content relative h-[50%] overflow-y-auto p-4 font-sans" }, /* @__PURE__ */ React54.createElement("div", { className: "mb-2 flex items-center justify-between" }, /* @__PURE__ */ React54.createElement("h2", { className: "text-base font-semibold" }, _("Translated Text")), /* @__PURE__ */ React54.createElement(
      "select",
      {
        value: targetLang,
      ...
      Object.entries(LANGUAGES).filter(([code]) => code !== "AUTO").map(([code, name]) => /* @__PURE__ */ React54.createElement("option", { key: code, value: code }, name))
    )), loading ? /* @__PURE__ */ React54.createElement("p", { className: "text-base italic text-gray-500" }, _("Loading...")) : error ? /* @__PURE__ */ React54.createElement("p", { className: "text-base text-red-600" }, error) : /* @__PURE__ */ React54.createElement("div", null, /* @__PURE__ */ React54.createElement("p", { className: "text-base" }, translation || "No translation available."), /* @__PURE__ */ React54.createElement("div", { className: "pt-4 text-sm opacity-60" }, "Translated by DeepL.")))
  ));
};
...
var Annotator = ({ bookKey }) => {
  ...
  const view = getView(bookKey);
  const viewSettings = getViewSettings(bookKey);
  const isShowingPopup = useRef21(false);
  const isTextSelected = useRef21(false);
  const isUpToShowPopup = useRef21(false);
  const isTouchstarted = useRef21(false);
  const [selection, setSelection] = useState31();
  const [showAnnotPopup, setShowAnnotPopup] = useState31(false);
  const [showWiktionaryPopup, setShowWiktionaryPopup] = useState31(false);
  const [showWikipediaPopup, setShowWikipediaPopup] = useState31(false);
  const [showDeepLPopup, setShowDeepLPopup] = useState31(false);
  const [trianglePosition, setTrianglePosition] = useState31();
  const [annotPopupPosition, setAnnotPopupPosition] = useState31();
  const [dictPopupPosition, setDictPopupPosition] = useState31();
  const [translatorPopupPosition, setTranslatorPopupPosition] = useState31();
  const [highlightOptionsVisible, setHighlightOptionsVisible] = useState31(false);
  const [selectedStyle, setSelectedStyle] = useState31(
    settings.globalReadSettings.highlightStyle
  );
  const [selectedColor, setSelectedColor] = useState31(
  ...
  const buttons = [
    ...
    { tooltipText: _("Search"), Icon: FiSearch3, onClick: handleSearch },
    ...
    { tooltipText: _("Speak"), Icon: FaHeadphones2, onClick: handleSpeakText }
  ];
  return /* @__PURE__ */ React55.createElement("div", null, showWiktionaryPopup && trianglePosition && dictPopupPosition && /* @__PURE__ */ React55.createElement(
  ...
  ), showWikipediaPopup && trianglePosition && dictPopupPosition && /* @__PURE__ */ React55.createElement(
  ...
  ), showDeepLPopup && trianglePosition && translatorPopupPosition && /* @__PURE__ */ React55.createElement(
    DeepLPopup_default,
    {
      text: selection?.text,
  ...
  ), showAnnotPopup && trianglePosition && annotPopupPosition && /* @__PURE__ */ React55.createElement(
...
import React56, { useEffect as useEffect39, useRef as useRef22, useState as useState32 } from "react";
import { FootnoteHandler } from "foliate-js/footnotes.js";
var popupWidth = 360;
var popupHeight = 88;
var popupPadding = 10;
var FootnotePopup = ({ bookKey, bookDoc }) => {
  const footnoteRef = useRef22(null);
  const footnoteViewRef = useRef22(null);
  const [trianglePosition, setTrianglePosition] = useState32();
  const [popupPosition, setPopupPosition] = useState32();
  const [showPopup, setShowPopup] = useState32(false);
  const { getView, getViewSettings } = useReaderStore();
  const view = getView(bookKey);
  const viewSettings = getViewSettings(bookKey);
  const footnoteHandler = new FootnoteHandler();
  const [gridRect, setGridRect] = useState32(null);
  const [responsiveWidth, setResponsiveWidth] = useState32(popupWidth);
  const [responsiveHeight, setResponsiveHeight] = useState32(popupHeight);
...
${footnoteStyles}`);
  ...
  return /* @__PURE__ */ React56.createElement("div", null, showPopup && /* @__PURE__ */ React56.createElement(
    "div",
    {
...
import React57, { useEffect as useEffect40, useRef as useRef23 } from "react";
var HintInfo = ({
  bookKey,
  showDoubleBorder,
  isVertical,
  ...
  const [hintMessage, setHintMessage] = React57.useState(null);
  const hintTimeout = useRef23(2e3);
  const dismissTimeout = useRef23(null);
  ...
  return /* @__PURE__ */ React57.createElement(
    ...
    /* @__PURE__ */ React57.createElement("h2", { className: clsx38("text-neutral-content text-center font-sans text-xs font-light") }, hintMessage || "")
  );
};
  ...
  return /* @__PURE__ */ React58.createElement(
    ...
    bookKeys.map((bookKey, index) => {
      ...
      return /* @__PURE__ */ React58.createElement(
        ...
        isBookmarked && !hoveredBookKey && /* @__PURE__ */ React58.createElement(Ribbon_default, { width: `${horizontalGapPercent}%` }),
        ...
        /* @__PURE__ */ React58.createElement(FoliateViewer_default, { bookKey, bookDoc, config }),
        viewSettings.vertical && viewSettings.scrolled && /* @__PURE__ */ React58.createElement(React58.Fragment, null, /* @__PURE__ */ React58.createElement(
          "div",
          {
        ...
        viewSettings.vertical && viewSettings.doubleBorder && /* @__PURE__ */ React58.createElement(
        ...
        viewSettings.showHeader && /* @__PURE__ */ React58.createElement(
          SectionInfo_default,
          {
        ...
        viewSettings.showFooter && /* @__PURE__ */ React58.createElement(
          PageInfo_default,
          {
        ...
        /* @__PURE__ */ React58.createElement(Annotator_default, { bookKey }),
        /* @__PURE__ */ React58.createElement(FootnotePopup_default, { bookKey, bookDoc }),
        /* @__PURE__ */ React58.createElement(
          FooterBar_default,
          {
            bookKey,
        ...
        isFontLayoutSettingsDialogOpen && /* @__PURE__ */ React58.createElement(SettingsDialog_default, { bookKey, config })
      );
    })
  );
};
...
import React61, { useState as useState34, useRef as useRef24, useEffect as useEffect43, useCallback as useCallback3 } from "react";
...
import React59, { useState as useState33, useEffect as useEffect42 } from "react";
import { MdPlayCircle, MdPauseCircle, MdFastRewind, MdFastForward, MdAlarm } from "react-icons/md";
import { RiVoiceAiFill } from "react-icons/ri";
import { MdCheck as MdCheck6 } from "react-icons/md";
...
var TTSPanel = ({
  ...
  const viewSettings = getViewSettings(bookKey);
  const [voices, setVoices] = useState33([]);
  const [rate, setRate] = useState33(viewSettings?.ttsRate ?? 1);
  const [selectedVoice, setSelectedVoice] = useState33(viewSettings?.ttsVoice ?? "");
  const [timeoutCountdown, setTimeoutCountdown] = useState33(() => {
  ...
  return /* @__PURE__ */ React59.createElement("div", { className: "flex w-full flex-col items-center justify-center gap-2 rounded-2xl p-4" }, /* @__PURE__ */ React59.createElement("div", { className: "flex w-full flex-col items-center gap-0.5" }, /* @__PURE__ */ React59.createElement(
    "input",
    {
      className: "range",
      type: "range",
  ...
  ), /* @__PURE__ */ React59.createElement("div", { className: "grid w-full grid-cols-7 text-xs" }, /* @__PURE__ */ React59.createElement("span", { className: "text-center" }, "|"), /* @__PURE__ */ React59.createElement("span", { className: "text-center" }, "|"), /* @__PURE__ */ React59.createElement("span", { className: "text-center" }, "|"), /* @__PURE__ */ React59.createElement("span", { className: "text-center" }, "|"), /* @__PURE__ */ React59.createElement("span", { className: "text-center" }, "|"), /* @__PURE__ */ React59.createElement("span", { className: "text-center" }, "|"), /* @__PURE__ */ React59.createElement("span", { className: "text-center" }, "|")), /* @__PURE__ */ React59.createElement("div", { className: "grid w-full grid-cols-7 text-xs" }, /* @__PURE__ */ React59.createElement("span", { className: "text-center" }, _("Slow")), /* @__PURE__ */ React59.createElement("span", { className: "text-center" }), /* @__PURE__ */ React59.createElement("span", { className: "text-center" }, "1.0"), /* @__PURE__ */ React59.createElement("span", { className: "text-center" }, "1.5"), /* @__PURE__ */ React59.createElement("span", { className: "text-center" }, "2.0"), /* @__PURE__ */ React59.createElement("span", { className: "text-center" }), /* @__PURE__ */ React59.createElement("span", { className: "text-center" }, _("Fast")))), /* @__PURE__ */ React59.createElement("div", { className: "flex items-center justify-between space-x-2" }, /* @__PURE__ */ React59.createElement("button", { onClick: onBackward, className: "rounded-full p-1" }, /* @__PURE__ */ React59.createElement(MdFastRewind, { size: iconSize32 })), /* @__PURE__ */ React59.createElement("button", { onClick: onTogglePlay, className: "rounded-full p-1" }, isPlaying ? /* @__PURE__ */ React59.createElement(MdPauseCircle, { size: iconSize48, className: "fill-primary" }) : /* @__PURE__ */ React59.createElement(MdPlayCircle, { size: iconSize48, className: "fill-primary" })), /* @__PURE__ */ React59.createElement("button", { onClick: onForward, className: "rounded-full p-1" }, /* @__PURE__ */ React59.createElement(MdFastForward, { size: iconSize32 })), /* @__PURE__ */ React59.createElement("div", { className: "dropdown dropdown-top" }, /* @__PURE__ */ React59.createElement("button", { className: "flex flex-col items-center justify-center rounded-full p-1" }, /* @__PURE__ */ React59.createElement(MdAlarm, { size: iconSize32 }), timeoutCountdown && /* @__PURE__ */ React59.createElement(
    "span",
    {
      className: clsx40(
    ...
    timeoutOptions.map((option, index) => /* @__PURE__ */ React59.createElement("li", { key: `${index}-${option.value}`, onClick: () => onSelectTimeout(option.value) }, /* @__PURE__ */ React59.createElement("div", { className: "flex items-center px-2" }, /* @__PURE__ */ React59.createElement("span", { style: { minWidth: `${defaultIconSize}px` } }, timeoutOption === option.value && /* @__PURE__ */ React59.createElement(MdCheck6, { className: "text-base-content" })), /* @__PURE__ */ React59.createElement("span", { className: clsx40("text-base sm:text-sm") }, option.label))))
  )), /* @__PURE__ */ React59.createElement("div", { className: "dropdown dropdown-top" }, /* @__PURE__ */ React59.createElement("button", { tabIndex: 0, className: "rounded-full p-1" }, /* @__PURE__ */ React59.createElement(RiVoiceAiFill, { size: iconSize32 })), /* @__PURE__ */ React59.createElement(
    "ul",
    {
      tabIndex: 0,
      className: clsx40(
    ...
    voices.map((voice, index) => /* @__PURE__ */ React59.createElement(
      "li",
      {
        key: `${index}-${voice.id}`,
        onClick: () => !voice.disabled && handleSelectVoice(voice.id)
      },
      /* @__PURE__ */ React59.createElement("div", { className: "flex items-center px-2" }, /* @__PURE__ */ React59.createElement("span", { style: { minWidth: `${defaultIconSize}px` } }, selectedVoice === voice.id && /* @__PURE__ */ React59.createElement(MdCheck6, { className: "text-base-content" })), /* @__PURE__ */ React59.createElement("span", { className: clsx40("text-base sm:text-sm", voice.disabled && "text-gray-400") }, voice.name))
    ))
  ))));
};
...
var TTSIcon2 = ({ isPlaying, onClick }) => {
  const bars = [1, 2, 3, 4];
  return /* @__PURE__ */ React60.createElement("div", { className: "relative h-full w-full cursor-pointer", onClick }, /* @__PURE__ */ React60.createElement("div", { className: "absolute inset-0 overflow-hidden rounded-full bg-gradient-to-r from-blue-500 via-emerald-500 to-violet-500" }, /* @__PURE__ */ React60.createElement(
    "div",
    {
      ...
      style: {
  ...
  )), /* @__PURE__ */ React60.createElement("div", { className: "absolute inset-0 flex items-center justify-center" }, /* @__PURE__ */ React60.createElement("style", null, `
        ...
        `), /* @__PURE__ */ React60.createElement("div", { className: "flex items-end space-x-1" }, bars.map((bar) => /* @__PURE__ */ React60.createElement(
    "div",
    {
      key: bar,
...
var TTSControl = () => {
  ...
  const { getBookData } = useBookDataStore();
  const { getView, getViewSettings } = useReaderStore();
  const [bookKey, setBookKey] = useState34("");
  const [ttsLang, setTtsLang] = useState34("en");
  const [isPlaying, setIsPlaying] = useState34(false);
  const [isPaused, setIsPaused] = useState34(false);
  const [showIndicator, setShowIndicator] = useState34(false);
  const [showPanel, setShowPanel] = useState34(false);
  const [panelPosition, setPanelPosition] = useState34();
  const [trianglePosition, setTrianglePosition] = useState34();
  const [timeoutOption, setTimeoutOption] = useState34(0);
  const [timeoutTimestamp, setTimeoutTimestamp] = useState34(0);
  const [timeoutFunc, setTimeoutFunc] = useState34(null);
  ...
  const iconRef = useRef24(null);
  const ttsControllerRef = useRef24(null);
  const unblockerAudioRef = useRef24(null);
  const unblockAudio = () => {
  ...
  const handleSetRate = useCallback3(
    throttle(async (rate) => {
      const ttsController = ttsControllerRef.current;
      if (ttsController) {
  ...
  const handleSetVoice = useCallback3(
  ...
  return /* @__PURE__ */ React61.createElement("div", null, showPanel && /* @__PURE__ */ React61.createElement(
    "div",
    {
      className: "fixed inset-0",
      onClick: handleDismissPopup,
  ...
  ), showIndicator && /* @__PURE__ */ React61.createElement(
    "div",
    {
      ref: iconRef,
      className: clsx41(
    ...
    /* @__PURE__ */ React61.createElement(TTSIcon_default, { isPlaying, onClick: togglePopup })
  ), showPanel && panelPosition && trianglePosition && /* @__PURE__ */ React61.createElement(
    Popup_default,
    {
      width: popupWidth2,
      height: popupHeight2,
...
var ReaderContent = ({ ids, settings }) => {
  ...
  const [showDetailsBook, setShowDetailsBook] = useState35(null);
  const isInitiating = useRef25(false);
  ...
  if (!bookData || !bookData.book || !bookData.bookDoc) {
    ...
    return loading && /* @__PURE__ */ React62.createElement("div", { className: clsx42("hero hero-content", appService?.isIOSApp ? "h-[100vh]" : "h-dvh") }, /* @__PURE__ */ React62.createElement(Spinner_default, { loading: true }));
  }
  return /* @__PURE__ */ React62.createElement("div", { className: clsx42("flex", appService?.isIOSApp ? "h-[100vh]" : "h-dvh") }, /* @__PURE__ */ React62.createElement(SideBar_default, { onGoToLibrary: handleCloseBooksAndReload }), /* @__PURE__ */ React62.createElement(BooksGrid_default, { bookKeys, onCloseBook: handleCloseBook }), /* @__PURE__ */ React62.createElement(TTSControl_default, null), /* @__PURE__ */ React62.createElement(Notebook_default, null), showDetailsBook && /* @__PURE__ */ React62.createElement(
...
var Reader = ({ bookUrl = "https://cdn.readest.com/books/the-scarlet-letter.epub" }) => {
  ...
  return settings?.globalReadSettings && /* @__PURE__ */ React63.createElement(
    ...
    /* @__PURE__ */ React63.createElement(Suspense, null, /* @__PURE__ */ React63.createElement(ReaderContent_default, { key: bookHash || "default", ids: bookHash || void 0, settings }), /* @__PURE__ */ React63.createElement(Toast, null))
  );
};
