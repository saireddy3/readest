...
EnvProvider.propTypes = {
  children: PropTypes13.node.isRequired
};
var useEnv = () => {
...
Alert.propTypes = {
  ...
  message: PropTypes13.string.isRequired,
  onCancel: PropTypes13.func.isRequired,
  onConfirm: PropTypes13.func.isRequired
};
...
Spinner.propTypes = {
  loading: PropTypes13.bool.isRequired
};
...
Dialog.propTypes = {
  ...
  isOpen: PropTypes13.bool.isRequired,
  children: PropTypes13.node.isRequired,
  snapHeight: PropTypes13.number,
  header: PropTypes13.node,
  title: PropTypes13.string,
  className: PropTypes13.string,
  bgClassName: PropTypes13.string,
  boxClassName: PropTypes13.string,
  contentClassName: PropTypes13.string,
  onClose: PropTypes13.func.isRequired
};
...
BookDetailModal.propTypes = {
  book: PropTypes13.shape({
    title: PropTypes13.string.isRequired,
    author: PropTypes13.string,
    coverImageUrl: PropTypes13.string,
    hash: PropTypes13.string.isRequired,
    lastUpdated: PropTypes13.number,
    uploadedAt: PropTypes13.number
  }).isRequired,
  isOpen: PropTypes13.bool.isRequired,
  onClose: PropTypes13.func.isRequired
};
...
var SidebarContent = ({ bookDoc, sideBarBookKey }) => {
  ...
  const [activeTab, setActiveTab] = useState(((_a = config2 == null ? void 0 : config2.viewSettings) == null ? void 0 : _a.sideBarTab) || "toc");
...
Dropdown.propTypes = {
  className: PropTypes13.string,
  menuClassName: PropTypes13.string,
  buttonClassName: PropTypes13.string,
  toggleButton: PropTypes13.node.isRequired,
  children: PropTypes13.element.isRequired,
  onToggle: PropTypes13.func
};
...
var Option = ({ label, isActive, onClick }) => /* @__PURE__ */ React42__default.createElement(
  ...
  /* @__PURE__ */ React42__default.createElement("div", { className: "flex items-center" }, /* @__PURE__ */ React42__default.createElement("span", { style: { minWidth: `${useResponsiveSize()}px` } }, isActive && /* @__PURE__ */ React42__default.createElement(MdCheck, { className: "text-base-content" })), /* @__PURE__ */ React42__default.createElement("span", { className: "ml-2" }, label))
);
var SearchOptions = ({
  searchConfig,
  menuClassName,
...
var SideBar = ({ onGoToLibrary }) => {
  ...
  return isSideBarVisible ? /* @__PURE__ */ React42__default.createElement(React42__default.Fragment, null, /* @__PURE__ */ React42__default.createElement(
    ...
    /* @__PURE__ */ React42__default.createElement(
      "div",
      {
        className: clsx8("drag-handle absolute right-0 top-0 h-full w-1 cursor-col-resize", {
          "hidden": isMobile
        }),
...
var NotebookHeader = ({ isPinned, handleClose, handleTogglePin }) => {
  const _ = useTranslation();
  return /* @__PURE__ */ React42__default.createElement("div", { className: "flex h-11 items-center justify-between border-b px-3" }, /* @__PURE__ */ React42__default.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React42__default.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ React42__default.createElement(
      MdPushPin,
      {
        className: clsx8("h-5 w-5", isPinned && "rotate-45")
      }
    )
  ), /* @__PURE__ */ React42__default.createElement("span", { className: "font-size-sm font-medium" }, _("Notebook"))), /* @__PURE__ */ React42__default.createElement(
    "button",
    {
      className: "btn btn-ghost btn-sm h-8 min-h-8 w-8 p-0",
      onClick: handleClose,
    ...
    /* @__PURE__ */ React42__default.createElement(MdClose, { className: "h-5 w-5" })
  ));
};
...
var NoteEditor = ({ onSave, onEdit }) => {
  ...
  return /* @__PURE__ */ React42__default.createElement("div", { className: "my-2" }, /* @__PURE__ */ React42__default.createElement(
    "textarea",
    {
      ref: textareaRef,
  ...
  ), /* @__PURE__ */ React42__default.createElement("div", { className: "flex justify-end", dir: "ltr" }, /* @__PURE__ */ React42__default.createElement(
    "button",
    {
...
WindowButton.propTypes = {
  id: PropTypes13.string.isRequired,
  onClick: PropTypes13.func.isRequired,
  ariaLabel: PropTypes13.string.isRequired,
  children: PropTypes13.node.isRequired
};
var WindowButtons = ({
  className,
  ...
  return /* @__PURE__ */ React42__default.createElement(
    ...
    showMinimize && (appService == null ? void 0 : appService.hasWindowBar) && /* @__PURE__ */ React42__default.createElement(WindowButton, { onClick: handleMinimizeClick, ariaLabel: "Minimize", id: "titlebar-minimize" }, /* @__PURE__ */ React42__default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 24 24" }, /* @__PURE__ */ React42__default.createElement("path", { fill: "currentColor", d: "M20 14H4v-2h16" }))),
    showMaximize && (appService == null ? void 0 : appService.hasWindowBar) && /* @__PURE__ */ React42__default.createElement(WindowButton, { onClick: handleMaximizeClick, ariaLabel: "Maximize/Restore", id: "titlebar-maximize" }, /* @__PURE__ */ React42__default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 24 24" }, /* @__PURE__ */ React42__default.createElement("path", { fill: "currentColor", d: "M4 4h16v16H4zm2 4v10h12V8z" })))
  );
};
WindowButtons.propTypes = {
  className: PropTypes13.string,
  headerRef: PropTypes13.object,
  showMinimize: PropTypes13.bool,
  showMaximize: PropTypes13.bool,
  showClose: PropTypes13.bool,
  onMinimize: PropTypes13.func,
  onToggleMaximize: PropTypes13.func,
  onClose: PropTypes13.func
};
...
Button.propTypes = {
  icon: PropTypes13.node.isRequired,
  onClick: PropTypes13.func.isRequired,
  disabled: PropTypes13.bool,
  tooltip: PropTypes13.string,
  tooltipDirection: PropTypes13.oneOf(["top", "bottom", "left", "right"]),
  className: PropTypes13.string
};
...
MenuItem.propTypes = {
  label: PropTypes13.string.isRequired,
  labelClass: PropTypes13.string,
  shortcut: PropTypes13.string,
  disabled: PropTypes13.bool,
  noIcon: PropTypes13.bool,
  icon: PropTypes13.node,
  children: PropTypes13.node,
  onClick: PropTypes13.func
};
...
var ViewMenu = ({
  ...
  return /* @__PURE__ */ React42__default.createElement(
    ...
    /* @__PURE__ */ React42__default.createElement("hr", { className: "border-base-300 my-1" }),
    (appService == null ? void 0 : appService.hasWindow) && /* @__PURE__ */ React42__default.createElement(MenuItem_default, { label: _("Fullscreen"), onClick: handleFullScreen }),
    /* @__PURE__ */ React42__default.createElement(
      MenuItem_default,
      {
...
Slider.propTypes = {
  min: PropTypes13.number,
  max: PropTypes13.number,
  step: PropTypes13.number,
  initialValue: PropTypes13.number,
  heightPx: PropTypes13.number,
  minLabel: PropTypes13.string,
  maxLabel: PropTypes13.string,
  bubbleElement: PropTypes13.node,
  bubbleLabel: PropTypes13.string,
  className: PropTypes13.string,
  minClassName: PropTypes13.string,
  maxClassName: PropTypes13.string,
  bubbleClassName: PropTypes13.string,
  onChange: PropTypes13.func
};
  ...
  return /* @__PURE__ */ React42__default.createElement(React42__default.Fragment, null, /* @__PURE__ */ React42__default.createElement(
    ...
    /* @__PURE__ */ React42__default.createElement(
      ...
      /* @__PURE__ */ React42__default.createElement(
        Button_default,
        {
          icon: (viewSettings == null ? void 0 : viewSettings.rtl) ? /* @__PURE__ */ React42__default.createElement(RiArrowRightWideLine, null) : /* @__PURE__ */ React42__default.createElement(RiArrowLeftWideLine, null),
      ...
      /* @__PURE__ */ React42__default.createElement(
        Button_default,
        {
          icon: (viewSettings == null ? void 0 : viewSettings.rtl) ? /* @__PURE__ */ React42__default.createElement(RiArrowGoForwardLine, null) : /* @__PURE__ */ React42__default.createElement(RiArrowGoBackLine, null),
      ...
      /* @__PURE__ */ React42__default.createElement(
        Button_default,
        {
          icon: (viewSettings == null ? void 0 : viewSettings.rtl) ? /* @__PURE__ */ React42__default.createElement(RiArrowGoBackLine, null) : /* @__PURE__ */ React42__default.createElement(RiArrowGoForwardLine, null),
      ...
      /* @__PURE__ */ React42__default.createElement(
        Button_default,
        {
          icon: (viewSettings == null ? void 0 : viewSettings.rtl) ? /* @__PURE__ */ React42__default.createElement(RiArrowLeftWideLine, null) : /* @__PURE__ */ React42__default.createElement(RiArrowRightWideLine, null),
...
var FontPanel = ({ bookKey }) => {
  ...
  )), (isCJKEnv() || (view == null ? void 0 : view.language.isCJK)) && /* @__PURE__ */ React42__default.createElement(
    FontFace,
    {
...
var ThemeEditor = ({ customTheme, onSave, onDelete, onCancel }) => {
  ...
  const [themeName, setThemeName] = useState((customTheme == null ? void 0 : customTheme.label) || _("Custom"));
...
var Popup = ({
  ...
  triangleClassName = "",
  additionalStyle = {}
}) => /* @__PURE__ */ React42__default.createElement("div", null, /* @__PURE__ */ React42__default.createElement(
  "div",
  {
    id: "popup-container",
...
Popup.propTypes = {
  width: PropTypes13.number.isRequired,
  height: PropTypes13.number.isRequired,
  position: PropTypes13.shape({
    point: PropTypes13.shape({
      x: PropTypes13.number.isRequired,
      y: PropTypes13.number.isRequired
    })
  }),
  trianglePosition: PropTypes13.shape({
    dir: PropTypes13.oneOf(["left", "right", "up", "down"]),
    point: PropTypes13.shape({
      x: PropTypes13.number.isRequired,
      y: PropTypes13.number.isRequired
    })
  ...
  children: PropTypes13.node.isRequired,
  className: PropTypes13.string,
  triangleClassName: PropTypes13.string,
  additionalStyle: PropTypes13.object
};
...
var FootnotePopup = ({ bookKey, bookDoc }) => {
  ...
  const [trianglePosition, setTrianglePosition] = useState(null);
...
var DoubleBorder = ({
  ...
  ), showFooter && /* @__PURE__ */ React42__default.createElement(
    "div",
    {
      className: "borderframe pointer-events-none absolute",
      style: {
  ...
  ), showHeader && /* @__PURE__ */ React42__default.createElement(
    "div",
    {
      className: "borderframe pointer-events-none absolute",
      style: {
  ...
  return /* @__PURE__ */ React42__default.createElement(
    ...
    bookKeys.map((bookKey, index) => {
      ...
      return /* @__PURE__ */ React42__default.createElement(
        ...
        /* @__PURE__ */ React42__default.createElement(FoliateViewer_default, { bookKey, bookDoc, config: config2 }),
        ...
        isFontLayoutSettingsDialogOpen && /* @__PURE__ */ React42__default.createElement(SettingsDialog_default, { bookKey, config: config2 })
      );
    })
  );
};
...
var TTSPanel = ({
  ...
  const [rate, setRate] = useState((viewSettings == null ? void 0 : viewSettings.ttsRate) ?? 1);
  const [selectedVoice, setSelectedVoice] = useState((viewSettings == null ? void 0 : viewSettings.ttsVoice) ?? "");
...
var ReaderContent = ({ ids }) => {
  ...
  if (!bookData || !bookData.book || !bookData.bookDoc) {
    ...
    return loading && /* @__PURE__ */ React42.createElement("div", { className: clsx8("hero hero-content", (appService == null ? void 0 : appService.isIOSApp) ? "h-[100vh]" : "h-dvh") }, /* @__PURE__ */ React42.createElement(Spinner_default, { loading: true }));
  }
  return /* @__PURE__ */ React42.createElement("div", { className: clsx8("flex", (appService == null ? void 0 : appService.isIOSApp) ? "h-[100vh]" : "h-dvh") }, /* @__PURE__ */ React42.createElement(SideBar_default, { onGoToLibrary: handleCloseBooksAndReload }), /* @__PURE__ */ React42.createElement(BooksGrid_default, { bookKeys, onCloseBook: handleCloseBook }), /* @__PURE__ */ React42.createElement(TTSControl_default, null), /* @__PURE__ */ React42.createElement(Notebook_default, null), showDetailsBook && /* @__PURE__ */ React42.createElement(
...
var Reader = ({ bookUrl: propBookUrl }) => {
  ...
  return (settings == null ? void 0 : settings.globalReadSettings) && /* @__PURE__ */ React42.createElement(
    "div",
    {
      className: clsx8(
