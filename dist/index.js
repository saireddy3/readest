...
// src/utils/misc.ts
var import_js_md5, uniqueId, randomMd5, getContentMd5, getUserLang, isCJKEnv, getUserLocale, getOSPlatform, stubTranslation;
var init_misc = __esm({
  "src/utils/misc.ts"() {
    "use strict";
    import_js_md5 = require("js-md5");
    uniqueId = () => Math.random().toString(36).substring(2, 9);
    randomMd5 = () => (0, import_js_md5.md5)(Math.random().toString());
    getContentMd5 = (content) => (0, import_js_md5.md5)(JSON.stringify(content));
    getUserLang = () => {
...
var ALLOWED_FILETYPES, FILE_ACCEPT_FORMATS, DEFAULT_BOOK_LAYOUT, DEFAULT_BOOK_SEARCH_CONFIG, SERIF_FONTS, CJK_SERIF_FONTS, CJK_SANS_SERIF_FONTS, SANS_SERIF_FONTS, MONOSPACE_FONTS, FALLBACK_FONTS, WINDOWS_FONTS, MACOS_FONTS, LINUX_FONTS, IOS_FONTS, ANDROID_FONTS, CJK_NAMES_PATTENS, CJK_FONTS_PATTENS, BOOK_IDS_SEPARATOR, SYNC_PROGRESS_INTERVAL_SEC, SYNC_NOTES_INTERVAL_SEC, CHECK_UPDATE_INTERVAL_SEC, MAX_ZOOM_LEVEL, MIN_ZOOM_LEVEL, ZOOM_STEP, DEFAULT_STORAGE_QUOTA, DOUBLE_CLICK_INTERVAL_THRESHOLD_MS, DISABLE_DOUBLE_CLICK_ON_MOBILE, LONG_HOLD_THRESHOLD, HIGHLIGHT_COLOR_HEX, CUSTOM_THEME_TEMPLATES, MIGHT_BE_RTL_LANGS, TRANSLATED_LANGS;
var init_constants = __esm({
  "src/services/constants.ts"() {
    ...
    FILE_ACCEPT_FORMATS = ALLOWED_FILETYPES.map((ext) => `.${ext}`).join(", ");
    DEFAULT_BOOK_LAYOUT = {
      marginPx: 44,
      gapPercent: 5,
      scrolled: false,
    ...
    CHECK_UPDATE_INTERVAL_SEC = 24 * 60 * 60;
    MAX_ZOOM_LEVEL = 500;
    MIN_ZOOM_LEVEL = 50;
    ZOOM_STEP = 10;
...
var epubcfi, CFI, EXTS, DocumentLoader, getDirection;
var init_document = __esm({
  "src/libs/document.ts"() {
    "use strict";
    epubcfi = __toESM(require("foliate-js/epubcfi.js"));
...
var require_i18next_scanner_config = __commonJS({
  "i18next-scanner.config.js"(exports2, module2) {
    "use strict";
    module2.exports = {
...
// src/utils/s3.ts
var import_client_s3, import_client_s32, import_s3_request_presigner, S3_ENDPOINT, S3_REGION, S3_ACCESS_KEY_ID, S3_SECRET_ACCESS_KEY, s3Client;
var init_s3 = __esm({
  "src/utils/s3.ts"() {
    "use strict";
...
// src/utils/r2.ts
var import_aws4fetch;
var init_r2 = __esm({
  "src/utils/r2.ts"() {
    "use strict";
    import_aws4fetch = require("aws4fetch");
  }
});
...
// src/utils/book.ts
var formatLanguageMap, listFormater, getBookLangCode, formatAuthors, formatTitle, formatPublisher, formatLanguage, primaryLanguage, formatDate, formatSubject, getCurrentPage, getBookDirFromWritingMode, getBookDirFromLanguage;
var init_book = __esm({
  "src/utils/book.ts"() {
    "use strict";
    init_document();
...
function md5Fingerprint(value) {
  return (0, import_js_md52.md5)(value).slice(0, 7);
}
var import_js_md52;
var init_md5 = __esm({
  "src/utils/md5.ts"() {
    "use strict";
    import_js_md52 = require("js-md5");
  }
});
...
var import_js_md54 = require("js-md5");

// src/context/EnvContext.tsx
var import_react = __toESM(require("react"));
init_environment();
var EnvContext = (0, import_react.createContext)(void 0);
var useEnv = () => {
  const context = (0, import_react.useContext)(EnvContext);
...
function hexToOklch(hexColor) {
  const { r, g, b } = (0, import_tinycolor2.default)(hexColor).toRgb();
...
var getContrastOklch = (hexColor) => {
  return (0, import_tinycolor2.default)(hexColor).isDark() ? "100% 0 0" : "0% 0 0";
};
...
var generateLightPalette = ({ bg, fg, primary }) => {
  return {
    "base-100": bg,
    // Main background
    "base-200": (0, import_tinycolor22.default)(bg).darken(5).toHexString(),
    // Slightly darker
    "base-300": (0, import_tinycolor22.default)(bg).darken(12).toHexString(),
    // More darker
    "base-content": fg,
    // Main text color
    neutral: (0, import_tinycolor22.default)(bg).darken(15).desaturate(20).toHexString(),
    // Muted neutral
    "neutral-content": (0, import_tinycolor22.default)(fg).lighten(20).desaturate(20).toHexString(),
    // Slightly lighter text
    primary,
    secondary: (0, import_tinycolor22.default)(primary).lighten(20).toHexString(),
    // Lighter secondary
    accent: (0, import_tinycolor22.default)(primary).analogous()[1].toHexString()
    // Analogous accent
  };
};
var generateDarkPalette = ({ bg, fg, primary }) => {
  return {
    "base-100": bg,
    // Main background
    "base-200": (0, import_tinycolor22.default)(bg).lighten(5).toHexString(),
    // Slightly lighter
    "base-300": (0, import_tinycolor22.default)(bg).lighten(12).toHexString(),
    // More lighter
    "base-content": fg,
    // Main text color
    neutral: (0, import_tinycolor22.default)(bg).lighten(15).desaturate(20).toHexString(),
    // Muted neutral
    "neutral-content": (0, import_tinycolor22.default)(fg).darken(20).desaturate(20).toHexString(),
    // Darkened text
    primary,
    secondary: (0, import_tinycolor22.default)(primary).darken(20).toHexString(),
    // Darker secondary
    accent: (0, import_tinycolor22.default)(primary).triad()[1].toHexString()
    // Triad accent
  };
};
var themes = [
...
// src/utils/style.ts
var import_fonts = __toESM(require("!!raw-loader!../styles/fonts.css"));
init_misc();
...
var useThemeStore = (0, import_zustand.create)((set, get) => {
...
var useSettingsStore = (0, import_zustand2.create)((set) => ({
  settings: {},
...
var useScreenWakeLock = (lock) => {
  const wakeLockRef = (0, import_react3.useRef)(null);
...
// src/components/Toast.tsx
var Toast = () => {
  const [toastMessage, setToastMessage] = (0, import_react4.useState)("");
  const toastType = (0, import_react4.useRef)("info");
  const toastTimeout = (0, import_react4.useRef)(5e3);
  const messageClass = (0, import_react4.useRef)("");
  const toastDismissTimeout = (0, import_react4.useRef)(null);
  const toastClassMap = {
  ...
  return toastMessage && /* @__PURE__ */ import_react4.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react4.default.createElement(
      ...
      /* @__PURE__ */ import_react4.default.createElement(
        ...
        toastMessage.split("\n").map((line, idx) => /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, { key: idx }, line || /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, "\xA0"), /* @__PURE__ */ import_react4.default.createElement("br", null)))
      )
    )
  );
};
...
// src/store/bookDataStore.ts
var import_zustand3 = require("zustand");
var useBookDataStore = (0, import_zustand3.create)((set, get) => ({
  booksData: {},
  getBookData: (keyOrId) => {
...
// src/store/readerStore.ts
var useReaderStore = (0, import_zustand4.create)((set, get) => ({
  viewStates: {},
  bookKeys: [],
  hoveredBookKey: null,
...
var useSidebarStore = (0, import_zustand5.create)((set) => ({
  sideBarBookKey: null,
  sideBarWidth: "",
...
// src/app/reader/hooks/useBooksManager.ts
...
var useBooksManager = () => {
  ...
  const [shouldUpdateSearchParams, setShouldUpdateSearchParams] = (0, import_react5.useState)(false);
...
var useNotebookStore = (0, import_zustand6.create)((set, get) => ({
  notebookWidth: "",
...
var useShortcuts = (actions, dependencies = []) => {
  const [shortcuts, setShortcuts] = (0, import_react6.useState)(loadShortcuts);
...
import_i18next.default.on("languageChanged", (lng) => {
...
var useTranslation = (namespace = "translation") => {
  const { t } = (0, import_react_i18next2.useTranslation)(namespace);
...
var Alert = ({ title, message, onCancel, onConfirm }) => {
  ...
  return /* @__PURE__ */ import_react7.default.createElement("div", { className: (0, import_clsx2.default)("z-[100] flex justify-center px-4") }, /* @__PURE__ */ import_react7.default.createElement(
    "div",
    {
      role: "alert",
    ...
    /* @__PURE__ */ import_react7.default.createElement("div", { className: "flex items-center space-x-2" }, /* @__PURE__ */ import_react7.default.createElement(
      "svg",
      {
    ...
    ), /* @__PURE__ */ import_react7.default.createElement("div", { className: "" }, /* @__PURE__ */ import_react7.default.createElement("h3", { className: "font-sm text-base" }, title), /* @__PURE__ */ import_react7.default.createElement("div", { className: "text-xs" }, message))),
    /* @__PURE__ */ import_react7.default.createElement("div", { className: "flex flex-wrap items-center justify-center gap-2" }, /* @__PURE__ */ import_react7.default.createElement("button", { className: "btn btn-sm", onClick: onCancel }, _("Cancel")), /* @__PURE__ */ import_react7.default.createElement("button", { className: "btn btn-sm btn-warning", onClick: onConfirm }, _("Confirm")))
  ));
};
...
var Spinner = ({ loading }) => {
  ...
  return /* @__PURE__ */ import_react8.default.createElement(
    ...
    /* @__PURE__ */ import_react8.default.createElement("span", { className: "loading loading-dots loading-lg" }),
    /* @__PURE__ */ import_react8.default.createElement("span", { className: "hidden" }, _("Loading..."))
  );
};
...
var useDrag = (onDragMove, onDragEnd) => {
  ...
  const startY = (0, import_react9.useRef)(0);
  const lastX = (0, import_react9.useRef)(0);
  const lastY = (0, import_react9.useRef)(0);
  const startTime = (0, import_react9.useRef)(0);
...
var useResponsiveSize = (baseSize) => {
  const isPhone = (0, import_react_responsive.useMediaQuery)({ maxWidth: 480 });
  const isTablet = (0, import_react_responsive.useMediaQuery)({ minWidth: 481, maxWidth: 1024 });
...
var Dialog = ({
  ...
  const [isFullHeightInMobile, setIsFullHeightInMobile] = import_react10.default.useState(!snapHeight);
  const [isRtl] = (0, import_react10.useState)(() => getDirFromUILanguage() === "rtl");
  ...
  return /* @__PURE__ */ import_react10.default.createElement(
    ...
    /* @__PURE__ */ import_react10.default.createElement(
      "div",
      {
        className: (0, import_clsx4.default)("overlay fixed inset-0 z-10 bg-black/50 sm:bg-black/20", bgClassName),
        onClick: onClose
      }
    ),
    /* @__PURE__ */ import_react10.default.createElement(
      ...
      window.innerWidth < 640 && /* @__PURE__ */ import_react10.default.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ import_react10.default.createElement("div", { className: "bg-base-content/50 h-1 w-10 rounded-full" })
      ),
      /* @__PURE__ */ import_react10.default.createElement("div", { className: "dialog-header bg-base-100 sticky top-1 z-10 flex items-center justify-between px-4" }, header ? header : /* @__PURE__ */ import_react10.default.createElement("div", { className: "flex h-11 w-full items-center justify-between" }, /* @__PURE__ */ import_react10.default.createElement(
        "button",
        {
          tabIndex: -1,
          onClick: onClose,
        ...
        isRtl ? /* @__PURE__ */ import_react10.default.createElement(import_md.MdArrowForwardIos, { size: iconSize22 }) : /* @__PURE__ */ import_react10.default.createElement(import_md.MdArrowBackIosNew, { size: iconSize22 })
      ), /* @__PURE__ */ import_react10.default.createElement("div", { className: "z-15 pointer-events-none absolute inset-0 flex h-11 items-center justify-center" }, /* @__PURE__ */ import_react10.default.createElement("span", { className: "line-clamp-1 text-center font-bold" }, title ?? "")), /* @__PURE__ */ import_react10.default.createElement(
        "button",
        {
          tabIndex: -1,
          onClick: onClose,
...
var BookDetailModal = ({ book, isOpen, onClose }) => {
  ...
  const [showDeleteAlert, setShowDeleteAlert] = (0, import_react11.useState)(false);
  const [bookMeta, setBookMeta] = (0, import_react11.useState)(null);
  ...
  if (!bookMeta)
    return loading && /* @__PURE__ */ import_react11.default.createElement("div", { className: "fixed inset-0 z-50 flex items-center justify-center" }, /* @__PURE__ */ import_react11.default.createElement(Spinner_default, { loading: true }));
  return /* @__PURE__ */ import_react11.default.createElement("div", { className: "fixed inset-0 z-50 flex items-center justify-center" }, /* @__PURE__ */ import_react11.default.createElement(
    Dialog_default,
    {
    ...
    /* @__PURE__ */ import_react11.default.createElement("div", { className: "flex w-full select-text items-center justify-center" }, /* @__PURE__ */ import_react11.default.createElement("div", { className: "relative w-full rounded-lg" }, /* @__PURE__ */ import_react11.default.createElement("div", { className: "mb-10 flex h-40 items-start" }, /* @__PURE__ */ import_react11.default.createElement("div", { className: "book-cover relative mr-10 aspect-[28/41] h-40 items-end shadow-lg" }, /* @__PURE__ */ import_react11.default.createElement(
    ...
    )), /* @__PURE__ */ import_react11.default.createElement("div", { className: "title-author flex h-40 flex-col justify-between" }, /* @__PURE__ */ import_react11.default.createElement("div", null, /* @__PURE__ */ import_react11.default.createElement("p", { className: "text-base-content mb-2 line-clamp-2 break-all text-2xl font-bold" }, formatTitle(book.title) || _("Untitled")), /* @__PURE__ */ import_react11.default.createElement("p", { className: "text-neutral-content line-clamp-1" }, formatAuthors(book.author, bookMeta.language) || _("Unknown"))), window.innerWidth >= 400 && /* @__PURE__ */ import_react11.default.createElement("div", { className: "flex flex-wrap items-center gap-x-4 gap-y-2 py-2" }, /* @__PURE__ */ import_react11.default.createElement(
      "button",
      {
      ...
      _("Delete")
    ), /* @__PURE__ */ import_react11.default.createElement("button", { className: "btn btn-disabled bg-primary/25 hover:bg-primary/85 rounded-xl px-4 text-white" }, _("More Info"))))), window.innerWidth < 400 && /* @__PURE__ */ import_react11.default.createElement("div", { className: "flex flex-wrap items-center gap-x-4 gap-y-2 py-2" }, /* @__PURE__ */ import_react11.default.createElement(
      "button",
      {
      ...
      _("Delete")
    ), /* @__PURE__ */ import_react11.default.createElement("button", { className: "btn btn-disabled bg-primary/25 hover:bg-primary/85 rounded px-4 text-white" }, _("More Info"))), /* @__PURE__ */ import_react11.default.createElement("div", { className: "text-base-content my-4" }, /* @__PURE__ */ import_react11.default.createElement("div", { className: "mb-4 grid grid-cols-2 gap-4 sm:grid-cols-3" }, /* @__PURE__ */ import_react11.default.createElement("div", { className: "overflow-hidden" }, /* @__PURE__ */ import_react11.default.createElement("span", { className: "font-bold" }, _("Publisher:")), /* @__PURE__ */ import_react11.default.createElement("p", { className: "text-neutral-content line-clamp-1 text-sm" }, formatPublisher(bookMeta.publisher || "") || _("Unknown"))), /* @__PURE__ */ import_react11.default.createElement("div", { className: "overflow-hidden" }, /* @__PURE__ */ import_react11.default.createElement("span", { className: "font-bold" }, _("Published:")), /* @__PURE__ */ import_react11.default.createElement("p", { className: "text-neutral-content max-w-28 text-ellipsis text-sm" }, formatDate(bookMeta.published) || _("Unknown"))), /* @__PURE__ */ import_react11.default.createElement("div", { className: "overflow-hidden" }, /* @__PURE__ */ import_react11.default.createElement("span", { className: "font-bold" }, _("Updated:")), /* @__PURE__ */ import_react11.default.createElement("p", { className: "text-neutral-content text-sm" }, formatDate(book.lastUpdated) || "")), /* @__PURE__ */ import_react11.default.createElement("div", { className: "overflow-hidden" }, /* @__PURE__ */ import_react11.default.createElement("span", { className: "font-bold" }, _("Language:")), /* @__PURE__ */ import_react11.default.createElement("p", { className: "text-neutral-content text-sm" }, formatLanguage(bookMeta.language) || _("Unknown"))), /* @__PURE__ */ import_react11.default.createElement("div", { className: "overflow-hidden" }, /* @__PURE__ */ import_react11.default.createElement("span", { className: "font-bold" }, _("Identifier:")), /* @__PURE__ */ import_react11.default.createElement("p", { className: "text-neutral-content line-clamp-1 text-sm" }, bookMeta.identifier || "N/A")), /* @__PURE__ */ import_react11.default.createElement("div", { className: "overflow-hidden" }, /* @__PURE__ */ import_react11.default.createElement("span", { className: "font-bold" }, _("Subjects:")), /* @__PURE__ */ import_react11.default.createElement("p", { className: "text-neutral-content line-clamp-1 text-sm" }, formatSubject(bookMeta.subject) || _("Unknown")))))))
  ), showDeleteAlert && /* @__PURE__ */ import_react11.default.createElement(
    "div",
    {
      className: (0, import_clsx5.default)(
...
var useTrafficLightStore = (0, import_zustand7.create)((set, get) => {
  return {
    appService: void 0,
...
var SidebarHeader = ({ isPinned, isSearchBarVisible, onGoToLibrary, onClose, onTogglePin, onToggleSearchBar }) => {
  ...
  return /* @__PURE__ */ import_react12.default.createElement(
    ...
    /* @__PURE__ */ import_react12.default.createElement("div", { className: "flex items-center gap-x-8" }, /* @__PURE__ */ import_react12.default.createElement(
      "button",
      {
        onClick: onClose,
        className: "btn btn-ghost btn-circle flex h-6 min-h-6 w-6 hover:bg-transparent sm:hidden"
      },
      /* @__PURE__ */ import_react12.default.createElement(import_md3.MdArrowBackIosNew, { size: iconSize22 })
      ...
      /* @__PURE__ */ import_react12.default.createElement(import_io5.IoReload, { className: "fill-base-content" })
    )),
    /* @__PURE__ */ import_react12.default.createElement("div", { className: "flex min-w-24 max-w-32 items-center justify-between sm:size-[70%]" }, /* @__PURE__ */ import_react12.default.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ import_react12.default.createElement(import_fi.FiSearch, { size: iconSize18, className: "text-base-content" })
    ), /* @__PURE__ */ import_react12.default.createElement("div", { className: "right-0 hidden h-8 w-8 items-center justify-center sm:flex" }, /* @__PURE__ */ import_react12.default.createElement(
      "button",
      {
        onClick: onTogglePin,
        className: (0, import_clsx6.default)(
      ...
      isPinned ? /* @__PURE__ */ import_react12.default.createElement(import_md2.MdPushPin, { size: iconSize14 }) : /* @__PURE__ */ import_react12.default.createElement(import_md2.MdOutlinePushPin, { size: iconSize14 })
    )))
  );
};
...
var createExpanderIcon = (isExpanded) => {
  return /* @__PURE__ */ import_react13.default.createElement(
    ...
    /* @__PURE__ */ import_react13.default.createElement("polygon", { points: "0 0, 8 5, 0 10" })
  );
};
var TOCItemView = ({ bookKey, item, depth, expandedItems }) => {
  const [isExpanded, setIsExpanded] = (0, import_react13.useState)(expandedItems.includes(item.href || ""));
  ...
  return /* @__PURE__ */ import_react13.default.createElement("li", { className: "w-full", style: { paddingTop: "1px" } }, /* @__PURE__ */ import_react13.default.createElement(
    "span",
    {
      role: "treeitem",
      tabIndex: -1,
    ...
    item.subitems && /* @__PURE__ */ import_react13.default.createElement("span", { onClick: handleToggleExpand, className: "inline-block cursor-pointer" }, createExpanderIcon(isExpanded)),
  ...
  ), item.subitems && isExpanded && /* @__PURE__ */ import_react13.default.createElement("ol", { role: "group" }, item.subitems.map((subitem, index) => /* @__PURE__ */ import_react13.default.createElement(
    TOCItemView,
    {
      bookKey,
...
var TOCView = ({ bookKey, toc }) => {
  ...
  const progress = getProgress(bookKey);
  const [expandedItems, setExpandedItems] = (0, import_react13.useState)([]);
  const viewRef = (0, import_react13.useRef)(null);
  ...
  return /* @__PURE__ */ import_react13.default.createElement("div", { className: "rounded pt-2" }, /* @__PURE__ */ import_react13.default.createElement("ul", { role: "tree", ref: viewRef, className: "px-2" }, toc && toc.map((item, index) => /* @__PURE__ */ import_react13.default.createElement(
    TOCItemView,
    {
      bookKey,
      key: `${index}-${item.href}`,
...
var CFI3 = __toESM(require("foliate-js/epubcfi.js"));

// src/app/reader/components/sidebar/BooknoteItem.tsx
var import_clsx8 = __toESM(require("clsx"));
var import_react15 = __toESM(require("react"));

// src/app/reader/hooks/useScrollToItem.ts
var import_react14 = require("react");
var CFI2 = __toESM(require("foliate-js/epubcfi.js"));
var useScrollToItem = (cfi, progress) => {
  const viewRef = (0, import_react14.useRef)(null);
  const [isCurrent, setIsCurrent] = (0, import_react14.useState)(false);
  (0, import_react14.useEffect)(() => {
    if (!viewRef.current || !progress) return;
    const { location } = progress;
    const start = CFI2.collapse(location);
    const end = CFI2.collapse(location, true);
    const isCurrent2 = CFI2.compare(cfi, start) >= 0 && CFI2.compare(cfi, end) <= 0;
...
var BooknoteItem = ({ bookKey, item }) => {
  ...
  return /* @__PURE__ */ import_react15.default.createElement(
    ...
    /* @__PURE__ */ import_react15.default.createElement(
      "div",
      {
        className: (0, import_clsx8.default)("min-h-4 p-0 transition-all duration-300 ease-in-out"),
        style: {
          "--top-override": "0.7rem",
          "--end-override": "0.3rem"
        }
      },
      item.note && /* @__PURE__ */ import_react15.default.createElement("span", { className: "content font-size-sm font-normal", dir: "auto" }, item.note),
      /* @__PURE__ */ import_react15.default.createElement("div", { className: "flex items-start" }, item.note && /* @__PURE__ */ import_react15.default.createElement("div", { className: "my-1 me-2 min-h-full self-stretch border-l-2 border-gray-300" }), /* @__PURE__ */ import_react15.default.createElement("div", { className: (0, import_clsx8.default)("content font-size-sm line-clamp-3", item.note && "my-2") }, /* @__PURE__ */ import_react15.default.createElement(
        "span",
        {
          className: (0, import_clsx8.default)(
            "inline",
    ...
    /* @__PURE__ */ import_react15.default.createElement(
      ...
      /* @__PURE__ */ import_react15.default.createElement("div", { className: "flex justify-end space-x-3 p-2", dir: "ltr" }, item.note && /* @__PURE__ */ import_react15.default.createElement(
        "button",
        {
          className: (0, import_clsx8.default)(
...
var BooknoteView = ({ type, bookKey, toc }) => {
  ...
  Object.values(booknoteGroups).forEach((group) => {
    group.booknotes.sort((a, b) => {
      return CFI3.compare(a.cfi, b.cfi);
    });
  });
  const sortedGroups = Object.values(booknoteGroups).sort((a, b) => {
    return a.id - b.id;
  });
  return /* @__PURE__ */ import_react16.default.createElement("div", { className: "rounded pt-2" }, /* @__PURE__ */ import_react16.default.createElement("ul", { role: "tree", className: "px-2" }, sortedGroups.map((group) => /* @__PURE__ */ import_react16.default.createElement("li", { key: group.href, className: "p-2" }, /* @__PURE__ */ import_react16.default.createElement("h3", { className: "content font-size-base line-clamp-1 font-normal" }, group.label), /* @__PURE__ */ import_react16.default.createElement("ul", null, group.booknotes.map((item, index) => /* @__PURE__ */ import_react16.default.createElement(BooknoteItem_default, { key: `${index}-${item.cfi}`, bookKey, item })))))));
};
var BooknoteView_default = BooknoteView;

// src/app/reader/components/sidebar/TabNavigation.tsx
...
var TabNavigation = ({ activeTab, onTabChange }) => {
  ...
  return /* @__PURE__ */ import_react17.default.createElement(
    "div",
    {
      className: (0, import_clsx9.default)("bottom-tab border-base-300/50 bg-base-200 relative flex w-full border-t"),
      dir: "ltr"
    },
    ...
    tabs.map((tab) => /* @__PURE__ */ import_react17.default.createElement(
      "div",
      {
        key: tab,
      ...
      /* @__PURE__ */ import_react17.default.createElement("div", { className: (0, import_clsx9.default)("flex h-6 items-center"), onClick: () => onTabChange(tab) }, tab === "toc" ? /* @__PURE__ */ import_react17.default.createElement(import_io.IoIosList, { className: "mx-auto" }) : tab === "annotations" ? /* @__PURE__ */ import_react17.default.createElement(import_pi.PiNotePencil, { className: "mx-auto" }) : /* @__PURE__ */ import_react17.default.createElement(import_md4.MdBookmarkBorder, { className: "mx-auto" }))
    ))
  );
};
...
var SidebarContent = ({ bookDoc, sideBarBookKey }) => {
  ...
  const [activeTab, setActiveTab] = (0, import_react18.useState)(config?.viewSettings?.sideBarTab || "toc");
  const [fade, setFade] = (0, import_react18.useState)(false);
  const [targetTab, setTargetTab] = (0, import_react18.useState)(activeTab);
  ...
  return /* @__PURE__ */ import_react18.default.createElement(import_react18.default.Fragment, null, /* @__PURE__ */ import_react18.default.createElement(
    ...
    /* @__PURE__ */ import_react18.default.createElement(
      ...
      targetTab === "toc" && bookDoc.toc && /* @__PURE__ */ import_react18.default.createElement(TOCView_default, { toc: bookDoc.toc, bookKey: sideBarBookKey }),
      targetTab === "annotations" && /* @__PURE__ */ import_react18.default.createElement(BooknoteView_default, { type: "annotation", toc: bookDoc.toc ?? [], bookKey: sideBarBookKey }),
      targetTab === "bookmarks" && /* @__PURE__ */ import_react18.default.createElement(BooknoteView_default, { type: "bookmark", toc: bookDoc.toc ?? [], bookKey: sideBarBookKey })
    )
  ), /* @__PURE__ */ import_react18.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react18.default.createElement(TabNavigation_default, { activeTab, onTabChange: handleTabChange })
  ));
};
var Content_default = SidebarContent;

// src/app/reader/components/sidebar/BookCard.tsx
...
var BookCard = ({ book }) => {
  ...
  return /* @__PURE__ */ import_react19.default.createElement("div", { className: "flex h-20 w-full items-center" }, /* @__PURE__ */ import_react19.default.createElement(
  ...
  ), /* @__PURE__ */ import_react19.default.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ import_react19.default.createElement("h4", { className: "line-clamp-2 w-[90%] text-sm font-semibold" }, formatTitle(title)), /* @__PURE__ */ import_react19.default.createElement("p", { className: "truncate text-xs opacity-75" }, formatAuthors(author))), /* @__PURE__ */ import_react19.default.createElement(
    "button",
    {
      className: "btn btn-ghost hover:bg-base-300 h-6 min-h-6 w-6 rounded-full p-0 transition-colors",
      "aria-label": _("More Info")
    },
    /* @__PURE__ */ import_react19.default.createElement(import_md5.MdInfoOutline, { size: iconSize18, className: "fill-base-content", onClick: showBookDetails })
  ));
};
var BookCard_default = BookCard;

// src/app/reader/hooks/useSidebar.ts
...
var Dropdown = ({
  ...
  const childrenWithToggle = (0, import_react21.isValidElement)(children) ? import_react21.default.cloneElement(children, { setIsDropdownOpen, menuClassName }) : children;
  return /* @__PURE__ */ import_react21.default.createElement("div", { className: "dropdown-container" }, isOpen && /* @__PURE__ */ import_react21.default.createElement("div", { className: "fixed inset-0 bg-transparent", onClick: () => setIsDropdownOpen(false) }), /* @__PURE__ */ import_react21.default.createElement("div", { className: (0, import_clsx12.default)("dropdown", className) }, /* @__PURE__ */ import_react21.default.createElement(
    "div",
    {
      tabIndex: -1,
      onClick: toggleDropdown,
      className: (0, import_clsx12.default)("dropdown-toggle", buttonClassName, isOpen && "bg-base-300/50")
    },
    toggleButton
...
// src/app/reader/components/sidebar/SearchOptions.tsx
var import_clsx13 = __toESM(require("clsx"));
var import_react22 = __toESM(require("react"));
var import_md6 = require("react-icons/md");
var Option = ({ label, isActive, onClick }) => /* @__PURE__ */ import_react22.default.createElement(
  "button",
  {
    className: "hover:bg-base-300 flex w-full items-center justify-between rounded-md p-2",
    onClick
  },
  /* @__PURE__ */ import_react22.default.createElement("div", { className: "flex items-center" }, /* @__PURE__ */ import_react22.default.createElement("span", { style: { minWidth: `${useDefaultIconSize()}px` } }, isActive && /* @__PURE__ */ import_react22.default.createElement(import_md6.MdCheck, { className: "text-base-content" })), /* @__PURE__ */ import_react22.default.createElement("span", { className: "ml-2" }, label))
);
var SearchOptions = ({
  searchConfig,
  menuClassName,
  ...
  return /* @__PURE__ */ import_react22.default.createElement(
    ...
    /* @__PURE__ */ import_react22.default.createElement("hr", { className: "border-base-200 my-1" }),
    /* @__PURE__ */ import_react22.default.createElement(
      Option,
      {
        label: _("Match Case"),
...
var SearchBar = ({
  ...
  const { getView, getProgress } = useReaderStore();
  const [searchTerm, setSearchTerm] = (0, import_react23.useState)(term);
  const inputRef = (0, import_react23.useRef)(null);
  const view = getView(bookKey);
  const config = getConfig(bookKey);
  const progress = getProgress(bookKey);
  const searchConfig = config.searchConfig;
  const queuedSearchTerm = (0, import_react23.useRef)("");
  const isSearchPending = (0, import_react23.useRef)(false);
  const searchTimeout = (0, import_react23.useRef)(null);
  ...
  return /* @__PURE__ */ import_react23.default.createElement("div", { className: "relative p-2" }, /* @__PURE__ */ import_react23.default.createElement("div", { className: "bg-base-100 flex h-8 items-center rounded-lg" }, /* @__PURE__ */ import_react23.default.createElement("div", { className: "pl-3" }, /* @__PURE__ */ import_react23.default.createElement(import_fa.FaSearch, { size: iconSize16, className: "text-gray-500" })), /* @__PURE__ */ import_react23.default.createElement(
    "input",
    {
      ref: inputRef,
      type: "text",
  ...
  ), /* @__PURE__ */ import_react23.default.createElement("div", { className: "bg-base-300 flex h-8 w-8 items-center rounded-r-lg" }, /* @__PURE__ */ import_react23.default.createElement(
    Dropdown_default,
    {
      ...
      toggleButton: /* @__PURE__ */ import_react23.default.createElement(import_fa.FaChevronDown, { size: iconSize12, className: "text-gray-500" })
    },
...
// src/app/reader/components/sidebar/SearchResults.tsx
...
var SearchResultItem = ({
  ...
  return /* @__PURE__ */ import_react24.default.createElement(
    ...
    /* @__PURE__ */ import_react24.default.createElement("div", { className: "line-clamp-3" }, /* @__PURE__ */ import_react24.default.createElement("span", { className: "" }, excerpt.pre), /* @__PURE__ */ import_react24.default.createElement("span", { className: "font-semibold" }, excerpt.match), /* @__PURE__ */ import_react24.default.createElement("span", { className: "" }, excerpt.post))
  );
};
var SearchResults = ({ bookKey, results, onSelectResult }) => {
  return /* @__PURE__ */ import_react24.default.createElement("div", { className: "search-results overflow-y-auto p-2 font-sans text-sm font-light" }, /* @__PURE__ */ import_react24.default.createElement("ul", { className: "px-2" }, results.map((result, index) => {
    if ("subitems" in result) {
      return /* @__PURE__ */ import_react24.default.createElement("ul", { key: `${index}-${result.label}` }, /* @__PURE__ */ import_react24.default.createElement("h3", { className: "line-clamp-1 font-normal" }, result.label), /* @__PURE__ */ import_react24.default.createElement("ul", null, result.subitems.map((item, index2) => /* @__PURE__ */ import_react24.default.createElement(
        SearchResultItem,
        {
          key: `${index2}-${item.cfi}`,
          bookKey,
...
var SideBar = ({ onGoToLibrary }) => {
  ...
  const [isSearchBarVisible, setIsSearchBarVisible] = (0, import_react25.useState)(false);
  const [searchResults, setSearchResults] = (0, import_react25.useState)(null);
  ...
  return isSideBarVisible ? /* @__PURE__ */ import_react25.default.createElement(import_react25.default.Fragment, null, /* @__PURE__ */ import_react25.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react25.default.createElement("style", { jsx: true }, `
        ...
        `),
    /* @__PURE__ */ import_react25.default.createElement("div", { className: "flex-shrink-0" }, isMobile && /* @__PURE__ */ import_react25.default.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ import_react25.default.createElement("div", { className: "bg-base-content/50 h-1 w-10 rounded-full" })
      ...
      "div",
      {
        className: (0, import_clsx16.default)("search-bar", {
    ...
    ), /* @__PURE__ */ import_react25.default.createElement("div", { className: "border-base-300/50 border-b px-3" }, /* @__PURE__ */ import_react25.default.createElement(BookCard_default, { book }))),
    isSearchBarVisible && searchResults ? /* @__PURE__ */ import_react25.default.createElement(
    ...
    ) : /* @__PURE__ */ import_react25.default.createElement(Content_default, { bookDoc, sideBarBookKey }),
    /* @__PURE__ */ import_react25.default.createElement(
      "div",
      {
  ...
  ), !isSideBarPinned && /* @__PURE__ */ import_react25.default.createElement(
    "div",
    {
...
// src/app/reader/components/notebook/Header.tsx
...
var NotebookHeader = ({ isPinned, handleClose: handleClose2, handleTogglePin }) => {
  const _ = useTranslation();
  const iconSize14 = useResponsiveSize(14);
  return /* @__PURE__ */ import_react26.default.createElement("div", { className: "notebook-header relative flex h-11 items-center px-3", dir: "ltr" }, /* @__PURE__ */ import_react26.default.createElement("div", { className: "absolute inset-0 flex items-center justify-center space-x-2" }, /* @__PURE__ */ import_react26.default.createElement(import_lu.LuNotebookPen, null), /* @__PURE__ */ import_react26.default.createElement("div", { className: "notebook-title hidden text-sm font-medium sm:flex" }, _("Notebook"))), /* @__PURE__ */ import_react26.default.createElement("div", { className: "z-10 flex items-center gap-x-4" }, /* @__PURE__ */ import_react26.default.createElement(
    "button",
    {
    ...
    isPinned ? /* @__PURE__ */ import_react26.default.createElement(import_md7.MdPushPin, { size: iconSize14 }) : /* @__PURE__ */ import_react26.default.createElement(import_md7.MdOutlinePushPin, { size: iconSize14 })
    ...
    /* @__PURE__ */ import_react26.default.createElement(import_md7.MdArrowBackIosNew, null)
  ), /* @__PURE__ */ import_react26.default.createElement("button", { className: "btn btn-ghost left-0 h-8 min-h-8 w-8 p-0" }, /* @__PURE__ */ import_react26.default.createElement(import_fi2.FiSearch, null))));
};
var Header_default2 = NotebookHeader;

// src/app/reader/components/notebook/NoteEditor.tsx
...
var NoteEditor = ({ onSave, onEdit }) => {
  ...
  const [note, setNote] = import_react27.default.useState("");
  ...
  return /* @__PURE__ */ import_react27.default.createElement("div", { className: "content note-editor-container bg-base-100 mt-2 rounded-md p-2" }, /* @__PURE__ */ import_react27.default.createElement("div", { className: "flex w-full justify-between space-x-2" }, /* @__PURE__ */ import_react27.default.createElement("div", { className: "relative w-full" }, /* @__PURE__ */ import_react27.default.createElement(
    "textarea",
    {
  ...
  ))), /* @__PURE__ */ import_react27.default.createElement("div", { className: "flex items-start pt-2" }, /* @__PURE__ */ import_react27.default.createElement("div", { className: "mr-2 min-h-full self-stretch border-l-2 border-gray-300" }), /* @__PURE__ */ import_react27.default.createElement("div", { className: "content font-size-sm line-clamp-3 py-2" }, /* @__PURE__ */ import_react27.default.createElement("span", { className: "content font-size-xs inline text-gray-500" }, getAnnotationText()))), /* @__PURE__ */ import_react27.default.createElement("div", { className: "flex justify-end p-2", dir: "ltr" }, /* @__PURE__ */ import_react27.default.createElement(
    "button",
    {
      className: (0, import_clsx18.default)(
    ...
    /* @__PURE__ */ import_react27.default.createElement("div", { className: "font-size-sm pr-1 align-bottom text-blue-500" }, _("Save"))
  )));
};
...
var Notebook = ({}) => {
  ...
  return isNotebookVisible ? /* @__PURE__ */ import_react28.default.createElement(import_react28.default.Fragment, null, !isNotebookPinned && /* @__PURE__ */ import_react28.default.createElement("div", { className: "overlay fixed inset-0 z-10 bg-black/20", onClick: handleClickOverlay }), /* @__PURE__ */ import_react28.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react28.default.createElement("style", { jsx: true }, `
          @media (max-width: 640px) {
            .notebook-container {
              width: 100%;
              min-width: 100%;
    ...
    /* @__PURE__ */ import_react28.default.createElement("div", { className: "max-h-[calc(100vh-44px)] overflow-y-auto px-3" }, /* @__PURE__ */ import_react28.default.createElement("div", { dir: "ltr" }, excerptNotes.length > 0 && /* @__PURE__ */ import_react28.default.createElement("p", { className: "content font-size-base pt-1" }, _("Excerpts"))), /* @__PURE__ */ import_react28.default.createElement("ul", { className: "" }, excerptNotes.map((item, index) => /* @__PURE__ */ import_react28.default.createElement("li", { key: `${index}-${item.id}`, className: "my-2" }, /* @__PURE__ */ import_react28.default.createElement(
      "div",
      {
        tabIndex: 0,
      ...
      /* @__PURE__ */ import_react28.default.createElement(
        ...
        /* @__PURE__ */ import_react28.default.createElement("p", { className: "line-clamp-1" }, item.text || `Excerpt ${index + 1}`)
      ),
      /* @__PURE__ */ import_react28.default.createElement("div", { className: "collapse-content font-size-xs select-text px-3 pb-0" }, /* @__PURE__ */ import_react28.default.createElement("p", { className: "hyphens-auto text-justify" }, item.text), /* @__PURE__ */ import_react28.default.createElement("div", { className: "flex justify-end", dir: "ltr" }, /* @__PURE__ */ import_react28.default.createElement(
        "div",
        {
    ...
    )))), /* @__PURE__ */ import_react28.default.createElement("div", { dir: "ltr" }, (notebookNewAnnotation || annotationNotes.length > 0) && /* @__PURE__ */ import_react28.default.createElement("p", { className: "content font-size-base pt-1" }, _("Notes"))), (notebookNewAnnotation || notebookEditAnnotation) && /* @__PURE__ */ import_react28.default.createElement(NoteEditor_default, { onSave: handleSaveNote, onEdit: (item) => handleEditNote(item, false) }), /* @__PURE__ */ import_react28.default.createElement("ul", null, annotationNotes.map((item, index) => /* @__PURE__ */ import_react28.default.createElement(BooknoteItem_default, { key: `${index}-${item.cfi}`, bookKey: sideBarBookKey, item }))))
  )) : null;
};
...
// src/app/reader/hooks/useIframeEvents.ts
...
// src/app/reader/hooks/useFoliateEvents.ts
...
var SyncContext = (0, import_react31.createContext)({ syncClient });
var useSyncContext = () => (0, import_react31.useContext)(SyncContext);
...
function useSync(bookKey) {
  ...
  const [syncingBooks, setSyncingBooks] = (0, import_react32.useState)(false);
  const [syncingConfigs, setSyncingConfigs] = (0, import_react32.useState)(false);
  const [syncingNotes, setSyncingNotes] = (0, import_react32.useState)(false);
  const [syncError, setSyncError] = (0, import_react32.useState)(null);
  const [lastSyncedAtBooks, setLastSyncedAtBooks] = (0, import_react32.useState)(0);
  const [lastSyncedAtConfigs, setLastSyncedAtConfigs] = (0, import_react32.useState)(0);
  const [lastSyncedAtNotes, setLastSyncedAtNotes] = (0, import_react32.useState)(0);
  const lastSyncedAtInited = (0, import_react32.useRef)(false);
  const [syncing, setSyncing] = (0, import_react32.useState)(false);
  const [syncResult, setSyncResult] = (0, import_react32.useState)({
    books: null,
    configs: null,
    notes: null
  });
  const [syncedBooks, setSyncedBooks] = (0, import_react32.useState)(null);
  const [syncedConfigs, setSyncedConfigs] = (0, import_react32.useState)(null);
  const [syncedNotes, setSyncedNotes] = (0, import_react32.useState)(null);
...
var useProgressSync = (bookKey) => {
  ...
  const config = getConfig(bookKey);
  const progress = getProgress(bookKey);
  const configSynced = (0, import_react33.useRef)(false);
  const firstPulled = (0, import_react33.useRef)(false);
  ...
  const lastProgressSyncTime = (0, import_react33.useRef)(0);
  const syncTimeoutRef = (0, import_react33.useRef)(null);
  (0, import_react33.useEffect)(() => {
...
var useProgressAutoSave = (bookKey) => {
  ...
  const { getProgress } = useReaderStore();
  const progress = getProgress(bookKey);
  const saveBookConfig = (0, import_react34.useCallback)(
    throttle(async () => {
      const config = getConfig(bookKey);
...
// src/hooks/useUICSS.ts
var import_react35 = require("react");
var useUICSS = (bookKey, viewSettings) => {
  const [styleElement, setStyleElement] = (0, import_react35.useState)(null);
...
var FoliateViewer = ({ bookKey, bookDoc, config }) => {
  ...
  const viewRef = (0, import_react36.useRef)(null);
  const isViewCreated = (0, import_react36.useRef)(false);
  const { setView: setFoliateView, setProgress } = useReaderStore();
  const { getViewSettings, setViewSettings } = useReaderStore();
  const { themeCode, isDarkMode } = useThemeStore();
  const viewSettings = getViewSettings(bookKey);
  const [toastMessage, setToastMessage] = (0, import_react36.useState)("");
...
// src/app/reader/components/SectionInfo.tsx
...
var WindowButton = ({ onClick, ariaLabel, id, children }) => /* @__PURE__ */ import_react38.default.createElement(
  "button",
  {
    id,
    onClick,
...
var WindowButtons = ({
  ...
  const parentRef = (0, import_react38.useRef)(null);
  const { appService } = useEnv();
  ...
  return /* @__PURE__ */ import_react38.default.createElement(
    ...
    showMinimize && appService?.hasWindowBar && /* @__PURE__ */ import_react38.default.createElement(WindowButton, { onClick: handleMinimizeClick, ariaLabel: "Minimize", id: "titlebar-minimize" }, /* @__PURE__ */ import_react38.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 24 24" }, /* @__PURE__ */ import_react38.default.createElement("path", { fill: "currentColor", d: "M20 14H4v-2h16" }))),
    showMaximize && appService?.hasWindowBar && /* @__PURE__ */ import_react38.default.createElement(WindowButton, { onClick: handleMaximizeClick, ariaLabel: "Maximize/Restore", id: "titlebar-maximize" }, /* @__PURE__ */ import_react38.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 24 24" }, /* @__PURE__ */ import_react38.default.createElement("path", { fill: "currentColor", d: "M4 4h16v16H4zm2 4v10h12V8z" }))),
    showClose && (appService?.hasWindowBar || onClose) && /* @__PURE__ */ import_react38.default.createElement(WindowButton, { onClick: handleCloseClick, ariaLabel: "Close", id: "titlebar-close" }, /* @__PURE__ */ import_react38.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 24 24" }, /* @__PURE__ */ import_react38.default.createElement(
      "path",
      {
        fill: "currentColor",
        d: "M19 6.41L17.59 5L12 10.59L6.41 5L5 6.41L10.59 12L5 17.59L6.41 19L12 13.41L17.59 19L19 17.59L13.41 12z"
...
var SidebarToggler = ({ bookKey }) => {
  ...
  return /* @__PURE__ */ import_react40.default.createElement(
    Button_default,
    {
      icon: sideBarBookKey === bookKey && isSideBarVisible ? /* @__PURE__ */ import_react40.default.createElement(import_tb.TbLayoutSidebarFilled, { className: "text-base-content" }) : /* @__PURE__ */ import_react40.default.createElement(import_tb.TbLayoutSidebar, { className: "text-base-content" }),
...
// src/app/reader/components/BookmarkToggler.tsx
var import_react41 = __toESM(require("react"));
var import_md8 = require("react-icons/md");
var CFI4 = __toESM(require("foliate-js/epubcfi.js"));
init_misc();
init_book();
var BookmarkToggler = ({ bookKey }) => {
  ...
  const [isBookmarked, setIsBookmarked] = (0, import_react41.useState)(false);
  ...
  return /* @__PURE__ */ import_react41.default.createElement(
    Button_default,
    {
      icon: isBookmarked ? /* @__PURE__ */ import_react41.default.createElement(import_md8.MdOutlineBookmark, { className: "text-base-content" }) : /* @__PURE__ */ import_react41.default.createElement(import_md8.MdOutlineBookmarkAdd, { className: "text-base-content" }),
...
// src/app/reader/components/NotebookToggler.tsx
...
var NotebookToggler = ({ bookKey }) => {
  ...
  return /* @__PURE__ */ import_react42.default.createElement(
    Button_default,
    {
      icon: sideBarBookKey == bookKey && isNotebookVisible ? /* @__PURE__ */ import_react42.default.createElement(import_lu2.LuNotebookPen, { size: iconSize16, className: "text-base-content" }) : /* @__PURE__ */ import_react42.default.createElement(import_lu2.LuNotebookPen, { size: iconSize16, className: "text-base-content" }),
      onClick: handleToggleSidebar,
      tooltip: _("Notebook"),
      tooltipDirection: "bottom"
    }
...
// src/app/reader/components/SettingsToggler.tsx
...
var SettingsToggler = () => {
  ...
  return /* @__PURE__ */ import_react43.default.createElement(
    Button_default,
    {
      icon: /* @__PURE__ */ import_react43.default.createElement(import_ri.RiFontSize, { className: "text-base-content" }),
...
var MenuItem = ({
  ...
  const menuButton = /* @__PURE__ */ import_react44.default.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ import_react44.default.createElement("div", { className: "flex min-w-0 items-center" }, !noIcon && /* @__PURE__ */ import_react44.default.createElement("span", { style: { minWidth: `${iconSize}px` } }, icon), /* @__PURE__ */ import_react44.default.createElement(
      "span",
      {
        className: (0, import_clsx23.default)("mx-2 flex-1 truncate text-base sm:text-sm", labelClass),
        style: { minWidth: 0 }
      },
      label
    )),
    shortcut && /* @__PURE__ */ import_react44.default.createElement(
      "kbd",
      {
        className: (0, import_clsx23.default)(
  ...
  if (children) {
    return /* @__PURE__ */ import_react44.default.createElement("ul", { className: "menu rounded-box m-0 p-0" }, /* @__PURE__ */ import_react44.default.createElement("li", null, /* @__PURE__ */ import_react44.default.createElement("details", null, /* @__PURE__ */ import_react44.default.createElement("summary", { className: "hover:bg-base-300 p-0 pr-3" }, menuButton), children)));
  }
  return menuButton;
};
...
var ViewMenu = ({
  ...
  const [isScrolledMode, setScrolledMode] = (0, import_react46.useState)(viewSettings.scrolled);
  const [zoomLevel, setZoomLevel] = (0, import_react46.useState)(viewSettings.zoomLevel);
  ...
  return /* @__PURE__ */ import_react45.default.createElement(
    ...
    /* @__PURE__ */ import_react45.default.createElement("div", { className: (0, import_clsx24.default)("flex items-center justify-between rounded-md") }, /* @__PURE__ */ import_react45.default.createElement(
      "button",
      {
        onClick: zoomOut,
      ...
      /* @__PURE__ */ import_react45.default.createElement(import_md9.MdZoomOut, null)
      ...
      /* @__PURE__ */ import_react45.default.createElement(import_md9.MdZoomIn, null)
    )),
    /* @__PURE__ */ import_react45.default.createElement("hr", { className: "border-base-300 my-1" }),
    /* @__PURE__ */ import_react45.default.createElement(MenuItem_default, { label: _("Font & Layout"), shortcut: "Shift+F", onClick: openFontLayoutMenu }),
    /* @__PURE__ */ import_react45.default.createElement(
      MenuItem_default,
      {
        label: _("Scrolled Mode"),
        shortcut: "Shift+J",
        icon: isScrolledMode ? /* @__PURE__ */ import_react45.default.createElement(import_md9.MdCheck, null) : void 0,
        onClick: toggleScrolledMode
      }
    ),
    /* @__PURE__ */ import_react45.default.createElement("hr", { className: "border-base-300 my-1" }),
    appService?.hasWindow && /* @__PURE__ */ import_react45.default.createElement(MenuItem_default, { label: _("Fullscreen"), onClick: handleFullScreen }),
    /* @__PURE__ */ import_react45.default.createElement(
      MenuItem_default,
      {
        label: themeMode === "dark" ? _("Dark Mode") : themeMode === "light" ? _("Light Mode") : _("Auto Mode"),
        icon: themeMode === "dark" ? /* @__PURE__ */ import_react45.default.createElement(import_bi.BiMoon, null) : themeMode === "light" ? /* @__PURE__ */ import_react45.default.createElement(import_bi.BiSun, null) : /* @__PURE__ */ import_react45.default.createElement(import_tb2.TbSunMoon, null),
...
var HeaderBar = ({
  ...
  const [isDropdownOpen, setIsDropdownOpen] = (0, import_react47.useState)(false);
  ...
  return /* @__PURE__ */ import_react47.default.createElement(
    ...
    /* @__PURE__ */ import_react47.default.createElement("div", { className: "sidebar-bookmark-toggler bg-base-100 z-20 flex h-full items-center gap-x-4" }, /* @__PURE__ */ import_react47.default.createElement("div", { className: "hidden sm:flex" }, /* @__PURE__ */ import_react47.default.createElement(SidebarToggler_default, { bookKey })), /* @__PURE__ */ import_react47.default.createElement(BookmarkToggler_default, { bookKey })),
    /* @__PURE__ */ import_react47.default.createElement("div", { className: "header-title z-15 pointer-events-none absolute inset-0 hidden items-center justify-center sm:flex" }, /* @__PURE__ */ import_react47.default.createElement("h2", { className: "line-clamp-1 max-w-[50%] text-center text-xs font-semibold" }, bookTitle)),
    /* @__PURE__ */ import_react47.default.createElement("div", { className: "bg-base-100 z-20 ml-auto flex h-full items-center space-x-4" }, /* @__PURE__ */ import_react47.default.createElement(SettingsToggler_default, null), /* @__PURE__ */ import_react47.default.createElement(NotebookToggler_default, { bookKey }), /* @__PURE__ */ import_react47.default.createElement(
      Dropdown_default,
      {
        className: "exclude-title-bar-mousedown dropdown-bottom dropdown-end",
        buttonClassName: "btn btn-ghost h-8 min-h-8 w-8 p-0",
        toggleButton: /* @__PURE__ */ import_react47.default.createElement(import_pi2.PiDotsThreeVerticalBold, { size: iconSize16 }),
        onToggle: handleToggleDropdown
      },
      /* @__PURE__ */ import_react47.default.createElement(ViewMenu_default, { bookKey, onSetSettingsDialogOpen })
...
var import_rx2 = require("react-icons/rx");
...
var Slider = ({
  ...
  const [value, setValue] = (0, import_react48.useState)(safeInitialValue);
  const [isRtl, setIsRtl] = (0, import_react48.useState)(false);
  ...
  return /* @__PURE__ */ import_react48.default.createElement(
    ...
    /* @__PURE__ */ import_react48.default.createElement("div", { className: "relative", style: { height: `${heightPx}px` } }, /* @__PURE__ */ import_react48.default.createElement("div", { className: "bg-base-300/40 absolute h-full w-full rounded-full" }), /* @__PURE__ */ import_react48.default.createElement(
      "div",
      {
    ...
    ), /* @__PURE__ */ import_react48.default.createElement("div", { className: "absolute inset-0 flex items-center justify-between px-4 text-sm" }, /* @__PURE__ */ import_react48.default.createElement("span", { className: `ml-2 ${minClassName}` }, minLabel), /* @__PURE__ */ import_react48.default.createElement("span", { className: `mr-2 ${maxClassName}` }, maxLabel)), /* @__PURE__ */ import_react48.default.createElement(
      "div",
      {
...
var FooterBar = ({
  ...
  const [actionTab, setActionTab] = import_react49.default.useState("");
  ...
  return /* @__PURE__ */ import_react49.default.createElement(import_react49.default.Fragment, null, /* @__PURE__ */ import_react49.default.createElement(
    ...
    /* @__PURE__ */ import_react49.default.createElement(
      ...
      /* @__PURE__ */ import_react49.default.createElement(
        Button_default,
        {
          icon: viewSettings?.rtl ? /* @__PURE__ */ import_react49.default.createElement(import_ri2.RiArrowRightWideLine, null) : /* @__PURE__ */ import_react49.default.createElement(import_ri2.RiArrowLeftWideLine, null),
      ...
      /* @__PURE__ */ import_react49.default.createElement(
        Button_default,
        {
          icon: viewSettings?.rtl ? /* @__PURE__ */ import_react49.default.createElement(import_ri3.RiArrowGoForwardLine, null) : /* @__PURE__ */ import_react49.default.createElement(import_ri3.RiArrowGoBackLine, null),
      ...
      /* @__PURE__ */ import_react49.default.createElement(
        Button_default,
        {
          icon: viewSettings?.rtl ? /* @__PURE__ */ import_react49.default.createElement(import_ri3.RiArrowGoBackLine, null) : /* @__PURE__ */ import_react49.default.createElement(import_ri3.RiArrowGoForwardLine, null),
      ...
      /* @__PURE__ */ import_react49.default.createElement(
        Button_default,
        {
          icon: viewSettings?.rtl ? /* @__PURE__ */ import_react49.default.createElement(import_ri2.RiArrowLeftWideLine, null) : /* @__PURE__ */ import_react49.default.createElement(import_ri2.RiArrowRightWideLine, null),
    ...
    /* @__PURE__ */ import_react49.default.createElement(
      ...
      /* @__PURE__ */ import_react49.default.createElement("div", { className: "flex w-full items-center justify-between gap-x-6" }, /* @__PURE__ */ import_react49.default.createElement(
        Slider_default,
        {
          ...
          bubbleElement: /* @__PURE__ */ import_react49.default.createElement(import_tb3.TbBoxMargin, { size: marginIconSize }),
          minLabel: _("Small"),
          maxLabel: _("Large"),
          step: 10,
        ...
        Slider_default,
        {
          ...
          bubbleElement: /* @__PURE__ */ import_react49.default.createElement(import_rx2.RxLineHeight, { size: marginIconSize }),
          minLabel: _("Small"),
          maxLabel: _("Large"),
          min: 8,
          max: 24,
    ...
    /* @__PURE__ */ import_react49.default.createElement(
      ...
      /* @__PURE__ */ import_react49.default.createElement(
        Button_default,
        {
          icon: /* @__PURE__ */ import_react49.default.createElement(import_io2.IoIosList, { size: tocIconSize, className: "" }),
          onClick: () => handleSetActionTab("toc")
        }
      ),
      /* @__PURE__ */ import_react49.default.createElement(Button_default, { icon: /* @__PURE__ */ import_react49.default.createElement(import_pi3.PiNotePencil, { className: "" }), onClick: () => handleSetActionTab("note") }),
      /* @__PURE__ */ import_react49.default.createElement(
        Button_default,
        {
          icon: /* @__PURE__ */ import_react49.default.createElement(import_rx.RxSlider, { className: (0, import_clsx26.default)(actionTab === "progress" && "text-blue-500") }),
      ...
      /* @__PURE__ */ import_react49.default.createElement(
        Button_default,
        {
          icon: /* @__PURE__ */ import_react49.default.createElement(
            import_ri4.RiFontFamily,
            {
              size: fontIconSize,
              className: (0, import_clsx26.default)(actionTab === "font" && "text-blue-500")
            }
          ),
          onClick: () => handleSetActionTab("font")
        }
      ),
      /* @__PURE__ */ import_react49.default.createElement(Button_default, { icon: /* @__PURE__ */ import_react49.default.createElement(import_md10.MdOutlineHeadphones, { className: "" }), onClick: () => handleSetActionTab("tts") })
    ),
    /* @__PURE__ */ import_react49.default.createElement("div", { className: "hidden w-full items-center gap-x-4 px-4 sm:flex" }, /* @__PURE__ */ import_react49.default.createElement(
      Button_default,
      {
        icon: viewSettings?.rtl ? /* @__PURE__ */ import_react49.default.createElement(import_ri2.RiArrowRightWideLine, null) : /* @__PURE__ */ import_react49.default.createElement(import_ri2.RiArrowLeftWideLine, null),
        onClick: viewSettings?.rtl ? handleGoNext : handleGoPrev,
    ...
    ), /* @__PURE__ */ import_react49.default.createElement("span", { className: "mx-2 text-center text-sm" }, progressValid ? `${Math.round(progressFraction * 100)}%` : ""), /* @__PURE__ */ import_react49.default.createElement(
      "input",
      {
        type: "range",
    ...
    ), /* @__PURE__ */ import_react49.default.createElement(Button_default, { icon: /* @__PURE__ */ import_react49.default.createElement(import_fa6.FaHeadphones, null), onClick: handleSpeakText, tooltip: _("Speak") }), /* @__PURE__ */ import_react49.default.createElement(
      Button_default,
      {
        icon: viewSettings?.rtl ? /* @__PURE__ */ import_react49.default.createElement(import_ri2.RiArrowLeftWideLine, null) : /* @__PURE__ */ import_react49.default.createElement(import_ri2.RiArrowRightWideLine, null),
        onClick: viewSettings?.rtl ? handleGoPrev : handleGoNext,
...
// src/app/reader/components/PageInfo.tsx
...
var PageInfoView = ({
  ...
  return /* @__PURE__ */ import_react50.default.createElement(
    ...
    /* @__PURE__ */ import_react50.default.createElement("h2", { className: "text-neutral-content text-right font-sans text-xs font-extralight" }, pageInfo)
  );
};
var PageInfo_default = PageInfoView;

// src/app/reader/components/Ribbon.tsx
...
var Ribbon = ({}) => {
  return /* @__PURE__ */ import_react51.default.createElement(
    ...
    /* @__PURE__ */ import_react51.default.createElement(
      ...
      /* @__PURE__ */ import_react51.default.createElement("polygon", { fill: "#F44336", points: "100 100, 50 78, 0 100, 0 0, 100 0" })
    )
  );
};
...
var import_ri6 = require("react-icons/ri");
var import_vsc = require("react-icons/vsc");
var import_pi5 = require("react-icons/pi");
...
// src/app/reader/components/settings/NumberInput.tsx
...
var NumberInput = ({
  ...
  const [localValue, setLocalValue] = (0, import_react52.useState)(value);
  ...
  return /* @__PURE__ */ import_react52.default.createElement("div", { className: (0, import_clsx29.default)("config-item", className) }, /* @__PURE__ */ import_react52.default.createElement("span", { className: "text-base-content" }, label), /* @__PURE__ */ import_react52.default.createElement("div", { className: "text-base-content flex items-center gap-2" }, /* @__PURE__ */ import_react52.default.createElement(
    "input",
    {
      type: "text",
      inputMode: "decimal",
    ...
    /* @__PURE__ */ import_react52.default.createElement(import_fi3.FiMinus, { className: "h-4 w-4" })
  ), /* @__PURE__ */ import_react52.default.createElement(
    "button",
    {
      onClick: increment,
    ...
    /* @__PURE__ */ import_react52.default.createElement(import_fi3.FiPlus, { className: "h-4 w-4" })
  )));
};
var NumberInput_default = NumberInput;

// src/app/reader/components/settings/FontDropDown.tsx
...
var FontDropdown = ({
  ...
  return /* @__PURE__ */ import_react53.default.createElement("div", { className: "dropdown dropdown-top" }, /* @__PURE__ */ import_react53.default.createElement(
    "button",
    {
      tabIndex: 0,
    ...
    /* @__PURE__ */ import_react53.default.createElement("span", { style: { fontFamily: onGetFontFamily(selectedOption.option, family ?? "") } }, selectedOption.label),
    /* @__PURE__ */ import_react53.default.createElement(import_fi4.FiChevronUp, { size: iconSize16 })
    ...
    options2.map(({ option, label }) => /* @__PURE__ */ import_react53.default.createElement("li", { key: option, onClick: () => onSelect(option) }, /* @__PURE__ */ import_react53.default.createElement("div", { className: "flex items-center px-0" }, /* @__PURE__ */ import_react53.default.createElement("span", { style: { minWidth: `${defaultIconSize}px` } }, selected === option && /* @__PURE__ */ import_react53.default.createElement(import_md11.MdCheck, { className: "text-base-content" })), /* @__PURE__ */ import_react53.default.createElement("span", { style: { fontFamily: onGetFontFamily(option, family ?? "") } }, label || option)))),
    moreOptions && moreOptions.length > 0 && /* @__PURE__ */ import_react53.default.createElement("li", { className: "dropdown dropdown-left dropdown-top" }, /* @__PURE__ */ import_react53.default.createElement("div", { className: "flex items-center px-0" }, /* @__PURE__ */ import_react53.default.createElement("span", { style: { minWidth: `${defaultIconSize}px` } }, /* @__PURE__ */ import_react53.default.createElement(import_fi4.FiChevronLeft, { size: iconSize16 })), /* @__PURE__ */ import_react53.default.createElement("span", null, _("System Fonts"))), /* @__PURE__ */ import_react53.default.createElement(
      "ul",
      {
        tabIndex: 0,
        className: (0, import_clsx30.default)(
      ...
      moreOptions.map((option, index) => /* @__PURE__ */ import_react53.default.createElement("li", { key: `${index}-${option.option}`, onClick: () => onSelect(option.option) }, /* @__PURE__ */ import_react53.default.createElement("div", { className: "flex items-center px-2" }, /* @__PURE__ */ import_react53.default.createElement("span", { style: { minWidth: `${defaultIconSize}px` } }, selected === option.option && /* @__PURE__ */ import_react53.default.createElement(import_md11.MdCheck, { className: "text-base-content" })), /* @__PURE__ */ import_react53.default.createElement("span", { style: { fontFamily: onGetFontFamily(option.option, family ?? "") } }, option.label || option.option))))
    ))
  ));
};
...
var FontFace = ({
  ...
  const _ = useTranslation();
  return /* @__PURE__ */ import_react54.default.createElement("div", { className: (0, import_clsx31.default)("config-item", className) }, /* @__PURE__ */ import_react54.default.createElement("span", { className: "" }, label), /* @__PURE__ */ import_react54.default.createElement(
...
var FontPanel = ({ bookKey }) => {
  ...
  const [sysFonts, setSysFonts] = (0, import_react54.useState)(defaultSysFonts);
  const [defaultFontSize, setDefaultFontSize] = (0, import_react54.useState)(viewSettings.defaultFontSize);
  const [minFontSize, setMinFontSize] = (0, import_react54.useState)(viewSettings.minimumFontSize);
  const [overrideFont, setOverrideFont] = (0, import_react54.useState)(viewSettings.overrideFont);
  const [defaultFont, setDefaultFont] = (0, import_react54.useState)(viewSettings.defaultFont);
  const [defaultCJKFont, setDefaultCJKFont] = (0, import_react54.useState)(viewSettings.defaultCJKFont);
  const [serifFont, setSerifFont] = (0, import_react54.useState)(viewSettings.serifFont);
  const [sansSerifFont, setSansSerifFont] = (0, import_react54.useState)(viewSettings.sansSerifFont);
  const [monospaceFont, setMonospaceFont] = (0, import_react54.useState)(viewSettings.monospaceFont);
  const [fontWeight, setFontWeight] = (0, import_react54.useState)(viewSettings.fontWeight);
  const [CJKFonts] = (0, import_react54.useState)(() => {
  ...
  return /* @__PURE__ */ import_react54.default.createElement("div", { className: "my-4 w-full space-y-6" }, /* @__PURE__ */ import_react54.default.createElement("div", { className: "w-full" }, /* @__PURE__ */ import_react54.default.createElement("h2", { className: "mb-2 font-medium" }, _("Font Size")), /* @__PURE__ */ import_react54.default.createElement("div", { className: "card border-base-200 border shadow" }, /* @__PURE__ */ import_react54.default.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ import_react54.default.createElement(
    NumberInput_default,
    {
  ...
  )))), /* @__PURE__ */ import_react54.default.createElement("div", { className: "w-full" }, /* @__PURE__ */ import_react54.default.createElement("h2", { className: "mb-2 font-medium" }, _("Font Weight")), /* @__PURE__ */ import_react54.default.createElement("div", { className: "card border-base-200 border shadow" }, /* @__PURE__ */ import_react54.default.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ import_react54.default.createElement(
    NumberInput_default,
    {
      label: _("Font Weight"),
      value: fontWeight,
  ...
  )))), /* @__PURE__ */ import_react54.default.createElement("div", { className: "w-full" }, /* @__PURE__ */ import_react54.default.createElement("h2", { className: "mb-2 font-medium" }, _("Font Family")), /* @__PURE__ */ import_react54.default.createElement("div", { className: "card border-base-200 border shadow" }, /* @__PURE__ */ import_react54.default.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ import_react54.default.createElement("div", { className: "config-item" }, /* @__PURE__ */ import_react54.default.createElement("span", { className: "" }, _("Default Font")), /* @__PURE__ */ import_react54.default.createElement(
    FontDropDown_default,
    {
  ...
  )), (isCJKEnv() || view?.language.isCJK) && /* @__PURE__ */ import_react54.default.createElement(
    FontFace,
    {
  ...
  ), /* @__PURE__ */ import_react54.default.createElement("div", { className: "config-item" }, /* @__PURE__ */ import_react54.default.createElement("span", { className: "" }, _("Override Book Font")), /* @__PURE__ */ import_react54.default.createElement(
    "input",
    {
      type: "checkbox",
      className: "toggle",
  ...
  ))))), /* @__PURE__ */ import_react54.default.createElement("div", { className: "w-full" }, /* @__PURE__ */ import_react54.default.createElement("h2", { className: "mb-2 font-medium" }, _("Font Face")), /* @__PURE__ */ import_react54.default.createElement("div", { className: "card border-base-200 border shadow" }, /* @__PURE__ */ import_react54.default.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ import_react54.default.createElement(
    FontFace,
    {
      className: "config-item-top",
      family: "serif",
...
var import_md12 = require("react-icons/md");
...
var LayoutPanel = ({ bookKey }) => {
  ...
  const bookData = getBookData(bookKey);
  const viewSettings = getViewSettings(bookKey);
  const [paragraphMargin, setParagraphMargin] = (0, import_react55.useState)(viewSettings.paragraphMargin);
  const [lineHeight, setLineHeight] = (0, import_react55.useState)(viewSettings.lineHeight);
  const [wordSpacing, setWordSpacing] = (0, import_react55.useState)(viewSettings.wordSpacing);
  const [letterSpacing, setLetterSpacing] = (0, import_react55.useState)(viewSettings.letterSpacing);
  const [textIndent, setTextIndent] = (0, import_react55.useState)(viewSettings.textIndent);
  const [fullJustification, setFullJustification] = (0, import_react55.useState)(viewSettings.fullJustification);
  const [hyphenation, setHyphenation] = (0, import_react55.useState)(viewSettings.hyphenation);
  const [marginPx, setMarginPx] = (0, import_react55.useState)(viewSettings.marginPx);
  const [gapPercent, setGapPercent] = (0, import_react55.useState)(viewSettings.gapPercent);
  const [maxColumnCount, setMaxColumnCount] = (0, import_react55.useState)(viewSettings.maxColumnCount);
  const [maxInlineSize, setMaxInlineSize] = (0, import_react55.useState)(viewSettings.maxInlineSize);
  const [maxBlockSize, setMaxBlockSize] = (0, import_react55.useState)(viewSettings.maxBlockSize);
  const [writingMode, setWritingMode] = (0, import_react55.useState)(viewSettings.writingMode);
  const [overrideLayout, setOverrideLayout] = (0, import_react55.useState)(viewSettings.overrideLayout);
  const [isScrolledMode, setScrolledMode] = (0, import_react55.useState)(viewSettings.scrolled);
  const [doubleBorder, setDoubleBorder] = (0, import_react55.useState)(viewSettings.doubleBorder);
  const [borderColor, setBorderColor] = (0, import_react55.useState)(viewSettings.borderColor);
  const [showHeader, setShowHeader] = (0, import_react55.useState)(viewSettings.showHeader);
  const [showFooter, setShowFooter] = (0, import_react55.useState)(viewSettings.showFooter);
  ...
  return /* @__PURE__ */ import_react55.default.createElement("div", { className: "my-4 w-full space-y-6" }, /* @__PURE__ */ import_react55.default.createElement("div", { className: "w-full" }, /* @__PURE__ */ import_react55.default.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ import_react55.default.createElement("h2", { className: "font-medium" }, _("Scrolled Mode")), /* @__PURE__ */ import_react55.default.createElement(
    "input",
    {
      type: "checkbox",
      className: "toggle",
  ...
  ))), mightBeRTLBook && /* @__PURE__ */ import_react55.default.createElement("div", { className: "w-full" }, /* @__PURE__ */ import_react55.default.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ import_react55.default.createElement("h2", { className: "font-medium" }, _("Writing Mode")), /* @__PURE__ */ import_react55.default.createElement("div", { className: "flex gap-4" }, /* @__PURE__ */ import_react55.default.createElement("div", { className: "lg:tooltip lg:tooltip-bottom", "data-tip": _("Default") }, /* @__PURE__ */ import_react55.default.createElement(
    "button",
    {
      className: `btn btn-ghost btn-circle btn-sm ${writingMode === "auto" ? "btn-active bg-base-300" : ""}`,
      onClick: () => setWritingMode("auto")
    },
    /* @__PURE__ */ import_react55.default.createElement(import_md12.MdOutlineAutoMode, null)
  )), /* @__PURE__ */ import_react55.default.createElement("div", { className: "lg:tooltip lg:tooltip-bottom", "data-tip": _("Horizontal Direction") }, /* @__PURE__ */ import_react55.default.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ import_react55.default.createElement(import_md13.MdOutlineTextRotationNone, null)
  )), /* @__PURE__ */ import_react55.default.createElement("div", { className: "lg:tooltip lg:tooltip-bottom", "data-tip": _("Vertical Direction") }, /* @__PURE__ */ import_react55.default.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ import_react55.default.createElement(import_md13.MdTextRotateVertical, null)
  )), /* @__PURE__ */ import_react55.default.createElement("div", { className: "lg:tooltip lg:tooltip-bottom", "data-tip": _("RTL Direction") }, /* @__PURE__ */ import_react55.default.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ import_react55.default.createElement(import_tb4.TbTextDirectionRtl, null)
  ))))), viewSettings.vertical && /* @__PURE__ */ import_react55.default.createElement("div", { className: "w-full" }, /* @__PURE__ */ import_react55.default.createElement("h2", { className: "mb-2 font-medium" }, _("Border Frame")), /* @__PURE__ */ import_react55.default.createElement("div", { className: "card bg-base-100 border-base-200 border shadow" }, /* @__PURE__ */ import_react55.default.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ import_react55.default.createElement("div", { className: "config-item" }, /* @__PURE__ */ import_react55.default.createElement("span", { className: "" }, _("Double Border")), /* @__PURE__ */ import_react55.default.createElement(
    "input",
    {
      type: "checkbox",
      className: "toggle",
  ...
  )), /* @__PURE__ */ import_react55.default.createElement("div", { className: "config-item" }, /* @__PURE__ */ import_react55.default.createElement("span", { className: "" }, _("Border Color")), /* @__PURE__ */ import_react55.default.createElement("div", { className: "flex gap-4" }, /* @__PURE__ */ import_react55.default.createElement(
    "button",
    {
  ...
  )))))), /* @__PURE__ */ import_react55.default.createElement("div", { className: "w-full" }, /* @__PURE__ */ import_react55.default.createElement("h2", { className: "mb-2 font-medium" }, _("Paragraph")), /* @__PURE__ */ import_react55.default.createElement("div", { className: "card bg-base-100 border-base-200 border shadow" }, /* @__PURE__ */ import_react55.default.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ import_react55.default.createElement(
    NumberInput_default,
    {
  ...
  ), langCode !== "zh" && /* @__PURE__ */ import_react55.default.createElement(
    NumberInput_default,
    {
  ...
  ), /* @__PURE__ */ import_react55.default.createElement("div", { className: "config-item" }, /* @__PURE__ */ import_react55.default.createElement("span", { className: "" }, _("Full Justification")), /* @__PURE__ */ import_react55.default.createElement(
    "input",
    {
      type: "checkbox",
      className: "toggle",
  ...
  )), /* @__PURE__ */ import_react55.default.createElement("div", { className: "config-item" }, /* @__PURE__ */ import_react55.default.createElement("span", { className: "" }, _("Hyphenation")), /* @__PURE__ */ import_react55.default.createElement(
    "input",
    {
      type: "checkbox",
      className: "toggle",
  ...
  )), /* @__PURE__ */ import_react55.default.createElement("div", { className: "config-item" }, /* @__PURE__ */ import_react55.default.createElement("span", { className: "" }, _("Override Book Layout")), /* @__PURE__ */ import_react55.default.createElement(
    "input",
    {
      type: "checkbox",
      className: "toggle",
  ...
  ))))), /* @__PURE__ */ import_react55.default.createElement("div", { className: "w-full" }, /* @__PURE__ */ import_react55.default.createElement("h2", { className: "mb-2 font-medium" }, _("Page")), /* @__PURE__ */ import_react55.default.createElement("div", { className: "card bg-base-100 border-base-200 border shadow" }, /* @__PURE__ */ import_react55.default.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ import_react55.default.createElement("div", { className: "config-item" }, /* @__PURE__ */ import_react55.default.createElement("span", { className: "" }, _("Show Header")), /* @__PURE__ */ import_react55.default.createElement(
    "input",
    {
      type: "checkbox",
      className: "toggle",
  ...
  )), /* @__PURE__ */ import_react55.default.createElement("div", { className: "config-item" }, /* @__PURE__ */ import_react55.default.createElement("span", { className: "" }, _("Show Footer")), /* @__PURE__ */ import_react55.default.createElement(
    "input",
    {
      type: "checkbox",
      className: "toggle",
...
var import_md14 = require("react-icons/md");
var import_md15 = require("react-icons/md");
var import_cg = require("react-icons/cg");
var import_tb5 = require("react-icons/tb");
var import_pi4 = require("react-icons/pi");
...
// src/app/reader/components/settings/ColorInput.tsx
...
var ColorInput = ({ label, value, onChange }) => {
  ...
  const pickerRef = (0, import_react56.useRef)(null);
  ...
  return /* @__PURE__ */ import_react56.default.createElement("div", { className: "mb-3" }, /* @__PURE__ */ import_react56.default.createElement("label", { className: "mb-1 block text-sm font-medium" }, label), /* @__PURE__ */ import_react56.default.createElement("div", { className: "flex items-center" }, /* @__PURE__ */ import_react56.default.createElement(
    "div",
    {
  ...
  )), isOpen && /* @__PURE__ */ import_react56.default.createElement("div", { ref: pickerRef, className: "relative z-50 mt-2" }, /* @__PURE__ */ import_react56.default.createElement("div", { className: "absolute" }, /* @__PURE__ */ import_react56.default.createElement(
...
var ThemeEditor = ({ customTheme, onSave, onDelete, onCancel }) => {
  ...
  const [lightTextColor, setLightTextColor] = (0, import_react57.useState)(
    customTheme?.colors.light.fg || template.light.fg
  );
  const [lightBackgroundColor, setLightBackgroundColor] = (0, import_react57.useState)(
    customTheme?.colors.light.bg || template.light.bg
  );
  const [darkTextColor, setDarkTextColor] = (0, import_react57.useState)(
    customTheme?.colors.dark.fg || template.dark.fg
  );
  const [darkBackgroundColor, setDarkBackgroundColor] = (0, import_react57.useState)(
    customTheme?.colors.dark.bg || template.dark.bg
  );
  const [themeName, setThemeName] = (0, import_react57.useState)(customTheme?.label || _("Custom"));
...
var ColorPanel = ({}) => {
  ...
  const [editTheme, setEditTheme] = (0, import_react58.useState)(null);
  const [customThems, setCustomThemes] = (0, import_react58.useState)([]);
  const [showCustomThemeEditor, setShowCustomThemeEditor] = (0, import_react58.useState)(false);
  ...
  return /* @__PURE__ */ import_react58.default.createElement("div", { className: "my-4 w-full space-y-6" }, showCustomThemeEditor ? /* @__PURE__ */ import_react58.default.createElement(
    ThemeEditor_default,
    {
  ...
  ) : /* @__PURE__ */ import_react58.default.createElement(import_react58.default.Fragment, null, /* @__PURE__ */ import_react58.default.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ import_react58.default.createElement("h2", { className: "font-medium" }, _("Theme Mode")), /* @__PURE__ */ import_react58.default.createElement("div", { className: "flex gap-4" }, /* @__PURE__ */ import_react58.default.createElement("div", { className: "lg:tooltip lg:tooltip-bottom", "data-tip": _("Auto Mode") }, /* @__PURE__ */ import_react58.default.createElement(
    "button",
    {
      className: `btn btn-ghost btn-circle btn-sm ${themeMode === "auto" ? "btn-active bg-base-300" : ""}`,
      onClick: () => setThemeMode("auto")
    },
    /* @__PURE__ */ import_react58.default.createElement(import_tb5.TbSunMoon, null)
  )), /* @__PURE__ */ import_react58.default.createElement("div", { className: "lg:tooltip lg:tooltip-bottom", "data-tip": _("Light Mode") }, /* @__PURE__ */ import_react58.default.createElement(
    "button",
    {
      className: `btn btn-ghost btn-circle btn-sm ${themeMode === "light" ? "btn-active bg-base-300" : ""}`,
      onClick: () => setThemeMode("light")
    },
    /* @__PURE__ */ import_react58.default.createElement(import_md14.MdOutlineLightMode, null)
  )), /* @__PURE__ */ import_react58.default.createElement("div", { className: "lg:tooltip lg:tooltip-bottom", "data-tip": _("Dark Mode") }, /* @__PURE__ */ import_react58.default.createElement(
    "button",
    {
      className: `btn btn-ghost btn-circle btn-sm ${themeMode === "dark" ? "btn-active bg-base-300" : ""}`,
      onClick: () => setThemeMode("dark")
    },
    /* @__PURE__ */ import_react58.default.createElement(import_md14.MdOutlineDarkMode, null)
  )))), /* @__PURE__ */ import_react58.default.createElement("div", null, /* @__PURE__ */ import_react58.default.createElement("h2", { className: "mb-2 font-medium" }, _("Theme Color")), /* @__PURE__ */ import_react58.default.createElement("div", { className: "grid grid-cols-3 gap-4" }, themes.concat(customThems).map(({ name, label, colors: colors2, isCustomizale }) => /* @__PURE__ */ import_react58.default.createElement(
    "label",
    {
      key: name,
    ...
    themeColor === name ? /* @__PURE__ */ import_react58.default.createElement(import_md15.MdRadioButtonChecked, { size: iconSize24 }) : /* @__PURE__ */ import_react58.default.createElement(import_md15.MdRadioButtonUnchecked, { size: iconSize24 }),
    /* @__PURE__ */ import_react58.default.createElement("span", null, _(label)),
    isCustomizale && themeColor === name && /* @__PURE__ */ import_react58.default.createElement("button", { onClick: () => handleEditTheme(name) }, /* @__PURE__ */ import_react58.default.createElement(import_cg.CgColorPicker, { size: iconSize16, className: "absolute right-2 top-2" }))
  )), /* @__PURE__ */ import_react58.default.createElement(
    "label",
    {
    ...
    /* @__PURE__ */ import_react58.default.createElement(import_pi4.PiPlus, { size: iconSize24 }),
    /* @__PURE__ */ import_react58.default.createElement("span", null, _("Custom"))
  )))));
};
var ColorPanel_default = ColorPanel;

// src/app/reader/components/settings/DialogMenu.tsx
var import_react59 = __toESM(require("react"));
var import_md16 = require("react-icons/md");
var DialogMenu = ({ toggleDropdown }) => {
  ...
  return /* @__PURE__ */ import_react59.default.createElement(
    ...
    /* @__PURE__ */ import_react59.default.createElement(
      ...
      /* @__PURE__ */ import_react59.default.createElement("div", { className: "flex items-center" }, /* @__PURE__ */ import_react59.default.createElement("span", { style: { minWidth: `${iconSize}px` } }, isFontLayoutSettingsGlobal && /* @__PURE__ */ import_react59.default.createElement(import_md16.MdCheck, { className: "text-base-content" })), /* @__PURE__ */ import_react59.default.createElement(
        "div",
        {
          className: "lg:tooltip",
          "data-tip": isFontLayoutSettingsGlobal ? _("Apply to All Books") : _("Apply to This Book")
        },
        /* @__PURE__ */ import_react59.default.createElement("span", { className: "ml-2 whitespace-nowrap" }, _("Global Settings"))
      ))
    )
  );
};
...
init_constants();
var import_cssbeautify = __toESM(require("cssbeautify"));
...
// src/app/reader/components/settings/DropDown.tsx
var import_clsx33 = __toESM(require("clsx"));
var import_react60 = __toESM(require("react"));
var import_fi5 = require("react-icons/fi");
var import_md17 = require("react-icons/md");
var DropDown = ({ selected, options: options2, onSelect }) => {
  const iconSize16 = useResponsiveSize(16);
  const defaultIconSize = useDefaultIconSize();
  return /* @__PURE__ */ import_react60.default.createElement("div", { className: "dropdown dropdown-bottom" }, /* @__PURE__ */ import_react60.default.createElement(
    "button",
    {
      tabIndex: 0,
      className: "btn btn-sm flex items-center gap-1 px-[20px] font-normal normal-case",
    ...
    /* @__PURE__ */ import_react60.default.createElement("span", null, selected.label),
    /* @__PURE__ */ import_react60.default.createElement(import_fi5.FiChevronDown, { size: iconSize16 })
    ...
    options2.map(({ option, label }) => /* @__PURE__ */ import_react60.default.createElement("li", { key: option, onClick: () => onSelect(option) }, /* @__PURE__ */ import_react60.default.createElement("div", { className: "flex items-center px-0" }, /* @__PURE__ */ import_react60.default.createElement("span", { style: { minWidth: `${defaultIconSize}px` } }, selected.option === option && /* @__PURE__ */ import_react60.default.createElement(import_md17.MdCheck, { className: "text-base-content" })), /* @__PURE__ */ import_react60.default.createElement("span", null, label || option))))
  ));
};
var DropDown_default = DropDown;
...
var MiscPanel = ({ bookKey }) => {
  ...
  const { getView, getViewSettings, setViewSettings } = useReaderStore();
  const viewSettings = getViewSettings(bookKey);
  const [animated, setAnimated] = (0, import_react61.useState)(viewSettings.animated);
  const [isDisableClick, setIsDisableClick] = (0, import_react61.useState)(viewSettings.disableClick);
  const [swapClickArea, setSwapClickArea] = (0, import_react61.useState)(viewSettings.swapClickArea);
  const [isContinuousScroll, setIsContinuousScroll] = (0, import_react61.useState)(viewSettings.continuousScroll);
  const [draftStylesheet, setDraftStylesheet] = (0, import_react61.useState)(viewSettings.userStylesheet);
  const [draftStylesheetSaved, setDraftStylesheetSaved] = (0, import_react61.useState)(true);
  const [error, setError] = (0, import_react61.useState)(null);
  const [inputFocusInAndroid, setInputFocusInAndroid] = (0, import_react61.useState)(false);
  ...
  const applyStyles = () => {
    const formattedCSS = (0, import_cssbeautify.default)(draftStylesheet, {
      indent: "  ",
  ...
  const handleSelectUILang = (option) => {
    ...
    import_i18next2.default.changeLanguage(option ? option : navigator.language);
  };
  ...
  return /* @__PURE__ */ import_react61.default.createElement(
    ...
    /* @__PURE__ */ import_react61.default.createElement("div", { className: "w-full" }, /* @__PURE__ */ import_react61.default.createElement("h2", { className: "mb-2 font-medium" }, _("Language")), /* @__PURE__ */ import_react61.default.createElement("div", { className: "card border-base-200 bg-base-100 border shadow" }, /* @__PURE__ */ import_react61.default.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ import_react61.default.createElement("div", { className: "config-item" }, /* @__PURE__ */ import_react61.default.createElement("span", { className: "" }, _("Language")), /* @__PURE__ */ import_react61.default.createElement(
      DropDown_default,
      {
    ...
    /* @__PURE__ */ import_react61.default.createElement("div", { className: "w-full" }, /* @__PURE__ */ import_react61.default.createElement("h2", { className: "mb-2 font-medium" }, _("Animation")), /* @__PURE__ */ import_react61.default.createElement("div", { className: "card border-base-200 bg-base-100 border shadow" }, /* @__PURE__ */ import_react61.default.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ import_react61.default.createElement("div", { className: "config-item" }, /* @__PURE__ */ import_react61.default.createElement("span", { className: "" }, _("Paging Animation")), /* @__PURE__ */ import_react61.default.createElement(
      "input",
      {
        type: "checkbox",
        className: "toggle",
    ...
    /* @__PURE__ */ import_react61.default.createElement("div", { className: "w-full" }, /* @__PURE__ */ import_react61.default.createElement("h2", { className: "mb-2 font-medium" }, _("Behavior")), /* @__PURE__ */ import_react61.default.createElement("div", { className: "card border-base-200 bg-base-100 border shadow" }, /* @__PURE__ */ import_react61.default.createElement("div", { className: "divide-base-200 divide-y" }, /* @__PURE__ */ import_react61.default.createElement("div", { className: "config-item" }, /* @__PURE__ */ import_react61.default.createElement("span", { className: "" }, _("Continuous Scroll")), /* @__PURE__ */ import_react61.default.createElement(
      "input",
      {
        type: "checkbox",
        className: "toggle",
    ...
    )), /* @__PURE__ */ import_react61.default.createElement("div", { className: "config-item" }, /* @__PURE__ */ import_react61.default.createElement("span", { className: "" }, _("Disable Click-to-Flip")), /* @__PURE__ */ import_react61.default.createElement(
      "input",
      {
        type: "checkbox",
        className: "toggle",
    ...
    )), /* @__PURE__ */ import_react61.default.createElement("div", { className: "config-item" }, /* @__PURE__ */ import_react61.default.createElement("span", { className: "" }, _("Swap Click-to-Flip Area")), /* @__PURE__ */ import_react61.default.createElement(
      "input",
      {
        type: "checkbox",
        className: "toggle",
    ...
    /* @__PURE__ */ import_react61.default.createElement("div", { className: "w-full" }, /* @__PURE__ */ import_react61.default.createElement("h2", { className: "mb-2 font-medium" }, _("Custom CSS")), /* @__PURE__ */ import_react61.default.createElement(
      "div",
      {
        className: `card border-base-200 bg-base-100 border shadow ${error ? "border-red-500" : ""}`
      },
      /* @__PURE__ */ import_react61.default.createElement("div", { className: "relative p-1" }, /* @__PURE__ */ import_react61.default.createElement(
        "textarea",
        {
          ref: textareaRef,
          className: (0, import_clsx34.default)(
    ...
    ), error && /* @__PURE__ */ import_react61.default.createElement("p", { className: "mt-1 text-sm text-red-500" }, error))
  );
};
...
var SettingsDialog = ({ bookKey }) => {
  const _ = useTranslation();
  const [isRtl] = (0, import_react62.useState)(() => getDirFromUILanguage() === "rtl");
  const [activePanel, setActivePanel] = (0, import_react62.useState)(
  ...
  const tabConfig = [
    {
      tab: "Font",
      icon: import_ri5.RiFontSize,
      label: _("Font")
    },
    {
      tab: "Layout",
      icon: import_ri6.RiDashboardLine,
      label: _("Layout")
    },
    {
      tab: "Color",
      icon: import_vsc.VscSymbolColor,
      label: _("Color")
    },
    {
      tab: "Misc",
      icon: import_io52.IoAccessibilityOutline,
      label: _("Misc")
    }
  ];
  ...
  return /* @__PURE__ */ import_react62.default.createElement(import_react62.default.Fragment, null, /* @__PURE__ */ import_react62.default.createElement(
    Dialog_default,
    {
      ...
      header: /* @__PURE__ */ import_react62.default.createElement("div", { className: "flex w-full items-center justify-between" }, /* @__PURE__ */ import_react62.default.createElement(
        "button",
        {
          tabIndex: -1,
          onClick: handleClose2,
        ...
        isRtl ? /* @__PURE__ */ import_react62.default.createElement(import_md18.MdArrowForwardIos, null) : /* @__PURE__ */ import_react62.default.createElement(import_md18.MdArrowBackIosNew, null)
      ), /* @__PURE__ */ import_react62.default.createElement("div", { className: "dialog-tabs flex h-10 max-w-[100%] flex-grow items-center gap-2 pl-4" }, tabConfig.map(({ tab, icon: Icon, label }) => /* @__PURE__ */ import_react62.default.createElement(
        "button",
        {
          key: tab,
        ...
        /* @__PURE__ */ import_react62.default.createElement(Icon, { className: "mr-0" }),
        window.innerWidth >= 500 ? label : ""
      ))), /* @__PURE__ */ import_react62.default.createElement("div", { className: "flex h-full items-center justify-end gap-x-2" }, /* @__PURE__ */ import_react62.default.createElement(
        Dropdown_default,
        {
          className: "dropdown-bottom dropdown-end",
          buttonClassName: "btn btn-ghost h-8 min-h-8 w-8 p-0",
          toggleButton: /* @__PURE__ */ import_react62.default.createElement(import_pi5.PiDotsThreeVerticalBold, null)
        },
        /* @__PURE__ */ import_react62.default.createElement(DialogMenu_default, null)
    ...
    activePanel === "Font" && /* @__PURE__ */ import_react62.default.createElement(FontPanel_default, { bookKey }),
    activePanel === "Layout" && /* @__PURE__ */ import_react62.default.createElement(LayoutPanel_default, { bookKey }),
    activePanel === "Color" && /* @__PURE__ */ import_react62.default.createElement(ColorPanel_default, { bookKey }),
    activePanel === "Misc" && /* @__PURE__ */ import_react62.default.createElement(MiscPanel_default, { bookKey })
  ));
};
...
var import_pi6 = require("react-icons/pi");
var import_fa3 = require("react-icons/fa");
var import_bs = require("react-icons/bs");
var import_ri7 = require("react-icons/ri");
var import_bs2 = require("react-icons/bs");
var import_tb6 = require("react-icons/tb");
var import_fa62 = require("react-icons/fa6");
var CFI5 = __toESM(require("foliate-js/epubcfi.js"));
var import_overlayer = require("foliate-js/overlayer.js");
init_misc();

// src/app/reader/hooks/useNotesSync.ts
...
var useNotesSync = (bookKey) => {
  ...
  const lastSyncTime = (0, import_react63.useRef)(0);
  const syncTimeoutRef = (0, import_react63.useRef)(null);
  const getNewNotes = () => {
    if (!config?.location) return [];
...
// src/app/reader/components/annotator/PopupButton.tsx
var import_react64 = __toESM(require("react"));
var PopupButton = ({ showTooltip, tooltipText, Icon, onClick }) => {
  const [buttonClicked, setButtonClicked] = (0, import_react64.useState)(false);
  const handleClick2 = () => {
  ...
  return /* @__PURE__ */ import_react64.default.createElement(
    ...
    /* @__PURE__ */ import_react64.default.createElement(
      ...
      /* @__PURE__ */ import_react64.default.createElement(Icon, null)
    )
  );
};
var PopupButton_default = PopupButton;

// src/app/reader/components/annotator/HighlightOptions.tsx
...
var HighlightOptions = ({
  ...
  const [selectedStyle, setSelectedStyle] = import_react65.default.useState(_selectedStyle);
  const [selectedColor, setSelectedColor] = import_react65.default.useState(_selectedColor);
  ...
  return /* @__PURE__ */ import_react65.default.createElement(
    ...
    /* @__PURE__ */ import_react65.default.createElement(
      "div",
      {
        className: (0, import_clsx36.default)("flex gap-2", isVertical ? "flex-col" : "flex-row"),
        style: isVertical ? { width: size28 } : { height: size28 }
      },
      styles.map((style2) => /* @__PURE__ */ import_react65.default.createElement(
        "button",
        {
          key: style2,
    ...
    /* @__PURE__ */ import_react65.default.createElement(
      ...
      colors.map((color) => /* @__PURE__ */ import_react65.default.createElement(
        "button",
        {
          key: color,
          onClick: () => handleSelectColor(color),
          style: { width: size16, height: size16 },
          className: (0, import_clsx36.default)(`rounded-full p-0`, selectedColor !== color && `bg-${color}-400`)
        },
        selectedColor === color && /* @__PURE__ */ import_react65.default.createElement(import_fa2.FaCheckCircle, { size: size16, className: (0, import_clsx36.default)(`fill-${color}-400`) })
      ))
    )
  );
};
...
var AnnotationPopup = ({
  ...
  return /* @__PURE__ */ import_react66.default.createElement("div", { dir }, /* @__PURE__ */ import_react66.default.createElement(
    Popup_default,
    {
    ...
    /* @__PURE__ */ import_react66.default.createElement(
      ...
      buttons.map((button, index) => /* @__PURE__ */ import_react66.default.createElement(
        PopupButton_default,
        {
          key: index,
  ...
  ), highlightOptionsVisible && /* @__PURE__ */ import_react66.default.createElement(
...
// src/app/reader/components/annotator/WiktionaryPopup.tsx
...
var WiktionaryPopup = ({
  ...
  const [lookupWord, setLookupWord] = (0, import_react67.useState)(word);
  const isLookingUp = (0, import_react67.useRef)(false);
  ...
  return /* @__PURE__ */ import_react67.default.createElement("div", null, /* @__PURE__ */ import_react67.default.createElement(
    Popup_default,
    {
      trianglePosition,
      width: popupWidth2,
    ...
    /* @__PURE__ */ import_react67.default.createElement("div", { className: "flex h-full flex-col" }, /* @__PURE__ */ import_react67.default.createElement("main", { className: "flex-grow overflow-y-auto p-4 font-sans" }), /* @__PURE__ */ import_react67.default.createElement("footer", { className: "mt-auto hidden data-[state=loaded]:block data-[state=error]:hidden data-[state=loading]:hidden" }, /* @__PURE__ */ import_react67.default.createElement("div", { className: "flex items-center px-4 py-2 text-sm opacity-60" }, "Source: Wiktionary (CC BY-SA)")))
  ));
};
var WiktionaryPopup_default = WiktionaryPopup;

// src/app/reader/components/annotator/WikipediaPopup.tsx
...
var WikipediaPopup = ({
  ...
  const isLoading = (0, import_react68.useRef)(false);
  ...
  return /* @__PURE__ */ import_react68.default.createElement("div", null, /* @__PURE__ */ import_react68.default.createElement(
    Popup_default,
    {
      width: popupWidth2,
      height: popupHeight2,
    ...
    /* @__PURE__ */ import_react68.default.createElement("div", { className: "text-base-content flex h-full flex-col pt-2" }, /* @__PURE__ */ import_react68.default.createElement("main", { className: "flex-grow overflow-y-auto px-2 font-sans" }), /* @__PURE__ */ import_react68.default.createElement("footer", { className: "mt-auto hidden data-[state=loaded]:block data-[state=error]:hidden data-[state=loading]:hidden" }, /* @__PURE__ */ import_react68.default.createElement("div", { className: "flex items-center px-4 py-2 text-sm opacity-60" }, "Source: Wikipedia (CC BY-SA)")))
  ));
};
var WikipediaPopup_default = WikipediaPopup;

// src/app/reader/components/annotator/DeepLPopup.tsx
...
var DeepLPopup = ({
  ...
  const _ = useTranslation();
  const { settings, setSettings } = useSettingsStore();
  const [sourceLang, setSourceLang] = (0, import_react69.useState)("AUTO");
  const [targetLang, setTargetLang] = (0, import_react69.useState)(settings.globalReadSettings.translateTargetLang);
  const [translation, setTranslation] = (0, import_react69.useState)(null);
  const [detectedSourceLang, setDetectedSourceLang] = (0, import_react69.useState)(null);
  ...
  return /* @__PURE__ */ import_react69.default.createElement("div", null, /* @__PURE__ */ import_react69.default.createElement(
    Popup_default,
    {
      trianglePosition,
      width: popupWidth2,
    ...
    /* @__PURE__ */ import_react69.default.createElement("div", { className: "text-neutral-content relative h-[50%] overflow-y-auto border-b border-neutral-400/75 p-4 font-sans" }, /* @__PURE__ */ import_react69.default.createElement("div", { className: "mb-2 flex items-center justify-between" }, /* @__PURE__ */ import_react69.default.createElement("h1", { className: "text-base font-semibold" }, _("Original Text")), /* @__PURE__ */ import_react69.default.createElement(
      "select",
      {
        value: sourceLang,
      ...
      Object.entries(LANGUAGES).map(([code, name]) => {
        return /* @__PURE__ */ import_react69.default.createElement("option", { key: code, value: code }, detectedSourceLang && sourceLang === "AUTO" && code === "AUTO" ? `${LANGUAGES[detectedSourceLang] || detectedSourceLang} ` + _("(detected)") : name);
      })
    )), /* @__PURE__ */ import_react69.default.createElement("p", { className: "text-base" }, text)),
    /* @__PURE__ */ import_react69.default.createElement("div", { className: "text-neutral-content relative h-[50%] overflow-y-auto p-4 font-sans" }, /* @__PURE__ */ import_react69.default.createElement("div", { className: "mb-2 flex items-center justify-between" }, /* @__PURE__ */ import_react69.default.createElement("h2", { className: "text-base font-semibold" }, _("Translated Text")), /* @__PURE__ */ import_react69.default.createElement(
      "select",
      {
        value: targetLang,
      ...
      Object.entries(LANGUAGES).filter(([code]) => code !== "AUTO").map(([code, name]) => /* @__PURE__ */ import_react69.default.createElement("option", { key: code, value: code }, name))
    )), loading ? /* @__PURE__ */ import_react69.default.createElement("p", { className: "text-base italic text-gray-500" }, _("Loading...")) : error ? /* @__PURE__ */ import_react69.default.createElement("p", { className: "text-base text-red-600" }, error) : /* @__PURE__ */ import_react69.default.createElement("div", null, /* @__PURE__ */ import_react69.default.createElement("p", { className: "text-base" }, translation || "No translation available."), /* @__PURE__ */ import_react69.default.createElement("div", { className: "pt-4 text-sm opacity-60" }, "Translated by DeepL.")))
  ));
};
...
var Annotator = ({ bookKey }) => {
  ...
  const view = getView(bookKey);
  const viewSettings = getViewSettings(bookKey);
  const isShowingPopup = (0, import_react70.useRef)(false);
  const isTextSelected = (0, import_react70.useRef)(false);
  const isUpToShowPopup = (0, import_react70.useRef)(false);
  const isTouchstarted = (0, import_react70.useRef)(false);
  const [selection, setSelection] = (0, import_react70.useState)();
  const [showAnnotPopup, setShowAnnotPopup] = (0, import_react70.useState)(false);
  const [showWiktionaryPopup, setShowWiktionaryPopup] = (0, import_react70.useState)(false);
  const [showWikipediaPopup, setShowWikipediaPopup] = (0, import_react70.useState)(false);
  const [showDeepLPopup, setShowDeepLPopup] = (0, import_react70.useState)(false);
  const [trianglePosition, setTrianglePosition] = (0, import_react70.useState)();
  const [annotPopupPosition, setAnnotPopupPosition] = (0, import_react70.useState)();
  const [dictPopupPosition, setDictPopupPosition] = (0, import_react70.useState)();
  const [translatorPopupPosition, setTranslatorPopupPosition] = (0, import_react70.useState)();
  const [highlightOptionsVisible, setHighlightOptionsVisible] = (0, import_react70.useState)(false);
  const [selectedStyle, setSelectedStyle] = (0, import_react70.useState)(
    settings.globalReadSettings.highlightStyle
  );
  const [selectedColor, setSelectedColor] = (0, import_react70.useState)(
  ...
  const onDrawAnnotation = (event) => {
    ...
    if (style === "highlight") {
      draw(import_overlayer.Overlayer.highlight, { color: hexColor });
      ...
      draw(import_overlayer.Overlayer[style], { writingMode, color: hexColor, padding });
    }
  };
  ...
  (0, import_react70.useEffect)(() => {
    if (!progress) return;
    const { location } = progress;
    const start = CFI5.collapse(location);
    const end = CFI5.collapse(location, true);
    const { booknotes = [] } = config;
    const annotations = booknotes.filter(
      (item) => !item.deletedAt && item.type === "annotation" && item.style && CFI5.compare(item.cfi, start) >= 0 && CFI5.compare(item.cfi, end) <= 0
    );
    try {
  ...
  const handleExportMarkdown = (event) => {
    ...
    Object.values(booknoteGroups).forEach((group) => {
      group.booknotes.sort((a2, b) => {
        return CFI5.compare(a2.cfi, b.cfi);
      });
    });
  ...
  const buttons = [
    { tooltipText: _("Copy"), Icon: import_fi7.FiCopy, onClick: handleCopy },
    {
      tooltipText: selectionAnnotated ? _("Delete Highlight") : _("Highlight"),
      Icon: selectionAnnotated ? import_ri7.RiDeleteBinLine : import_pi6.PiHighlighterFill,
      onClick: handleHighlight
    },
    { tooltipText: _("Annotate"), Icon: import_bs.BsPencilSquare, onClick: handleAnnotate },
    { tooltipText: _("Search"), Icon: import_fi6.FiSearch, onClick: handleSearch },
    { tooltipText: _("Dictionary"), Icon: import_tb6.TbHexagonLetterD, onClick: handleDictionary },
    { tooltipText: _("Wikipedia"), Icon: import_fa3.FaWikipediaW, onClick: handleWikipedia },
    { tooltipText: _("Translate"), Icon: import_bs2.BsTranslate, onClick: handleTranslation },
    { tooltipText: _("Speak"), Icon: import_fa62.FaHeadphones, onClick: handleSpeakText }
  ];
  return /* @__PURE__ */ import_react70.default.createElement("div", null, showWiktionaryPopup && trianglePosition && dictPopupPosition && /* @__PURE__ */ import_react70.default.createElement(
  ...
  ), showWikipediaPopup && trianglePosition && dictPopupPosition && /* @__PURE__ */ import_react70.default.createElement(
  ...
  ), showDeepLPopup && trianglePosition && translatorPopupPosition && /* @__PURE__ */ import_react70.default.createElement(
    DeepLPopup_default,
    {
      text: selection?.text,
  ...
  ), showAnnotPopup && trianglePosition && annotPopupPosition && /* @__PURE__ */ import_react70.default.createElement(
...
// src/app/reader/components/FootnotePopup.tsx
var import_react71 = __toESM(require("react"));
var import_footnotes = require("foliate-js/footnotes.js");
var popupWidth = 360;
var popupHeight = 88;
var popupPadding = 10;
var FootnotePopup = ({ bookKey, bookDoc }) => {
  const footnoteRef = (0, import_react71.useRef)(null);
  const footnoteViewRef = (0, import_react71.useRef)(null);
  const [trianglePosition, setTrianglePosition] = (0, import_react71.useState)();
  const [popupPosition, setPopupPosition] = (0, import_react71.useState)();
  const [showPopup, setShowPopup] = (0, import_react71.useState)(false);
  const { getView, getViewSettings } = useReaderStore();
  const view = getView(bookKey);
  const viewSettings = getViewSettings(bookKey);
  const footnoteHandler = new import_footnotes.FootnoteHandler();
  const [gridRect, setGridRect] = (0, import_react71.useState)(null);
  const [responsiveWidth, setResponsiveWidth] = (0, import_react71.useState)(popupWidth);
  const [responsiveHeight, setResponsiveHeight] = (0, import_react71.useState)(popupHeight);
...
${footnoteStyles}`);
  ...
  return /* @__PURE__ */ import_react71.default.createElement("div", null, showPopup && /* @__PURE__ */ import_react71.default.createElement(
    "div",
    {
...
// src/app/reader/components/HintInfo.tsx
...
var HintInfo = ({
  ...
  const [hintMessage, setHintMessage] = import_react72.default.useState(null);
  const hintTimeout = (0, import_react72.useRef)(2e3);
  const dismissTimeout = (0, import_react72.useRef)(null);
  ...
  return /* @__PURE__ */ import_react72.default.createElement(
    ...
    /* @__PURE__ */ import_react72.default.createElement("h2", { className: (0, import_clsx38.default)("text-neutral-content text-center font-sans text-xs font-light") }, hintMessage || "")
  );
};
  ...
  return /* @__PURE__ */ import_react73.default.createElement(
    ...
    bookKeys.map((bookKey, index) => {
      ...
      return /* @__PURE__ */ import_react73.default.createElement(
        ...
        isBookmarked && !hoveredBookKey && /* @__PURE__ */ import_react73.default.createElement(Ribbon_default, { width: `${horizontalGapPercent}%` }),
        ...
        /* @__PURE__ */ import_react73.default.createElement(FoliateViewer_default, { bookKey, bookDoc, config }),
        viewSettings.vertical && viewSettings.scrolled && /* @__PURE__ */ import_react73.default.createElement(import_react73.default.Fragment, null, /* @__PURE__ */ import_react73.default.createElement(
          "div",
          {
        ...
        viewSettings.vertical && viewSettings.doubleBorder && /* @__PURE__ */ import_react73.default.createElement(
        ...
        viewSettings.showHeader && /* @__PURE__ */ import_react73.default.createElement(
          SectionInfo_default,
          {
        ...
        viewSettings.showFooter && /* @__PURE__ */ import_react73.default.createElement(
          PageInfo_default,
          {
        ...
        /* @__PURE__ */ import_react73.default.createElement(Annotator_default, { bookKey }),
        /* @__PURE__ */ import_react73.default.createElement(FootnotePopup_default, { bookKey, bookDoc }),
        /* @__PURE__ */ import_react73.default.createElement(
          FooterBar_default,
          {
            bookKey,
        ...
        isFontLayoutSettingsDialogOpen && /* @__PURE__ */ import_react73.default.createElement(SettingsDialog_default, { bookKey, config })
      );
    })
  );
};
...
// src/libs/edgeTTS.ts
var import_js_md53 = require("js-md5");
init_misc();
...
var hashPayload = (payload) => {
  ...
  return (0, import_js_md53.md5)(base);
};
...
// src/app/reader/components/tts/TTSPanel.tsx
var import_clsx40 = __toESM(require("clsx"));
var import_react74 = __toESM(require("react"));
var import_md19 = require("react-icons/md");
var import_ri8 = require("react-icons/ri");
var import_md20 = require("react-icons/md");
...
var TTSPanel = ({
  ...
  const viewSettings = getViewSettings(bookKey);
  const [voices, setVoices] = (0, import_react74.useState)([]);
  const [rate, setRate] = (0, import_react74.useState)(viewSettings?.ttsRate ?? 1);
  const [selectedVoice, setSelectedVoice] = (0, import_react74.useState)(viewSettings?.ttsVoice ?? "");
  const [timeoutCountdown, setTimeoutCountdown] = (0, import_react74.useState)(() => {
  ...
  return /* @__PURE__ */ import_react74.default.createElement("div", { className: "flex w-full flex-col items-center justify-center gap-2 rounded-2xl p-4" }, /* @__PURE__ */ import_react74.default.createElement("div", { className: "flex w-full flex-col items-center gap-0.5" }, /* @__PURE__ */ import_react74.default.createElement(
    "input",
    {
      className: "range",
      type: "range",
  ...
  ), /* @__PURE__ */ import_react74.default.createElement("div", { className: "grid w-full grid-cols-7 text-xs" }, /* @__PURE__ */ import_react74.default.createElement("span", { className: "text-center" }, "|"), /* @__PURE__ */ import_react74.default.createElement("span", { className: "text-center" }, "|"), /* @__PURE__ */ import_react74.default.createElement("span", { className: "text-center" }, "|"), /* @__PURE__ */ import_react74.default.createElement("span", { className: "text-center" }, "|"), /* @__PURE__ */ import_react74.default.createElement("span", { className: "text-center" }, "|"), /* @__PURE__ */ import_react74.default.createElement("span", { className: "text-center" }, "|"), /* @__PURE__ */ import_react74.default.createElement("span", { className: "text-center" }, "|")), /* @__PURE__ */ import_react74.default.createElement("div", { className: "grid w-full grid-cols-7 text-xs" }, /* @__PURE__ */ import_react74.default.createElement("span", { className: "text-center" }, _("Slow")), /* @__PURE__ */ import_react74.default.createElement("span", { className: "text-center" }), /* @__PURE__ */ import_react74.default.createElement("span", { className: "text-center" }, "1.0"), /* @__PURE__ */ import_react74.default.createElement("span", { className: "text-center" }, "1.5"), /* @__PURE__ */ import_react74.default.createElement("span", { className: "text-center" }, "2.0"), /* @__PURE__ */ import_react74.default.createElement("span", { className: "text-center" }), /* @__PURE__ */ import_react74.default.createElement("span", { className: "text-center" }, _("Fast")))), /* @__PURE__ */ import_react74.default.createElement("div", { className: "flex items-center justify-between space-x-2" }, /* @__PURE__ */ import_react74.default.createElement("button", { onClick: onBackward, className: "rounded-full p-1" }, /* @__PURE__ */ import_react74.default.createElement(import_md19.MdFastRewind, { size: iconSize32 })), /* @__PURE__ */ import_react74.default.createElement("button", { onClick: onTogglePlay, className: "rounded-full p-1" }, isPlaying ? /* @__PURE__ */ import_react74.default.createElement(import_md19.MdPauseCircle, { size: iconSize48, className: "fill-primary" }) : /* @__PURE__ */ import_react74.default.createElement(import_md19.MdPlayCircle, { size: iconSize48, className: "fill-primary" })), /* @__PURE__ */ import_react74.default.createElement("button", { onClick: onForward, className: "rounded-full p-1" }, /* @__PURE__ */ import_react74.default.createElement(import_md19.MdFastForward, { size: iconSize32 })), /* @__PURE__ */ import_react74.default.createElement("div", { className: "dropdown dropdown-top" }, /* @__PURE__ */ import_react74.default.createElement("button", { className: "flex flex-col items-center justify-center rounded-full p-1" }, /* @__PURE__ */ import_react74.default.createElement(import_md19.MdAlarm, { size: iconSize32 }), timeoutCountdown && /* @__PURE__ */ import_react74.default.createElement(
    "span",
    {
    ...
    timeoutOptions.map((option, index) => /* @__PURE__ */ import_react74.default.createElement("li", { key: `${index}-${option.value}`, onClick: () => onSelectTimeout(option.value) }, /* @__PURE__ */ import_react74.default.createElement("div", { className: "flex items-center px-2" }, /* @__PURE__ */ import_react74.default.createElement("span", { style: { minWidth: `${defaultIconSize}px` } }, timeoutOption === option.value && /* @__PURE__ */ import_react74.default.createElement(import_md20.MdCheck, { className: "text-base-content" })), /* @__PURE__ */ import_react74.default.createElement("span", { className: (0, import_clsx40.default)("text-base sm:text-sm") }, option.label))))
  )), /* @__PURE__ */ import_react74.default.createElement("div", { className: "dropdown dropdown-top" }, /* @__PURE__ */ import_react74.default.createElement("button", { tabIndex: 0, className: "rounded-full p-1" }, /* @__PURE__ */ import_react74.default.createElement(import_ri8.RiVoiceAiFill, { size: iconSize32 })), /* @__PURE__ */ import_react74.default.createElement(
    "ul",
    {
      tabIndex: 0,
      className: (0, import_clsx40.default)(
    ...
    voices.map((voice, index) => /* @__PURE__ */ import_react74.default.createElement(
      "li",
      {
        key: `${index}-${voice.id}`,
        onClick: () => !voice.disabled && handleSelectVoice(voice.id)
      },
      /* @__PURE__ */ import_react74.default.createElement("div", { className: "flex items-center px-2" }, /* @__PURE__ */ import_react74.default.createElement("span", { style: { minWidth: `${defaultIconSize}px` } }, selectedVoice === voice.id && /* @__PURE__ */ import_react74.default.createElement(import_md20.MdCheck, { className: "text-base-content" })), /* @__PURE__ */ import_react74.default.createElement("span", { className: (0, import_clsx40.default)("text-base sm:text-sm", voice.disabled && "text-gray-400") }, voice.name))
    ))
  ))));
};
var TTSPanel_default = TTSPanel;

// src/app/reader/components/tts/TTSIcon.tsx
var import_react75 = __toESM(require("react"));
var TTSIcon2 = ({ isPlaying, onClick }) => {
  const bars = [1, 2, 3, 4];
  return /* @__PURE__ */ import_react75.default.createElement("div", { className: "relative h-full w-full cursor-pointer", onClick }, /* @__PURE__ */ import_react75.default.createElement("div", { className: "absolute inset-0 overflow-hidden rounded-full bg-gradient-to-r from-blue-500 via-emerald-500 to-violet-500" }, /* @__PURE__ */ import_react75.default.createElement(
    "div",
    {
      ...
      style: {
  ...
  )), /* @__PURE__ */ import_react75.default.createElement("div", { className: "absolute inset-0 flex items-center justify-center" }, /* @__PURE__ */ import_react75.default.createElement("style", null, `
        ...
        `), /* @__PURE__ */ import_react75.default.createElement("div", { className: "flex items-end space-x-1" }, bars.map((bar) => /* @__PURE__ */ import_react75.default.createElement(
    "div",
    {
      key: bar,
...
var TTSControl = () => {
  ...
  const { getBookData } = useBookDataStore();
  const { getView, getViewSettings } = useReaderStore();
  const [bookKey, setBookKey] = (0, import_react76.useState)("");
  const [ttsLang, setTtsLang] = (0, import_react76.useState)("en");
  const [isPlaying, setIsPlaying] = (0, import_react76.useState)(false);
  const [isPaused, setIsPaused] = (0, import_react76.useState)(false);
  const [showIndicator, setShowIndicator] = (0, import_react76.useState)(false);
  const [showPanel, setShowPanel] = (0, import_react76.useState)(false);
  const [panelPosition, setPanelPosition] = (0, import_react76.useState)();
  const [trianglePosition, setTrianglePosition] = (0, import_react76.useState)();
  const [timeoutOption, setTimeoutOption] = (0, import_react76.useState)(0);
  const [timeoutTimestamp, setTimeoutTimestamp] = (0, import_react76.useState)(0);
  const [timeoutFunc, setTimeoutFunc] = (0, import_react76.useState)(null);
  ...
  const iconRef = (0, import_react76.useRef)(null);
  const ttsControllerRef = (0, import_react76.useRef)(null);
  const unblockerAudioRef = (0, import_react76.useRef)(null);
  const unblockAudio = () => {
  ...
  const handleSetRate = (0, import_react76.useCallback)(
    throttle(async (rate) => {
      const ttsController = ttsControllerRef.current;
      if (ttsController) {
  ...
  const handleSetVoice = (0, import_react76.useCallback)(
  ...
  return /* @__PURE__ */ import_react76.default.createElement("div", null, showPanel && /* @__PURE__ */ import_react76.default.createElement(
    "div",
    {
      className: "fixed inset-0",
      onClick: handleDismissPopup,
  ...
  ), showIndicator && /* @__PURE__ */ import_react76.default.createElement(
    "div",
    {
      ref: iconRef,
    ...
    /* @__PURE__ */ import_react76.default.createElement(TTSIcon_default, { isPlaying, onClick: togglePopup })
  ), showPanel && panelPosition && trianglePosition && /* @__PURE__ */ import_react76.default.createElement(
    Popup_default,
    {
      width: popupWidth2,
      height: popupHeight2,
...
var ReaderContent = ({ ids, settings }) => {
  ...
  const [showDetailsBook, setShowDetailsBook] = (0, import_react77.useState)(null);
  const isInitiating = (0, import_react77.useRef)(false);
  ...
  if (!bookData || !bookData.book || !bookData.bookDoc) {
    ...
    return loading && /* @__PURE__ */ React62.createElement("div", { className: (0, import_clsx42.default)("hero hero-content", appService?.isIOSApp ? "h-[100vh]" : "h-dvh") }, /* @__PURE__ */ React62.createElement(Spinner_default, { loading: true }));
  }
  return /* @__PURE__ */ React62.createElement("div", { className: (0, import_clsx42.default)("flex", appService?.isIOSApp ? "h-[100vh]" : "h-dvh") }, /* @__PURE__ */ React62.createElement(SideBar_default, { onGoToLibrary: handleCloseBooksAndReload }), /* @__PURE__ */ React62.createElement(BooksGrid_default, { bookKeys, onCloseBook: handleCloseBook }), /* @__PURE__ */ React62.createElement(TTSControl_default, null), /* @__PURE__ */ React62.createElement(Notebook_default, null), showDetailsBook && /* @__PURE__ */ React62.createElement(
...
var Reader = ({ bookUrl = "https://cdn.readest.com/books/the-scarlet-letter.epub" }) => {
  ...
  (0, import_react78.useEffect)(() => {
    ...
    const initSettings = async () => {
      try {
        ...
        const hash = (0, import_js_md54.md5)(arrayBuffer);
  ...
  if (loading) {
    return /* @__PURE__ */ React63.createElement("div", { className: "hero h-dvh bg-base-100" }, /* @__PURE__ */ React63.createElement("div", { className: "hero-content text-center" }, /* @__PURE__ */ React63.createElement("div", null, /* @__PURE__ */ React63.createElement(Spinner_default, { loading: true }), /* @__PURE__ */ React63.createElement("div", { className: "mt-4 text-base-content" }, "Loading book from URL..."))));
  }
  if (error) {
    return /* @__PURE__ */ React63.createElement("div", { className: "hero h-dvh bg-base-100" }, /* @__PURE__ */ React63.createElement("div", { className: "hero-content text-center" }, /* @__PURE__ */ React63.createElement("div", { className: "max-w-md" }, /* @__PURE__ */ React63.createElement("h1", { className: "text-2xl font-bold text-error" }, "Error"), /* @__PURE__ */ React63.createElement("p", { className: "py-4 text-base-content" }, error), /* @__PURE__ */ React63.createElement(
      "button",
      {
  ...
  return settings?.globalReadSettings && /* @__PURE__ */ React63.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React63.createElement(import_react78.Suspense, null, /* @__PURE__ */ React63.createElement(ReaderContent_default, { key: bookHash || "default", ids: bookHash || void 0, settings }), /* @__PURE__ */ React63.createElement(Toast, null))
  );
};
