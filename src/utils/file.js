...
/**
 * A Blob subclass that defers loading of its content
 * @extends {Blob}
 */
 ...
 * @property {() => Promise<void>} open - Open the file
 * @property {() => Promise<void>} close - Close the file
 */
 ...
 * @returns {NativeFile}
 */
export function createNativeFile(path) {
