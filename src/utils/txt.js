import { getBaseFilename } from './book.js';
import { partialMD5 } from './md5.js';
...
/**
 * @typedef {Object} Txt2EpubOptions
 * @property {File} file
 * @property {string} [author]
 * @property {string} [language]
 */
...
/**
 * @typedef {Object} ExtractChapterOptions
 * @property {number} linesBetweenSegments
 */
