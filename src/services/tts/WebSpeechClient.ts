import { getUserLocale } from '../../utils/misc.js';
import { TTSClient, TTSMessageEvent, TTSVoice } from './TTSClient.js';
import { AsyncQueue } from '../../utils/queue.ts';
...
export class WebSpeechClient implements TTSClient {
  ...
  async getVoices(lang: string) {
    ...
    const locale = lang === 'en' ? getUserLocale() || lang : lang;
